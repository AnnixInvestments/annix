...
const RESOURCES: MarketingResource[] = [
  ...
  {
    slug: "orbit-seeker-prelaunch-week-1",
    category: "Platform",
    title: "Why aren't employers calling you back?",
    excerpt: "It's not your experience. It might be your CV.",
    body: "Annix Orbit Seeker uses AI to review, score and improve your CV so you can stand out and get more interviews.\n\nMost strong candidates never hear back — not because they lack experience, but because their CV doesn't tell the story clearly. Orbit Seeker reads your CV the way a recruiter and an applicant-tracking system do, then shows you exactly what to fix.\n\nWhat's inside: AI CV review, a career score, smart job matching, interview preparation and career growth tools — your AI career coach, in one place.\n\nAnnix Orbit Seeker — coming soon. Conquer your career.",
    imageUrl: "/marketing/orbit-seeker/prelaunch-week-1.png",
    productSlug: "annix-orbit",
    published: true,
    ctaLabel: "Register your interest",
    ctaUrl: "/annix/orbit/seeker/register-interest",
  },
  {
    slug: "orbit-seeker-prelaunch-week-2",
    category: "Platform",
    title: "Your CV could be costing you interviews",
    excerpt: "Small mistakes. Big impact.",
    body: "Get an AI-powered review that shows you exactly what's holding you back — instantly.\n\nThe most common reasons a CV gets passed over are quietly fixable: it reads as too generic, it's missing measurable impact, it lists duties instead of achievements, the skills are weak or unfocused, and the value you offer is unclear.\n\nAnnix Orbit Seeker scores your CV against what recruiters actually look for and turns each weakness into a specific, actionable fix — so your next application lands.\n\nAnnix Orbit Seeker — launching soon. Conquer your career.",
    imageUrl: "/marketing/orbit-seeker/prelaunch-week-2.png",
    productSlug: "annix-orbit",
    published: true,
    ctaLabel: "Register your interest",
    ctaUrl: "/annix/orbit/seeker/register-interest",
  ...
  {
    slug: "orbit-seeker-prelaunch-week-3",
    category: "Platform",
    title: "What's your career score?",
    excerpt: "Know where you stand. Unlock where you can go.",
    body: "Get your AI Career Score and discover how you compare in today's job market.\n\nOrbit Seeker analyses your skills, experience, education and potential and distils them into a single, easy-to-read score — with the detail behind it, so you know precisely where you're strong and where to grow.\n\nFrom there it connects the dots: improve your CV, find the right jobs, prepare for interviews and plan your next move with confidence.\n\nAnnix Orbit Seeker — launching soon. Conquer your career.",
    imageUrl: "/marketing/orbit-seeker/prelaunch-week-3.png",
    productSlug: "annix-orbit",
    published: true,
    ctaLabel: "Register your interest",
    ctaUrl: "/annix/orbit/seeker/register-interest",
  ...
  {
    slug: "orbit-seeker-prelaunch-week-4",
    category: "Platform",
    title: "Find jobs that fit you",
    excerpt: "Less searching. More opportunities.",
    body: "AI matches you with opportunities that fit your skills, goals and ambitions.\n\nInstead of scrolling endless listings, Orbit Seeker surfaces roles ranked by how well they match you — with a clear match score on each — so you spend your time on the opportunities worth pursuing.\n\nWhat you get: AI job matching, real-time alerts the moment new roles appear, save-and-track for every application, career insights to plan your next move, and smarter applications that get better results.\n\nAnnix Orbit Seeker — launching soon. Conquer your career.",
    imageUrl: "/marketing/orbit-seeker/prelaunch-week-4.png",
    productSlug: "annix-orbit",
    published: true,
    ctaLabel: "Register your interest",
    ctaUrl: "/annix/orbit/seeker/register-interest",
  ...
  {
    slug: "orbit-seeker-prelaunch-week-5",
    category: "Platform",
    title: "Prepare. Practice. Perform.",
    excerpt: "An AI interview coach in your pocket.",
    body: "Practice questions and real-time feedback help you walk into every interview ready.\n\nOrbit Seeker's AI interview coach gives you personalised coaching, industry-specific practice questions and instant feedback on your answers — so you build genuine confidence before it counts.\n\nTrack your progress over time, see your interview readiness improve, and turn preparation into offers. Be prepared, stand out and get hired.\n\nAnnix Orbit Seeker — launching soon. Conquer your career.",
    imageUrl: "/marketing/orbit-seeker/prelaunch-week-5.png",
    productSlug: "annix-orbit",
    published: true,
    ctaLabel: "Register your interest",
    ctaUrl: "/annix/orbit/seeker/register-interest",
  ...
  {
    slug: "orbit-seeker-prelaunch-week-6",
    category: "Platform",
    title: "All your career tools. One place.",
    excerpt: "Everything you need to advance your career.",
    body: "From AI CV review to job matching, career score to interview prep — Annix Orbit Seeker brings your whole career into one place.\n\nYour career hub keeps it all together: CV review, job search, interview coach, career score, saved jobs, applications and courses — with your progress visible at a glance.\n\nIt's private and secure (your data is protected and never shared), AI-powered to give you an edge, and built to help you succeed.\n\nAnnix Orbit Seeker — launching soon. Conquer your career.",
    imageUrl: "/marketing/orbit-seeker/prelaunch-week-6.png",
    productSlug: "annix-orbit",
    published: true,
    ctaLabel: "Register your interest",
    ctaUrl: "/annix/orbit/seeker/register-interest",

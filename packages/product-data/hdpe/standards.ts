...
import { HDPE_GRADES } from "./grades";
import type { PnClass, SdrValue } from "./sdr-ratings";
import { calculatePnFromSdr, pnClassForSdr, SDR_RATINGS, SDR_VALUES } from "./sdr-ratings";
import {
  deratedPressure,

...
export const FALLBACK_PIPE_SCHEDULES: Record<number, PipeScheduleEntry[]> = {
  15: [
...
export const SABS719_PIPE_SCHEDULES: Record<number, PipeScheduleEntry[]> = {
  200: [
...
export const SABS62_MEDIUM_SCHEDULES: Record<number, PipeScheduleEntry[]> = {
...
export const SABS62_HEAVY_SCHEDULES: Record<number, PipeScheduleEntry[]> = {

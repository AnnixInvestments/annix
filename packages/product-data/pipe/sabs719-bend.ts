export interface Sabs719BendDimension {
  A: number;
  B: number;
  C: number;
  R: number;
...
export const SABS719_ELBOWS: Record<number, Sabs719BendDimension> = {
...
export const SABS719_MEDIUM_RADIUS: Record<number, Sabs719BendDimension> = {
...
export const SABS719_LONG_RADIUS: Record<number, Sabs719BendDimension> = {
...
export const sabs719ColumnBySegments = (
...
export const sabs719CenterToFaceBySegments = (
  ...
  const tables: Record<string, Record<number, Sabs719BendDimension>> = {

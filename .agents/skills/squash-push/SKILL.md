...
Collapse every commit ahead of `origin/main` into a single commit, then push to `origin/main`. Always trunk-based: push to `origin/main` even from a `Codex/*` branch.

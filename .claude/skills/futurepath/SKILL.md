...
Separate app/login/admin card · scraping every university or daily refresh · fabricated admission % · QS/THE commercial use · rebuilding employer/jobs (reuse) · a new AI provider or Claude/OpenAI direct calls (Gemini via `AiChatService` only).

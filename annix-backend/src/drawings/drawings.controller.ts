...
import { DrawingAnalysisResult, DrawingAnalyzerService } from "./drawing-analyzer.service";
...
export class DrawingsController {
  ...
  async analyzeDrawing(@UploadedFile() file: Express.Multer.File): Promise<DrawingAnalysisResult> {
    if (!file) {
      return {
        success: false,
        components: [],

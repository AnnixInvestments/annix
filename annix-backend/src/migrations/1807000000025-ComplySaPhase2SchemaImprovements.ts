...
export class ComplySaPhase2SchemaImprovements1807000000025 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        ...
        USING next_due_date::varchar(50);
      EXCEPTION WHEN others THEN NULL;
      END $$
    `);
    await queryRunner.query(`
      DO $$ BEGIN
        ...
        USING last_completed_date::varchar(50);
      EXCEPTION WHEN others THEN NULL;
      END $$
    `);
    await queryRunner.query(`
      DO $$ BEGIN
        ...
        USING trial_ends_at::varchar(50);
      EXCEPTION WHEN others THEN NULL;
      END $$
    `);
    await queryRunner.query(`
      DO $$ BEGIN
        ...
        USING current_period_start::varchar(50);
      EXCEPTION WHEN others THEN NULL;
      END $$
    `);
    await queryRunner.query(`
      DO $$ BEGIN
        ...
        USING current_period_end::varchar(50);
      EXCEPTION WHEN others THEN NULL;
      END $$
    `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        ...
        USING password_reset_expires_at::varchar(50);
      EXCEPTION WHEN others THEN NULL;
      END $$
    `);

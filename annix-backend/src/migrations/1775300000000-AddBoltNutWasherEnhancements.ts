...
export class AddBoltNutWasherEnhancements1775300000000 implements MigrationInterface {
  ...
  private async addFinishColumnToBolts(
  ...
  private async addMissingThreadPitches(
    queryRunner: QueryRunner,
  ): Promise<void> {
  ...
  private async addLargeMetricStuds(queryRunner: QueryRunner): Promise<void> {
    ...
    const largeStuds = [
      {
        designation: 'M68 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
      {
        designation: 'M72 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
      {
        designation: 'M76 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
      {
        designation: 'M80 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
      {
        designation: 'M85 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
      {
        designation: 'M90 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
      {
        designation: 'M95 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
      {
        designation: 'M100 Stud',
        grade: 'B7',
        material: 'Alloy Steel',
        threadPitch: 6.0,
      },
    ...
    const studBoltMassData: Array<{
      ...
      { designation: 'M76 Stud', length: 500, mass: 17.7 },
    ...
    console.warn(
      `Added ${largeStuds.length} large metric stud bolts with mass data`,
    );
  }

  private async createBoltGradeAvailabilityTable(
    queryRunner: QueryRunner,
  ): Promise<void> {
    ...
    const gradeAvailability = [
      {
        ...
        thread: 'coarse',
        grade: '8.8',
        finishes: ['plain', 'zinc', 'hot-dip galvanized'],
        minLen: 16,
        maxLen: 100,
      },
      {
      ...
      },
      {
        ...
        thread: 'coarse',
        grade: '8.8',
        finishes: ['plain', 'hot-dip galvanized'],
        minLen: 100,
        maxLen: 800,
      },
      {
...

      {
        ...
        thread: 'stud',
        grade: 'B7',
        finishes: ['plain', 'hot-dip galvanized', 'PTFE'],
        minLen: 50,
        maxLen: 200,
      },
      {
    ...
    console.warn(
      `Added ${gradeAvailability.length} bolt grade availability records`,
    );
  }

  private async createBoltThreadCompatibilityTable(
    queryRunner: QueryRunner,
  ): Promise<void> {
    ...
    const compatibilityRules = [
      {
        ...
        nutPitch: 1.5,
        compatible: true,
        notes: 'M10 coarse standard match',
      },
      {
        boltType: 'coarse',
        boltPitch: 1.5,
        ...
        nutPitch: 1.25,
        compatible: false,
        notes: 'M10 coarse/fine mismatch - thread damage risk',
      },
      {
        boltType: 'fine',
        boltPitch: 1.25,
        ...
        nutPitch: 1.5,
        compatible: false,
        notes: 'M10 fine/coarse mismatch - thread damage risk',
      },
      {
        boltType: 'fine',
        boltPitch: 1.25,
...

      {
        ...
        nutPitch: 1.75,
        compatible: true,
        notes: 'M12 coarse standard match',
      },
      {
        boltType: 'coarse',
        boltPitch: 1.75,
        ...
        nutPitch: 1.5,
        compatible: false,
        notes: 'M12 coarse/fine mismatch',
      },
      {
        boltType: 'fine',
        boltPitch: 1.5,
        ...
        nutPitch: 1.75,
        compatible: false,
        notes: 'M12 fine/coarse mismatch',
      },
      {
        boltType: 'fine',
        boltPitch: 1.5,
...

      {
        ...
        nutPitch: 2.0,
        compatible: true,
        notes: 'M16 coarse standard match',
      },
      {
        boltType: 'coarse',
        boltPitch: 2.0,
        ...
        nutPitch: 1.5,
        compatible: false,
        notes: 'M16 coarse/fine mismatch',
      },
      {
        boltType: 'fine',
        boltPitch: 1.5,
        ...
        nutPitch: 2.0,
        compatible: false,
        notes: 'M16 fine/coarse mismatch',
      },

      {
        ...
        nutPitch: 2.5,
        compatible: true,
        notes: 'M20 coarse standard match',
      },
      {
        boltType: 'coarse',
        boltPitch: 2.5,
        ...
        nutPitch: 1.5,
        compatible: false,
        notes: 'M20 coarse/fine mismatch',
      },
      {
        boltType: 'fine',
        boltPitch: 1.5,
        ...
        nutPitch: 2.5,
        compatible: false,
        notes: 'M20 fine/coarse mismatch',
      },

      {
        ...
        nutPitch: 3.0,
        compatible: true,
        notes: 'M24 coarse standard match',
      },
      {
        boltType: 'coarse',
        boltPitch: 3.0,
        ...
        nutPitch: 2.0,
        compatible: false,
        notes: 'M24 coarse/fine mismatch',
      },
...

      {
        ...
        nutPitch: 1.954,
        compatible: false,
        notes: 'M10 metric/imperial mismatch',
      },
      {
        boltType: 'UNC',
        boltPitch: 2.54,
        ...
        nutPitch: 2.5,
        compatible: false,
        notes: '3/4" imperial/M20 metric near-match but incompatible',
      },
    ];
    ...
    console.warn(
      `Added ${compatibilityRules.length} thread compatibility validation rules`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    for (const designation of largeStudDesignations) {
      const bolt = await queryRunner.query(
        `SELECT id FROM bolts WHERE designation = $1`,
        [designation],
      );
      if (bolt.length > 0) {
        await queryRunner.query(`DELETE FROM bolt_masses WHERE "boltId" = $1`, [
          bolt[0].id,
        ]);
        await queryRunner.query(`DELETE FROM bolts WHERE id = $1`, [
          bolt[0].id,
        ]);
      }
    }

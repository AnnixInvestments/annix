  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (bs4504Result.length > 0) {
      ...
      const carbonSteelDerating: [number, number][] = [
        [-29, 1.00], [20, 1.00], [50, 1.00], [100, 0.92],
        [150, 0.95], [200, 0.91], [250, 0.83], [300, 0.76],
        [350, 0.71], [400, 0.64],
      ];

      const ss304Derating: [number, number][] = [
        [-29, 1.00], [20, 1.00], [50, 1.00], [100, 1.00],
        [150, 0.97], [200, 0.93], [250, 0.88], [300, 0.84],
        [350, 0.80], [400, 0.76], [450, 0.69], [500, 0.60],
      ];

      const ss316Derating: [number, number][] = [
        [-29, 1.00], [20, 1.00], [50, 1.00], [100, 1.00],
        [150, 0.98], [200, 0.94], [250, 0.90], [300, 0.86],
        [350, 0.82], [400, 0.78], [450, 0.72], [500, 0.64],
      ];

...
export class AddSABS62PipeData1760428500000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const mediumSteelResult = await queryRunner.query(
      `SELECT id FROM "steel_specifications" WHERE "steel_spec_name" = 'SABS 62 ERW Medium'`,
    );
    const heavySteelResult = await queryRunner.query(
    ...
    const mediumPipes = [
      { nb: 15, od: 21.3, mass: 1.123, wallMin: 2.3 },
      { nb: 20, od: 26.9, mass: 1.442, wallMin: 2.3 },
      { nb: 25, od: 33.7, mass: 2.225, wallMin: 2.8 },
      { nb: 32, od: 42.4, mass: 2.843, wallMin: 2.8 },
      { nb: 40, od: 48.3, mass: 3.261, wallMin: 2.8 },
      { nb: 50, od: 60.3, mass: 4.606, wallMin: 3.2 },
      { nb: 65, od: 76.3, mass: 5.869, wallMin: 3.2 },
      { nb: 80, od: 88.9, mass: 7.604, wallMin: 3.5 },
      { nb: 100, od: 114.3, mass: 10.924, wallMin: 3.9 },
      { nb: 125, od: 139.7, mass: 14.447, wallMin: 4.2 },
      { nb: 150, od: 165.1, mass: 17.148, wallMin: 4.2 },
    ];

    // SABS 62 Heavy grade pipe data
    const heavyPipes = [
      { nb: 15, od: 21.3, mass: 1.34, wallMin: 2.8 },
      { nb: 20, od: 26.9, mass: 1.728, wallMin: 2.8 },
      { nb: 25, od: 33.7, mass: 2.711, wallMin: 3.5 },
      { nb: 32, od: 42.4, mass: 3.481, wallMin: 3.5 },
      { nb: 40, od: 48.3, mass: 4.003, wallMin: 3.5 },
      { nb: 50, od: 60.3, mass: 5.598, wallMin: 3.9 },
      { nb: 65, od: 76.1, mass: 7.153, wallMin: 3.9 },
      { nb: 80, od: 88.9, mass: 9.033, wallMin: 4.2 },
      { nb: 100, od: 114.3, mass: 13.021, wallMin: 4.7 },
      { nb: 125, od: 139.7, mass: 16.058, wallMin: 4.7 },
      { nb: 150, od: 165.1, mass: 19.072, wallMin: 4.7 },
    ];

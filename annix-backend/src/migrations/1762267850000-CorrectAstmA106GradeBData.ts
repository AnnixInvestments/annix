...
export class CorrectAstmA106GradeBData1762267850000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const astmA106Data = [
      ...
      [8, 13.7, 3.02, 7.65, 0.8, '80'],
      [10, 17.1, 2.31, 12.48, 0.85, '40'],
      [10, 17.1, 3.2, 10.7, 1.1, '80'],
      ...
      [25, 33.4, 3.38, 26.64, 2.5, '40'],
      [25, 33.4, 4.55, 24.31, 3.23, '80'],
      [25, 33.4, 6.35, 20.7, 4.23, '160'],
      [25, 33.4, 9.09, 15.21, 5.45, 'XXS'],
      [32, 42.2, 3.56, 35.09, 3.38, '40'],
      [32, 42.2, 4.85, 32.5, 4.46, '80'],
      [32, 42.2, 6.35, 29.5, 5.61, '160'],
      [32, 42.2, 9.7, 22.79, 7.74, 'XXS'],
      [40, 48.3, 3.68, 40.93, 4.05, '40'],
      [40, 48.3, 5.08, 38.14, 5.4, '80'],
      ...
      [65, 73.0, 7.01, 58.98, 11.4, '80'],
      [65, 73.0, 9.53, 53.94, 14.9, '160'],
      ...
      [125, 141.3, 6.55, 128.2, 21.78, '40'],
      [125, 141.3, 9.53, 122.24, 30.92, '80'],
      [125, 141.3, 12.7, 115.9, 40.24, '120'],
      [125, 141.3, 15.88, 109.54, 49.05, '160'],
      [125, 141.3, 19.05, 103.2, 57.38, 'XXS'],
      ...
      [150, 168.3, 21.95, 124.4, 79.1, 'XXS'],
      [200, 219.1, 6.35, 206.4, 33.31, '20'],
      [200, 219.1, 7.04, 205.02, 36.79, '30'],
      [200, 219.1, 8.18, 202.74, 42.53, '40'],
      [200, 219.1, 10.31, 198.48, 53.1, '60'],
      [200, 219.1, 12.7, 193.7, 64.63, '80'],
      ...
      [500, 508.0, 6.35, 495.3, 78.54, '10'],
      [500, 508.0, 9.52, 488.96, 117.07, '20'],
      [500, 508.0, 12.7, 482.6, 155.1, '30'],
    ...
    for (const [
      ...
      if (nominalResult.length > 0) {
        ...
        const scheduleNumber = /^\d+$/.test(scheduleStr)
          ? parseFloat(scheduleStr)
          : null;

...
export class AddDetailedSABS62FittingDimensions1762180179295 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const sabs62Medium = await queryRunner.query(
      `SELECT id FROM steel_specifications WHERE steel_spec_name = 'SABS 62 ERW Medium'`,
    );
    const sabs62Heavy = await queryRunner.query(
      `SELECT id FROM steel_specifications WHERE steel_spec_name = 'SABS 62 ERW Heavy'`,
    );
  ...
  private async insert90DegreePulledBends(
    ...
    const bendsData = [
      ...
      { nb: 65, od: 76.2, r3d: 191, l3d: 253, r5d: 325, l5d: 400 },
      { nb: 80, od: 88.9, r3d: 229, l3d: 297, r5d: 445, l5d: 550 },
      { nb: 100, od: 114.3, r3d: 305, l3d: 387, r5d: 508, l5d: 600 },
      { nb: 125, od: 139.7, r3d: 381, l3d: 546, r5d: 635, l5d: 700 },
      { nb: 150, od: 165.1, r3d: 457, l3d: 628, r5d: 840, l5d: 830 },
    ];
  ...
  private async insertSpringBends5D(
    ...
    const springBends5D = [
      ...
      { nb: 65, od: 76.2, radius: 325, l46_90: 350, l1_45: 204 },
      { nb: 80, od: 88.9, radius: 445, l46_90: 470, l1_45: 240 },
      { nb: 100, od: 114.3, radius: 508, l46_90: 575, l1_45: 329 },
      { nb: 125, od: 139.7, radius: 635, l46_90: 700, l1_45: 435 },
      { nb: 150, od: 165.1, radius: 840, l46_90: 875, l1_45: 509 },
    ];
  ...
  private async insertSpringBends3D(
    ...
    const springBends3D = [
      ...
      { nb: 65, od: 76.2, radius: 191, l46_90: 253, l1_45: 138 },
      { nb: 80, od: 88.9, radius: 229, l46_90: 297, l1_45: 161 },
      { nb: 90, od: 101.6, radius: 267, l46_90: 375, l1_45: 225 },
      { nb: 100, od: 114.3, radius: 305, l46_90: 387, l1_45: 207 },
      { nb: 125, od: 139.7, radius: 381, l46_90: 546, l1_45: 278 },
      { nb: 150, od: 165.1, radius: 457, l46_90: 628, l1_45: 315 },
      { nb: 175, od: 190.5, radius: 622, l46_90: 650, l1_45: 630 },
    ];
  ...
  private async insertEqualTees(
    ...
    const equalTees = [
      ...
      { nb: 65, od: 76.2, ctf: 140 },
      { nb: 80, od: 88.9, ctf: 150 },
      { nb: 90, od: 101.6, ctf: 170 },
      { nb: 100, od: 114.3, ctf: 180 },
      { nb: 125, od: 139.7, ctf: 200 },
      { nb: 150, od: 165.1, ctf: 230 },
    ];
  ...
  private async insertSweepTees(
    ...
    const sweepTees = [
      ...
      { nb: 65, od: 76.2, ctf_c: 290, ctf_d: 140, radius: 190 },
      { nb: 80, od: 88.9, ctf_c: 330, ctf_d: 150, radius: 230 },
      { nb: 90, od: 101.6, ctf_c: 395, ctf_d: 165, radius: 265 },
      { nb: 100, od: 114.3, ctf_c: 430, ctf_d: 180, radius: 305 },
      { nb: 125, od: 139.7, ctf_c: 535, ctf_d: 205, radius: 380 },
      { nb: 150, od: 165.1, ctf_c: 635, ctf_d: 230, radius: 455 },
    ];
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (sabs62Medium.length > 0) {
      await queryRunner.query(
        `DELETE FROM fittings WHERE steel_specification_id = ${sabs62Medium[0].id}`,
      );
    }
    if (sabs62Heavy.length > 0) {
      await queryRunner.query(
        `DELETE FROM fittings WHERE steel_specification_id = ${sabs62Heavy[0].id}`,
      );
    }
  }
}

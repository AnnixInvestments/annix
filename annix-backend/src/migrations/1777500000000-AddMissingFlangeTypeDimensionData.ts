...
export class AddMissingFlangeTypeDimensionData1777500000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (bs4504Id && type4Id) {
      ...
      const threadedPN16Data: Array<[number, number, number, number, number, number, string, number, number]> = [
      ...
      const threadedPN10Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        ...
        [80, 200, 18, 160, 8, 18, 'M16', 3.20, 50],
        [100, 220, 18, 180, 8, 18, 'M16', 3.80, 55],
      ];
      ...
      const threadedPN25Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 16, 65, 4, 14, 'M12', 0.85, 45],
        [20, 105, 18, 75, 4, 14, 'M12', 1.15, 50],
        [25, 115, 18, 85, 4, 14, 'M12', 1.40, 50],
        [32, 140, 20, 100, 4, 18, 'M16', 2.10, 55],
        [40, 150, 20, 110, 4, 18, 'M16', 2.40, 55],
        [50, 165, 22, 125, 4, 18, 'M16', 3.00, 60],
        [65, 185, 22, 145, 8, 18, 'M16', 3.80, 60],
        [80, 200, 24, 160, 8, 18, 'M16', 4.80, 65],
        [100, 235, 24, 190, 8, 22, 'M20', 6.20, 70],
      ];
      ...
      const threadedPN40Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 16, 65, 4, 14, 'M12', 0.95, 50],
        [20, 105, 18, 75, 4, 14, 'M12', 1.30, 55],
        [25, 115, 20, 85, 4, 14, 'M12', 1.60, 55],
        [32, 140, 22, 100, 4, 18, 'M16', 2.40, 60],
        [40, 150, 22, 110, 4, 18, 'M16', 2.80, 60],
        [50, 165, 24, 125, 4, 18, 'M16', 3.50, 65],
        [65, 185, 26, 145, 8, 18, 'M16', 4.50, 70],
        [80, 200, 28, 160, 8, 18, 'M16', 5.80, 75],
        [100, 235, 30, 190, 8, 22, 'M20', 7.80, 80],
      ];
    ...
    if (bs4504Id && type5Id) {
      ...
      const slipOnBossPN16Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 14, 65, 4, 14, 'M12', 0.55, 40],
        [20, 105, 16, 75, 4, 14, 'M12', 0.80, 45],
        [25, 115, 16, 85, 4, 14, 'M12', 1.00, 45],
        [32, 140, 18, 100, 4, 18, 'M16', 1.55, 50],
        [40, 150, 18, 110, 4, 18, 'M16', 1.80, 50],
        [50, 165, 18, 125, 4, 18, 'M16', 2.15, 55],
        [65, 185, 18, 145, 4, 18, 'M16', 2.70, 55],
        [80, 200, 20, 160, 8, 18, 'M16', 3.50, 55],
        [100, 220, 20, 180, 8, 18, 'M16', 4.15, 60],
        [125, 250, 22, 210, 8, 18, 'M16', 5.80, 65],
        [150, 285, 22, 240, 8, 22, 'M20', 7.00, 65],
      ...
      const slipOnBossPN10Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 12, 65, 4, 14, 'M12', 0.42, 35],
        [20, 105, 14, 75, 4, 14, 'M12', 0.60, 40],
        [25, 115, 14, 85, 4, 14, 'M12', 0.75, 40],
        [32, 140, 14, 100, 4, 18, 'M16', 1.20, 45],
        [40, 150, 14, 110, 4, 18, 'M16', 1.40, 45],
        [50, 165, 14, 125, 4, 18, 'M16', 1.70, 50],
        [65, 185, 14, 145, 4, 18, 'M16', 2.15, 50],
        [80, 200, 16, 160, 8, 18, 'M16', 2.80, 50],
        [100, 220, 16, 180, 8, 18, 'M16', 3.40, 55],
        [125, 250, 18, 210, 8, 18, 'M16', 4.80, 60],
        [150, 285, 18, 240, 8, 22, 'M20', 5.80, 60],
        [200, 340, 20, 295, 8, 22, 'M20', 9.00, 65],
      ...
      const slipOnBossPN25Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        ...
        [50, 165, 22, 125, 4, 18, 'M16', 2.70, 60],
        [65, 185, 22, 145, 8, 18, 'M16', 3.40, 60],
        [80, 200, 24, 160, 8, 18, 'M16', 4.40, 65],
        [100, 235, 24, 190, 8, 22, 'M20', 5.80, 70],
        [125, 270, 26, 220, 8, 22, 'M20', 8.50, 75],
      ...
      const slipOnBossPN40Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 18, 65, 4, 14, 'M12', 0.78, 50],
        [20, 105, 20, 75, 4, 14, 'M12', 1.10, 55],
        [25, 115, 20, 85, 4, 14, 'M12', 1.35, 55],
        [32, 140, 22, 100, 4, 18, 'M16', 2.10, 60],
        [40, 150, 22, 110, 4, 18, 'M16', 2.45, 60],
        [50, 165, 24, 125, 4, 18, 'M16', 3.10, 65],
        [65, 185, 26, 145, 8, 18, 'M16', 4.00, 70],
        [80, 200, 28, 160, 8, 18, 'M16', 5.20, 75],
        [100, 235, 30, 190, 8, 22, 'M20', 7.20, 80],
    ...
    if (asmeB165Id && type5Id) {
      ...
      const swClass150Data: Array<[number, number, number, number, number, number, number, string, number, number]> = [
        ...
        [100, 229, 24, 190, 8, 19, 116, '5/8"', 5.90, 90],
      ];
      ...
      const swClass300Data: Array<[number, number, number, number, number, number, number, string, number, number]> = [
        ...
        [80, 210, 29, 168, 8, 22, 91, '3/4"', 6.80, 110],
      ...
      const swClass600Data: Array<[number, number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 14, 67, 4, 16, 22, '1/2"', 0.68, 55],
        ...
        [65, 191, 29, 149, 8, 22, 75, '3/4"', 6.80, 115],
      ...
      const swClass900Data: Array<[number, number, number, number, number, number, number, string, number, number]> = [
    ...
    if (asmeB165Id && type4Id) {
      ...
      const ljClass150Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 89, 11, 60, 4, 16, '1/2"', 0.50, 45],
        [20, 99, 13, 70, 4, 16, '1/2"', 1.00, 50],
        [25, 108, 14, 79, 4, 16, '1/2"', 1.00, 55],
        [32, 117, 16, 89, 4, 16, '1/2"', 1.00, 60],
        [40, 127, 18, 98, 4, 16, '1/2"', 1.00, 65],
        [50, 152, 19, 121, 4, 19, '5/8"', 2.00, 75],
        [65, 178, 22, 140, 4, 19, '5/8"', 3.00, 80],
        [80, 191, 24, 152, 4, 19, '5/8"', 4.00, 85],
        [100, 229, 24, 191, 8, 19, '5/8"', 6.00, 90],
        [150, 279, 25, 241, 8, 22, '3/4"', 9.00, 95],
      ...
      const ljClass300Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 14, 67, 4, 16, '1/2"', 1.20, 55],
        [20, 117, 16, 83, 4, 19, '5/8"', 1.40, 65],
        [25, 124, 17, 89, 4, 19, '5/8"', 1.80, 70],
        [32, 133, 19, 98, 4, 19, '5/8"', 2.30, 75],
        [40, 156, 21, 114, 4, 22, '3/4"', 3.20, 85],
        [50, 165, 22, 127, 8, 19, '5/8"', 4.10, 90],
        [65, 191, 25, 149, 8, 22, '3/4"', 5.50, 100],
        [80, 210, 29, 168, 8, 22, '3/4"', 6.80, 110],
      ...
      const ljClass600Data: Array<[number, number, number, number, number, number, string, number, number]> = [
        [15, 95, 14, 67, 4, 16, '1/2"', 1.20, 55],
        ...
        [65, 191, 29, 149, 8, 22, '3/4"', 6.80, 115],
      ...
      const ljClass900Data: Array<[number, number, number, number, number, number, string, number, number]> = [
    ...
    if (asmeB165Id && type7Id) {
      ...
      const sbClass150Data: Array<[number, number, number, number, number, number, string, number, number, number]> = [
      ...
      const sbClass300Data: Array<[number, number, number, number, number, number, string, number, number, number]> = [
      ...
      const sbClass600Data: Array<[number, number, number, number, number, number, string, number, number, number]> = [
      ...
      const sbClass900Data: Array<[number, number, number, number, number, number, string, number, number, number]> = [
      ...
      console.warn('ASME B16.48 Spectacle Blind data added for ASME B16.5 (Classes 150, 300, 600, 900).');
    }

...
export class AddSABS719PipeData1760428700000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const steelResult = await queryRunner.query(
    ...
    const pipeData = [
      // Format: { nb, od, wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20, 22], weights: [corresponding weights] }
      {
        nb: 200,
        od: 219.1,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12],
        weights: [24.9, 33.1, 43.6, 54.2, 64.6],
      },
      {
        nb: 250,
        od: 273.1,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16],
        weights: [31.2, 41.4, 54.7, 68.0, 81.5, 94, 106],
      },
      {
        nb: 300,
        od: 323.9,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20],
        weights: [37.1, 49.3, 65.2, 81.3, 97.5, 113, 127, 158],
      },
      {
        nb: 350,
        od: 355.6,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20],
        weights: [40.7, 54.2, 71.7, 89.5, 108, 124, 140, 174],
      },
      {
        nb: 400,
        od: 406.4,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20],
        weights: [46.6, 62.1, 82.2, 103, 123, 143, 161, 200],
      },
      {
        nb: 450,
        od: 457,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20],
        weights: [52.6, 70.0, 92.6, 115, 139, 161, 182, 227],
      },
      {
        nb: 500,
        od: 508,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20],
        weights: [58.5, 78.0, 103, 129, 155, 179, 203, 253],
      },
      {
        nb: 550,
        od: 559,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [64.4, 85.8, 113, 142, 172, 198, 223, 280, 309],
      },
      {
        nb: 600,
        od: 610,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [70.2, 93.6, 124, 155, 186, 216, 245, 305, 338],
      },
      {
        nb: 650,
        od: 660,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [76.1, 101, 134, 168, 203, 235, 267, 332, 366],
      },
      {
        nb: 700,
        od: 711,
        wallThicknesses: [4.5, 6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [82.0, 110, 145, 182, 219, 253, 287, 358, 396],
      },
      {
        nb: 750,
        od: 762,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [117, 155, 194, 235, 272, 308, 384, 425],
      },
      {
        nb: 800,
        od: 813,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [125, 166, 208, 250, 290, 327, 410, 455],
      },
      {
        nb: 850,
        od: 864,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [133, 176, 220, 266, 308, 349, 437, 484],
      },
      {
        nb: 900,
        od: 914,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [140, 187, 233, 282, 327, 371, 463, 508],
      },
      {
        nb: 950,
        od: 965,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [149, 198, 247, 296, 345, 393, 489, 537],
      },
      {
        nb: 1000,
        od: 1016,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [156, 208, 260, 315, 371, 413, 516, 567],
      },
      {
        nb: 1050,
        od: 1067,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [165, 219, 274, 327, 381, 435, 542, 594],
      },
      {
        nb: 1100,
        od: 1092,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [169, 224, 280, 335, 390, 446, 555, 609],
      },
      {
        nb: 1150,
        od: 1118,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [173, 230, 287, 344, 400, 455, 569, 624],
      },
      {
        nb: 1200,
        od: 1219,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [188, 251, 313, 375, 437, 499, 621, 682],
      },
      {
        nb: 1250,
        od: 1245,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [192, 256, 320, 383, 445, 509, 634, 697],
      },
      {
        nb: 1300,
        od: 1397,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [216, 288, 359, 430, 501, 572, 713, 783],
      },
      {
        nb: 1400,
        od: 1422,
        wallThicknesses: [6.0, 8.0, 10, 12, 14, 16, 20, 22],
        weights: [220, 292, 365, 437, 510, 587, 725, 796],
      },
      {
        nb: 1500,
        od: 1549,
        wallThicknesses: [8.0, 10, 12, 14, 16, 20, 22],
        weights: [319, 398, 477, 560, 635, 792, 869],
      },
      {
        nb: 1600,
        od: 1626,
        wallThicknesses: [8.0, 10, 12, 14, 16, 20, 22],
        weights: [334, 417, 499, 582, 664, 829, 910],
      },
      {
        nb: 1700,
        od: 1727,
        wallThicknesses: [8.0, 10, 12, 14, 16, 20, 22],
        weights: [352, 440, 527, 614, 701, 874, 960],
      },
      {
        nb: 1800,
        od: 1829,
        wallThicknesses: [8.0, 10, 12, 14, 16, 20, 22],
        weights: [375, 469, 562, 655, 747, 932, 1024],
      },
      {
        nb: 1900,
        od: 1930,
        wallThicknesses: [10, 12, 14, 16, 20, 22],
        weights: [479, 574, 669, 764, 953, 1046],
      },
      {
        nb: 2000,
        od: 2032,
        wallThicknesses: [10, 12, 14, 16, 20, 22],
        weights: [520, 624, 726, 830, 1036, 1138],
      },
      {
        nb: 2100,
        od: 2178,
        wallThicknesses: [10, 12, 14, 16, 20, 22],
        weights: [561, 673, 785, 896, 1118, 1228],
      },
      {
        nb: 2200,
        od: 2230,
        wallThicknesses: [10, 12, 14, 16, 20, 22],
        weights: [575, 689, 803, 917, 1144, 1257],
      },
    ];
    ...
    for (const pipe of pressureData) {
      ...
      if (nominalId) {
        for (const [wallThickness, pressure] of Object.entries(
          pipe.pressures,
        )) {

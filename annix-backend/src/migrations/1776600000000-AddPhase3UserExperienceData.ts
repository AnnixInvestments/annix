...
export class AddPhase3UserExperienceData1776600000000 implements MigrationInterface {
  ...
  private async createHdpeChemicalResistanceTable(
  ...
  private async createFlowCoefficientsTable(
    queryRunner: QueryRunner,
  ): Promise<void> {
  ...
  private async createRubberChemicalCompatibilityTable(
    queryRunner: QueryRunner,
  ): Promise<void> {
  ...
  private async populateHdpeChemicalResistanceData(
    queryRunner: QueryRunner,
  ): Promise<void> {
    const existing = await queryRunner.query(
      `SELECT COUNT(*) as count FROM hdpe_chemical_resistance`,
    );
    ...
    const chemicalData = [
      ...
      {
        substance: 'Acetic acid',
        concentration: '100% (glacial)',
        temps: { 20: '+', 60: '/' },
      },
      {
        substance: 'Acetic acid anhydride',
        concentration: '100%',
        temps: { 20: '+', 60: '-' },
      },
      {
      ...
      {
        substance: 'Aluminium fluoride',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Aluminium hydroxide',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Aluminium nitrate',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Aluminium sulphate',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
      ...
      {
        substance: 'Calcium hydroxide',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Calcium hypochlorite',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
      ...
      {
        substance: 'Chlorine',
        concentration: '10% in water',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Chlorine',
        concentration: 'gas dry',
        temps: { 20: '+', 60: '/' },
      },
      {
        substance: 'Chlorine',
        concentration: 'gas wet',
        temps: { 20: '+', 60: '/' },
      },
      {
      ...
      {
        substance: 'Copper chloride',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Copper sulphate',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
      ...
      {
        substance: 'Ferric chloride',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Ferric sulphate',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
      ...
      {
        substance: 'Nitric acid',
        concentration: 'fuming',
        temps: { 20: '-', 60: '-' },
      },
      {
        substance: 'Oxalic acid',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
      ...
      {
        substance: 'Sodium sulphate',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Sodium sulphide',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
        substance: 'Sodium thiosulphate',
        concentration: 'saturated',
        temps: { 20: '+', 60: '+' },
      },
      {
    ...
    for (const chemical of chemicalData) {
      for (const [temp, rating] of Object.entries(chemical.temps)) {
        const concentration = chemical.concentration
          ...
          : 'NULL';
        values.push(
          `('${chemical.substance}', ${concentration}, ${temp}, '${rating}')`,
        );
      }
    }
  ...
  private async populateFlowCoefficientsData(
    queryRunner: QueryRunner,
  ): Promise<void> {
    const existing = await queryRunner.query(
      `SELECT COUNT(*) as count FROM flow_coefficients`,
    );
    if (parseInt(existing[0]?.count) > 0) {
    ...
    const flowData = [
      ...
      {
        material: 'HDPE',
        condition: '10 years service',
        hazenWilliamsC: 145,
        manningN: 0.0095,
        absoluteRoughnessMm: 0.003,
      },
      {
        material: 'HDPE',
        condition: '25 years service',
        hazenWilliamsC: 140,
        manningN: 0.01,
        absoluteRoughnessMm: 0.005,
      },
      {
        material: 'HDPE',
        condition: '50 years service',
        hazenWilliamsC: 130,
        manningN: 0.011,
        absoluteRoughnessMm: 0.01,
      },
      {
        material: 'PP',
        condition: 'New',
      ...
      },
      {
        ...
        hazenWilliamsC: 130,
        manningN: 0.015,
        absoluteRoughnessMm: 0.3,
      },
      {
        material: 'Steel',
        condition: 'Moderately corroded',
        hazenWilliamsC: 100,
        manningN: 0.02,
        absoluteRoughnessMm: 1.0,
      },
      {
        material: 'Steel',
      ...
      },
      {
        ...
        hazenWilliamsC: 50,
        manningN: 0.04,
        absoluteRoughnessMm: 5.0,
      },
      {
        material: 'Ductile iron',
        condition: 'Cement lined',
        hazenWilliamsC: 140,
        manningN: 0.011,
        absoluteRoughnessMm: 0.025,
      },
      {
        material: 'Ductile iron',
        condition: 'Bitumen lined',
        hazenWilliamsC: 145,
        manningN: 0.01,
        absoluteRoughnessMm: 0.015,
      },
      {
        material: 'Concrete',
        condition: 'Smooth finish',
        hazenWilliamsC: 140,
        manningN: 0.012,
        absoluteRoughnessMm: 0.3,
      },
  ...
  private async populateRubberChemicalCompatibilityData(
    queryRunner: QueryRunner,
  ): Promise<void> {
    const existing = await queryRunner.query(
      `SELECT COUNT(*) as count FROM rubber_chemical_compatibility`,
    );
    if (parseInt(existing[0]?.count) > 0) {
      console.warn(
        'Rubber chemical compatibility data already exists, skipping...',
      );
      return;
    }
    console.warn(
      'Populating rubber chemical compatibility data (ISO/TR 7620)...',
    );
    ...
    const compatibilityData = [
      {
        ...
        concentration: '10-50%',
        temp: 60,
        ratings: { 'NR/SBR': 'A', Butyl: 'A', EPDM: 'A', NBR: 'B', CSM: 'A' },
      },
      {
        chemical: 'Sulphuric acid',
        concentration: '50-70%',
        temp: 60,
        ratings: { 'NR/SBR': 'C', Butyl: 'A', EPDM: 'A', NBR: 'C', CSM: 'A' },
      },
      {
        chemical: 'Sulphuric acid',
        concentration: '70-96%',
        temp: 60,
        ratings: { 'NR/SBR': 'C', Butyl: 'B', EPDM: 'C', NBR: 'C', CSM: 'B' },
      },
      {
        chemical: 'Hydrochloric acid',
        concentration: 'all conc',
        temp: 60,
        ratings: { 'NR/SBR': 'A', Butyl: 'A', EPDM: 'A', NBR: 'B', CSM: 'A' },
      },
      {
        ...
        concentration: '10%',
        temp: 60,
        ratings: { 'NR/SBR': 'C', Butyl: 'B', EPDM: 'B', NBR: 'C', CSM: 'A' },
      },
      {
        chemical: 'Nitric acid',
        concentration: '50%',
        temp: 60,
        ratings: { 'NR/SBR': 'C', Butyl: 'C', EPDM: 'C', NBR: 'C', CSM: 'B' },
      },
      {
      ...
      },
      {
        ...
        concentration: '100%',
        temp: 60,
        ratings: { 'NR/SBR': 'C', Butyl: 'C', EPDM: 'C', NBR: 'C', CSM: 'C' },
      },
      {
        chemical: 'Chromic acid',
        concentration: '10%',
        temp: 60,
        ratings: { 'NR/SBR': 'C', Butyl: 'C', EPDM: 'C', NBR: 'C', CSM: 'A' },
      },
      {
        chemical: 'Sodium hydroxide',
        concentration: '10-50%',
        temp: 60,
        ratings: { 'NR/SBR': 'A', Butyl: 'A', EPDM: 'A', NBR: 'A', CSM: 'A' },
      },
      {
        chemical: 'Ammonia',
        concentration: 'aqueous',
        temp: 60,
        ratings: { 'NR/SBR': 'A', Butyl: 'A', EPDM: 'A', NBR: 'B', CSM: 'C' },
      },
      {
      ...
      },
      {
        ...
        temp: 20,
        ratings: { 'NR/SBR': 'C', Butyl: 'A', EPDM: 'C', NBR: 'C', CSM: 'A' },
      },
      {
        chemical: 'Mineral oils',
        concentration: null,
        temp: 60,
        ratings: { 'NR/SBR': 'C', Butyl: 'C', EPDM: 'C', NBR: 'A', CSM: 'B' },
      },
      {
      ...
      {
        chemical: 'Petrol/Gasoline',
        concentration: null,
        temp: 20,
        ratings: { 'NR/SBR': 'C', Butyl: 'C', EPDM: 'C', NBR: 'A', CSM: 'C' },
      },
      {
        chemical: 'Kerosene',
        concentration: null,
      ...
      },
      {
        ...
        concentration: null,
        temp: 20,
        ratings: { 'NR/SBR': 'C', Butyl: 'C', EPDM: 'C', NBR: 'B', CSM: 'C' },
      },
      {
        chemical: 'Toluene',
        concentration: null,
      ...
      },
      {
        ...
        concentration: null,
        temp: 20,
        ratings: { 'NR/SBR': 'A', Butyl: 'A', EPDM: 'A', NBR: 'C', CSM: 'A' },
      },
      {
        chemical: 'Methanol',
        concentration: '100%',
      ...
      },
      {
        ...
        concentration: 'saturated',
        temp: 60,
        ratings: { 'NR/SBR': 'B', Butyl: 'A', EPDM: 'A', NBR: 'B', CSM: 'A' },
      },
      {
      ...
      },
      {
        ...
        concentration: '30%',
        temp: 20,
        ratings: { 'NR/SBR': 'C', Butyl: 'A', EPDM: 'A', NBR: 'C', CSM: 'B' },
      },
      {
      ...
      for (const [rubberType, rating] of Object.entries(compat.ratings)) {
        ...
        if (rubberTypeId) {
          const concentration = compat.concentration
            ...
            : 'NULL';
          values.push(
            `(${rubberTypeId}, '${compat.chemical}', ${concentration}, ${compat.temp}, '${rating}', 'ISO/TR 7620')`,
          );
        }
      }
    }
    ...
    console.warn(
      `Added ${values.length} rubber chemical compatibility entries.`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP TABLE IF EXISTS rubber_chemical_compatibility`,
    );

...
export class AddWasherData1772800000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const flatWasherData: Record<string, { massKg: number; odMm: number; idMm: number; thicknessMm: number }> = {
      ...
      'M12': { massKg: 0.010, odMm: 24.0, idMm: 13.0, thicknessMm: 2.5 },
      ...
      'M42': { massKg: 0.290, odMm: 78.0, idMm: 43.0, thicknessMm: 7.0 },
      'M45': { massKg: 0.356, odMm: 85.0, idMm: 46.0, thicknessMm: 7.0 },
      'M48': { massKg: 0.431, odMm: 92.0, idMm: 50.0, thicknessMm: 8.0 },
      'M52': { massKg: 0.550, odMm: 98.0, idMm: 54.0, thicknessMm: 8.0 },
    ...
    const splitWasherData: Record<string, { massKg: number; odMm: number; idMm: number; thicknessMm: number }> = {
    ...
    const toothWasherData: Record<string, { massKg: number; odMm: number; idMm: number; thicknessMm: number }> = {
      ...
      'M14': { massKg: 0.010, odMm: 24.0, idMm: 15.0, thicknessMm: 1.0 },
    ...
    const bellevilleWasherData: Record<string, { massKg: number; odMm: number; idMm: number; thicknessMm: number }> = {
      ...
      'M30': { massKg: 0.140, odMm: 60.0, idMm: 31.0, thicknessMm: 2.5 },
      'M36': { massKg: 0.220, odMm: 71.0, idMm: 37.0, thicknessMm: 3.0 },
    };

    const imperialFlatWasherData: Record<string, { massKg: number; odMm: number; idMm: number; thicknessMm: number }> = {
    ...
    const washerTypes = [
      ...
      { data: bellevilleWasherData, type: 'belleville', material: 'Carbon Steel' },
    ...
    const ssFlatWasherData: Record<string, { massKg: number; odMm: number; idMm: number; thicknessMm: number }> = {
      ...
      'M24': { massKg: 0.050, odMm: 44.0, idMm: 25.0, thicknessMm: 4.0 },
      'M30': { massKg: 0.100, odMm: 56.0, idMm: 31.0, thicknessMm: 4.0 },
    ...
    for (const [designation, spec] of Object.entries(ssFlatWasherData)) {
      ...
      await queryRunner.query(`
        ...
        VALUES ($1, $2, $3, $4, $5, $6, $7)
        ON CONFLICT DO NOTHING
      `, [boltId, 'flat', 'Stainless Steel 316', spec.massKg, spec.odMm, spec.idMm, spec.thicknessMm]);
    }

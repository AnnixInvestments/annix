...
export class AddSupportSpanAndNdtData1775700000000 implements MigrationInterface {
  ...
  private async addNickelAlloySpans(queryRunner: QueryRunner): Promise<void> {
    ...
    for (const alloy of nickelAlloys) {
      ...
      const spanFactor = modulusFactor ** 0.25 * densityFactor ** 0.5;
  ...
  private async createTemperatureDeratingTable(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
  ...
  private async createNdtRequirementsTable(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
    ...
    const allRequirements = [...asmeB313Requirements, ...awsRequirements, ...isoRequirements];

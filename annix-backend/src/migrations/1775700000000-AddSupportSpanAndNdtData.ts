...
export class AddSupportSpanAndNdtData1775700000000
  implements MigrationInterface
{
  ...
  private async addStainlessSteelSpans(queryRunner: QueryRunner): Promise<void> {
  ...
  private async addDuplexStainlessSpans(queryRunner: QueryRunner): Promise<void> {
  ...
  private async addNickelAlloySpans(queryRunner: QueryRunner): Promise<void> {
    const nickelSpanData = [
      { nb: 15, nps: '1/2"', water: 1.9, vapor: 2.4, rod: 10, modulus: 207, density: 8440 },
      { nb: 20, nps: '3/4"', water: 2.2, vapor: 2.7, rod: 10, modulus: 207, density: 8440 },
      { nb: 25, nps: '1"', water: 2.5, vapor: 3.1, rod: 10, modulus: 207, density: 8440 },
      { nb: 32, nps: '1-1/4"', water: 2.7, vapor: 3.4, rod: 10, modulus: 207, density: 8440 },
      { nb: 40, nps: '1-1/2"', water: 2.7, vapor: 3.4, rod: 10, modulus: 207, density: 8440 },
      { nb: 50, nps: '2"', water: 3.1, vapor: 3.9, rod: 10, modulus: 207, density: 8440 },
      { nb: 65, nps: '2-1/2"', water: 3.4, vapor: 4.2, rod: 10, modulus: 207, density: 8440 },
      { nb: 80, nps: '3"', water: 3.4, vapor: 4.2, rod: 10, modulus: 207, density: 8440 },
      { nb: 100, nps: '4"', water: 3.9, vapor: 4.8, rod: 12, modulus: 207, density: 8440 },
      { nb: 125, nps: '5"', water: 4.2, vapor: 5.1, rod: 12, modulus: 207, density: 8440 },
      { nb: 150, nps: '6"', water: 4.5, vapor: 5.3, rod: 16, modulus: 207, density: 8440 },
      { nb: 200, nps: '8"', water: 4.8, vapor: 5.9, rod: 16, modulus: 207, density: 8440 },
      { nb: 250, nps: '10"', water: 5.3, vapor: 6.5, rod: 20, modulus: 207, density: 8440 },
      { nb: 300, nps: '12"', water: 5.9, vapor: 7.0, rod: 20, modulus: 207, density: 8440 },
    ];
    ...
    for (const alloy of nickelAlloys) {
      ...
      const spanFactor = Math.pow(modulusFactor, 0.25) * Math.pow(densityFactor, 0.5);
  ...
  private async createTemperatureDeratingTable(
    ...
    const stainlessSteelDerating = [
      ...
      { temp: 550, factor: 0.840, modulus: 162 },
      { temp: 600, factor: 0.815, modulus: 157 },
      { temp: 650, factor: 0.788, modulus: 152 },
      { temp: 700, factor: 0.760, modulus: 147 },
      { temp: 750, factor: 0.730, modulus: 141 },
    ...
    const duplexDerating = [
      ...
      { temp: 100, factor: 0.990, modulus: 198 },
      { temp: 150, factor: 0.980, modulus: 196 },
    ...
    const nickelAlloyDerating = [
      { temp: 20, factor: 1.000, modulus: 207 },
      { temp: 100, factor: 0.990, modulus: 205 },
      ...
      { temp: 600, factor: 0.890, modulus: 184 },
    ...
    const contentTypes = [
      { type: 'empty', name: 'Empty/Air', density: 1.2, sg: 0.001, viscosity: 1.0, corrosion: 0 },
      { type: 'water', name: 'Water (20°C)', density: 998, sg: 1.0, viscosity: 1.0, corrosion: 0.5 },
      { type: 'steam', name: 'Steam', density: 0.6, sg: 0.0006, viscosity: 1.0, corrosion: 0.5 },
      { type: 'hydrocarbon_light', name: 'Light Hydrocarbon', density: 700, sg: 0.7, viscosity: 0.5, corrosion: 0.3 },
      { type: 'hydrocarbon_heavy', name: 'Heavy Hydrocarbon', density: 900, sg: 0.9, viscosity: 2.0, corrosion: 0.5 },
      { type: 'crude_oil', name: 'Crude Oil', density: 870, sg: 0.87, viscosity: 1.5, corrosion: 1.0 },
      { type: 'natural_gas', name: 'Natural Gas', density: 0.8, sg: 0.0008, viscosity: 1.0, corrosion: 0.3 },
      { type: 'nitrogen', name: 'Nitrogen', density: 1.25, sg: 0.00125, viscosity: 1.0, corrosion: 0 },
      { type: 'compressed_air', name: 'Compressed Air', density: 12, sg: 0.012, viscosity: 1.0, corrosion: 0.3 },
      { type: 'ammonia', name: 'Ammonia', density: 680, sg: 0.68, viscosity: 0.3, corrosion: 0.5 },
      { type: 'caustic_soda', name: 'Caustic Soda (50%)', density: 1530, sg: 1.53, viscosity: 5.0, corrosion: 1.5 },
      { type: 'sulfuric_acid', name: 'Sulfuric Acid (98%)', density: 1840, sg: 1.84, viscosity: 3.0, corrosion: 3.0 },
      { type: 'hydrochloric_acid', name: 'Hydrochloric Acid', density: 1200, sg: 1.2, viscosity: 1.5, corrosion: 3.0 },
      { type: 'seawater', name: 'Seawater', density: 1025, sg: 1.025, viscosity: 1.0, corrosion: 1.5 },
      { type: 'slurry_light', name: 'Light Slurry (<20% solids)', density: 1200, sg: 1.2, viscosity: 3.0, corrosion: 1.0 },
      { type: 'slurry_heavy', name: 'Heavy Slurry (>20% solids)', density: 1500, sg: 1.5, viscosity: 10.0, corrosion: 2.0 },
    ];
    ...
    for (const content of contentTypes) {
      ...
      `, [content.type, content.name, content.density, content.sg, content.viscosity, content.corrosion]);
    }
  }
  ...
  private async createNdtRequirementsTable(
    ...
    const ndtMethods = [
      {
        ...
        defects: ['surface_cracks', 'porosity', 'undercut', 'overlap', 'misalignment', 'spatter'],
        surfaceAccess: true,
        subsurface: false,
        surface: true,
        minWt: null,
      ...
      },
      {
        ...
        description: 'Detection of surface-breaking defects using dye penetrants',
        defects: ['surface_cracks', 'porosity', 'laps', 'seams', 'lack_of_fusion'],
        surfaceAccess: true,
        subsurface: false,
        surface: true,
        minWt: null,
      ...
      },
      {
        ...
        description: 'Detection of surface and near-surface defects in ferromagnetic materials',
        defects: ['surface_cracks', 'subsurface_cracks', 'laps', 'seams', 'inclusions'],
        surfaceAccess: true,
        subsurface: true,
        surface: true,
        minWt: null,
      ...
      },
      {
        ...
        defects: ['internal_cracks', 'lack_of_fusion', 'lack_of_penetration', 'porosity', 'inclusions', 'laminations'],
        surfaceAccess: true,
        subsurface: true,
        surface: false,
        minWt: 6,
      ...
      },
      {
        ...
        defects: ['porosity', 'inclusions', 'lack_of_fusion', 'lack_of_penetration', 'cracks', 'internal_voids'],
        surfaceAccess: true,
        subsurface: true,
        surface: true,
        minWt: 3,
      ...
      },
      {
        ...
        defects: ['internal_cracks', 'lack_of_fusion', 'lack_of_penetration', 'porosity', 'inclusions', 'sizing_defects'],
        surfaceAccess: true,
        subsurface: true,
        surface: false,
        minWt: 4,
      ...
      },
      {
        ...
        description: 'Electromagnetic examination for surface and near-surface defects',
        defects: ['surface_cracks', 'corrosion', 'wall_thinning', 'conductivity_variations'],
        surfaceAccess: true,
        subsurface: true,
        surface: true,
        minWt: null,
    ...
    const ndtCosts = [
      { method: 'VT', type: 'weld_inspection', unit: 'per_weld', baseZar: 150, baseUsd: 8, setup: 0, mob: 0, report: 100 },
      { method: 'VT', type: 'linear_meter', unit: 'per_meter', baseZar: 80, baseUsd: 4.5, setup: 0, mob: 0, report: 100 },
      { method: 'PT', type: 'weld_inspection', unit: 'per_weld', baseZar: 350, baseUsd: 19, setup: 200, mob: 500, report: 150 },
      { method: 'PT', type: 'linear_meter', unit: 'per_meter', baseZar: 220, baseUsd: 12, setup: 200, mob: 500, report: 150 },
      { method: 'MT', type: 'weld_inspection', unit: 'per_weld', baseZar: 400, baseUsd: 22, setup: 300, mob: 500, report: 150 },
      { method: 'MT', type: 'linear_meter', unit: 'per_meter', baseZar: 280, baseUsd: 15, setup: 300, mob: 500, report: 150 },
      { method: 'UT', type: 'weld_inspection', unit: 'per_weld', baseZar: 650, baseUsd: 36, setup: 500, mob: 800, report: 250 },
      { method: 'UT', type: 'linear_meter', unit: 'per_meter', baseZar: 380, baseUsd: 21, setup: 500, mob: 800, report: 250 },
      { method: 'UT', type: 'thickness_survey', unit: 'per_point', baseZar: 45, baseUsd: 2.5, setup: 200, mob: 500, report: 150 },
      { method: 'RT', type: 'weld_inspection', unit: 'per_weld', baseZar: 1200, baseUsd: 67, setup: 1000, mob: 1500, report: 500 },
      { method: 'RT', type: 'linear_meter', unit: 'per_meter', baseZar: 750, baseUsd: 42, setup: 1000, mob: 1500, report: 500 },
      { method: 'PAUT', type: 'weld_inspection', unit: 'per_weld', baseZar: 950, baseUsd: 53, setup: 800, mob: 1000, report: 400 },
      { method: 'PAUT', type: 'linear_meter', unit: 'per_meter', baseZar: 580, baseUsd: 32, setup: 800, mob: 1000, report: 400 },
      { method: 'TOFD', type: 'weld_inspection', unit: 'per_weld', baseZar: 1100, baseUsd: 61, setup: 900, mob: 1200, report: 450 },
      { method: 'TOFD', type: 'linear_meter', unit: 'per_meter', baseZar: 680, baseUsd: 38, setup: 900, mob: 1200, report: 450 },
      { method: 'ET', type: 'tube_inspection', unit: 'per_tube', baseZar: 180, baseUsd: 10, setup: 400, mob: 600, report: 200 },
      { method: 'ET', type: 'surface_scan', unit: 'per_m2', baseZar: 450, baseUsd: 25, setup: 400, mob: 600, report: 200 },
    ];
    ...
    for (const cost of ndtCosts) {
      await queryRunner.query(`
        ...
        ON CONFLICT (method_code, cost_type, min_wall_thickness_mm, min_diameter_mm) DO UPDATE SET
          base_cost_zar = $4,
          base_cost_usd = $5
      `, [cost.method, cost.type, cost.unit, cost.baseZar, cost.baseUsd, cost.setup, cost.mob, cost.report]);
    }
    ...
    const materialNdtReqs = [
      { group: 'carbon_steel', pNum: 1, surfaceNdt: ['VT'], volNdt: null, pwht: false, timing: null, special: null },
      { group: 'carbon_steel_fine_grain', pNum: 1, surfaceNdt: ['VT', 'MT'], volNdt: ['UT'], pwht: true, timing: 'after_pwht', special: 'Impact testing required below -29C' },
      { group: 'low_alloy_steel', pNum: 3, surfaceNdt: ['VT', 'MT'], volNdt: ['UT', 'RT'], pwht: true, timing: 'after_pwht', special: null },
      { group: 'cr_mo_steel', pNum: 4, surfaceNdt: ['VT', 'MT'], volNdt: ['UT', 'RT'], pwht: true, timing: 'after_pwht', special: 'Preheat required' },
      { group: 'cr_mo_steel_high', pNum: 5, surfaceNdt: ['VT', 'MT'], volNdt: ['UT', 'RT'], pwht: true, timing: 'after_pwht', special: 'Preheat and interpass temp control required' },
      { group: 'austenitic_ss', pNum: 8, surfaceNdt: ['VT', 'PT'], volNdt: ['RT'], pwht: false, timing: null, special: 'Ferrite content check may be required' },
      { group: 'duplex_ss', pNum: 10, surfaceNdt: ['VT', 'PT'], volNdt: ['RT', 'UT'], pwht: false, timing: null, special: 'Ferrite/austenite ratio verification required' },
      { group: 'nickel_alloy', pNum: 41, surfaceNdt: ['VT', 'PT'], volNdt: ['RT'], pwht: false, timing: null, special: 'Low heat input required' },
      { group: 'nickel_alloy_high', pNum: 43, surfaceNdt: ['VT', 'PT'], volNdt: ['RT', 'UT'], pwht: true, timing: 'after_pwht', special: 'Special filler metal required' },
      { group: 'titanium', pNum: 51, surfaceNdt: ['VT', 'PT'], volNdt: ['RT'], pwht: false, timing: null, special: 'Inert gas shielding required, color inspection' },
      { group: 'aluminum', pNum: 21, surfaceNdt: ['VT', 'PT'], volNdt: ['RT'], pwht: false, timing: null, special: null },
      { group: 'copper', pNum: 31, surfaceNdt: ['VT', 'PT'], volNdt: null, pwht: false, timing: null, special: null },
    ];
    ...
    for (const req of materialNdtReqs) {
      ...
      `, [req.group, req.pNum, req.surfaceNdt, req.volNdt, req.pwht, req.timing, req.special]);
    }
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS support_span_temperature_derating`);

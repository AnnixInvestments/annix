...
export class AddSmallMetricBolts1772600000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const smallBolts = [
      { designation: 'M6', grade: '8.8', material: 'Carbon Steel', headStyle: 'hex', threadType: 'coarse', threadPitchMm: 1.0 },
      { designation: 'M8', grade: '8.8', material: 'Carbon Steel', headStyle: 'hex', threadType: 'coarse', threadPitchMm: 1.25 },
      { designation: 'M6 10.9', grade: '10.9', material: 'Carbon Steel', headStyle: 'hex', threadType: 'coarse', threadPitchMm: 1.0 },
      { designation: 'M8 10.9', grade: '10.9', material: 'Carbon Steel', headStyle: 'hex', threadType: 'coarse', threadPitchMm: 1.25 },
      { designation: 'M6 A4', grade: 'A4-70', material: 'Stainless Steel 316', headStyle: 'hex', threadType: 'coarse', threadPitchMm: 1.0 },
      { designation: 'M8 A4', grade: 'A4-70', material: 'Stainless Steel 316', headStyle: 'hex', threadType: 'coarse', threadPitchMm: 1.25 },
    ];
    ...
    const m6MassData: Record<number, number> = {
      12: 0.003, 16: 0.004, 20: 0.005, 25: 0.006, 30: 0.008, 35: 0.009, 40: 0.011, 45: 0.012, 50: 0.014, 55: 0.015, 60: 0.017,
    };

    const m8MassData: Record<number, number> = {
      16: 0.007, 20: 0.009, 25: 0.011, 30: 0.013, 35: 0.015, 40: 0.018, 45: 0.020, 50: 0.023, 55: 0.025, 60: 0.027, 65: 0.030, 70: 0.032, 80: 0.037,
    };

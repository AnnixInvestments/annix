...
export class AddComprehensiveScheduleDatabase1699376000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const insertPipeDimension = async (
      nominalBore: number,
    ...
    await insertPipeDimension(100, "Sch10", 10, 3.4, 8.63);
    await insertPipeDimension(125, "Sch10", 10, 3.4, 10.85);
    await insertPipeDimension(150, "Sch10", 10, 3.4, 13.08);
    ...
    // Schedule 30 data
    await insertPipeDimension(40, "Sch30", 30, 3.68, 3.7);
    ...
    await insertPipeDimension(250, "Sch100", 100, 12.7, 66.63);
    await insertPipeDimension(300, "Sch100", 100, 12.7, 80.21);
    ...
    await insertPipeDimension(100, "Sch140", 140, 10.97, 24.7);
    await insertPipeDimension(125, "Sch140", 140, 12.7, 33.54);
    await insertPipeDimension(150, "Sch140", 140, 12.7, 40.24);
    ...
    await insertPipeDimension(100, "Sch160", 160, 12.7, 27.68);
    ...
    await insertPipeDimension(40, "STD", null, 3.68, 3.7);
    ...
    await insertPipeDimension(200, "XS", null, 12.7, 54.77);
    ...
    await insertPipeDimension(40, "XXS", null, 9.7, 9.11);
    await insertPipeDimension(50, "XXS", null, 11.07, 12.52);
    await insertPipeDimension(65, "XXS", null, 12.7, 17.29);
    ...
    await insertPipeDimension(200, "XXS", null, 25.4, 93.45);
    await insertPipeDimension(250, "XXS", null, 30.18, 133.22);
    await insertPipeDimension(300, "XXS", null, 34.93, 180.72);

    console.warn("Successfully added comprehensive schedule database with all standard schedules");
  }

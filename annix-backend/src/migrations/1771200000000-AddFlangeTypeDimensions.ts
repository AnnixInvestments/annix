...
export class AddFlangeTypeDimensions1771200000000
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const swClass300Data: [
      ...
      ['2-1/2', 190, 25, 76, 2, 8, 22, 'M20', 149, 5.90],
    ];
    ...
    const swClass600Data: [
      ...
      ['2-1/2', 190, 29, 76, 7, 8, 22, 'M20', 149, 6.80],
    ];
    ...
    const thClass150Data: [
      ...
      ['2-1/2', 178, 22, 76, 2, 4, 19, 'M16', 140, 3.63],
      ['3', 191, 24, 90, 2, 4, 19, 'M16', 152, 4.54],
      ['3-1/2', 216, 24, 102, 2, 8, 19, 'M16', 178, 5.90],
      ['4', 229, 24, 115, 2, 8, 19, 'M16', 191, 6.80],
      ...
      ['18', 635, 41, 461, 2, 16, 33, 'M30', 578, 63.50],

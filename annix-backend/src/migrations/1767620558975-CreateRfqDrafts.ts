...
export class CreateRfqDrafts1767620558975 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "rfq_items" ADD "description" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "rfq_documents" ADD "filename" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "rfq_documents" DROP COLUMN "file_path"`);
        await queryRunner.query(`ALTER TABLE "rfq_documents" ADD "file_path" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "rfq_documents" DROP COLUMN "mime_type"`);
        await queryRunner.query(`ALTER TABLE "rfq_documents" ADD "mime_type" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "rfqs" ADD "rfq_number" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "rfqs" ADD "project_name" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "pipe_steel_grades" ADD "code" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "pipe_steel_grades" ADD "name" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "pipe_schedule_walls" ADD "nps" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "pipe_schedule_walls" DROP COLUMN "schedule"`);
        await queryRunner.query(`ALTER TABLE "pipe_schedule_walls" ADD "schedule" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "pipe_nps_od" ADD "nps" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "admin_sessions" ADD "session_token" character varying NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "admin_sessions" ADD "client_ip" character varying NOT NULL`);

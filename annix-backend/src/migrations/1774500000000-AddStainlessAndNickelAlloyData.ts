...
export class AddStainlessAndNickelAlloyData1774500000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const stainlessGrades = [
      ...
      { code: 'A312_TP304H', name: 'ASTM A312 TP304H (18Cr-8Ni High Carbon)', stressData: [
      ...
      { code: 'A312_TP316H', name: 'ASTM A312 TP316H (16Cr-12Ni-2Mo High Carbon)', stressData: [
        { tempC: -196, tempF: -320, ksi: 18.8, mpa: 129.6 },
        { tempC: -129, tempF: -200, ksi: 18.8, mpa: 129.6 },
        { tempC: -29, tempF: -20, ksi: 18.8, mpa: 129.6 },
        { tempC: 38, tempF: 100, ksi: 18.8, mpa: 129.6 },
      ...
      { code: 'A312_TP321', name: 'ASTM A312 TP321 (18Cr-10Ni-Ti Stabilized)', stressData: [
        { tempC: -196, tempF: -320, ksi: 18.8, mpa: 129.6 },
        { tempC: -29, tempF: -20, ksi: 18.8, mpa: 129.6 },
        { tempC: 38, tempF: 100, ksi: 18.8, mpa: 129.6 },
        { tempC: 93, tempF: 200, ksi: 16.9, mpa: 116.5 },
      ...
      { code: 'A312_TP321H', name: 'ASTM A312 TP321H (18Cr-10Ni-Ti High Carbon)', stressData: [
        { tempC: -196, tempF: -320, ksi: 18.8, mpa: 129.6 },
        { tempC: -29, tempF: -20, ksi: 18.8, mpa: 129.6 },
        { tempC: 38, tempF: 100, ksi: 18.8, mpa: 129.6 },
        { tempC: 93, tempF: 200, ksi: 16.9, mpa: 116.5 },
      ...
      { code: 'A312_TP347', name: 'ASTM A312 TP347 (18Cr-10Ni-Nb Stabilized)', stressData: [
        { tempC: -196, tempF: -320, ksi: 18.8, mpa: 129.6 },
        { tempC: -29, tempF: -20, ksi: 18.8, mpa: 129.6 },
        { tempC: 38, tempF: 100, ksi: 18.8, mpa: 129.6 },
        { tempC: 93, tempF: 200, ksi: 16.9, mpa: 116.5 },
      ...
      { code: 'A312_TP347H', name: 'ASTM A312 TP347H (18Cr-10Ni-Nb High Carbon)', stressData: [
        { tempC: -196, tempF: -320, ksi: 18.8, mpa: 129.6 },
        { tempC: -29, tempF: -20, ksi: 18.8, mpa: 129.6 },
        { tempC: 38, tempF: 100, ksi: 18.8, mpa: 129.6 },
        { tempC: 93, tempF: 200, ksi: 16.9, mpa: 116.5 },
      ...
      { code: 'A312_TP309S', name: 'ASTM A312 TP309S (23Cr-12Ni High Temp)', stressData: [
        { tempC: -29, tempF: -20, ksi: 18.8, mpa: 129.6 },
        { tempC: 38, tempF: 100, ksi: 18.8, mpa: 129.6 },
      ...
      { code: 'A312_TP310S', name: 'ASTM A312 TP310S (25Cr-20Ni Highest Temp)', stressData: [
        { tempC: -29, tempF: -20, ksi: 18.8, mpa: 129.6 },
        { tempC: 38, tempF: 100, ksi: 18.8, mpa: 129.6 },
        { tempC: 93, tempF: 200, ksi: 16.2, mpa: 111.7 },
        { tempC: 149, tempF: 300, ksi: 14.8, mpa: 102.0 },
    ...
    const duplexGrades = [
      ...
      { code: 'A790_S31803', name: 'ASTM A790 S31803 Duplex (22Cr-5Ni-3Mo)', stressData: [
      ...
      // S32205 - Duplex 2205
      { code: 'A790_S32205', name: 'ASTM A790 S32205 Duplex 2205', stressData: [
      ...
      { code: 'A790_S32750', name: 'ASTM A790 S32750 Super Duplex 2507', stressData: [
      ...
      { code: 'A790_S32760', name: 'ASTM A790 S32760 Super Duplex Zeron 100', stressData: [
        { tempC: -46, tempF: -50, ksi: 36.4, mpa: 251.0 },
        { tempC: -29, tempF: -20, ksi: 36.4, mpa: 251.0 },
        { tempC: 38, tempF: 100, ksi: 36.4, mpa: 251.0 },
        { tempC: 93, tempF: 200, ksi: 32.8, mpa: 226.1 },
    ...
    const nickelGrades = [
      // Monel 400
      { code: 'B165_MONEL400', name: 'ASTM B165 Monel 400 (Ni-Cu)', stressData: [
      ...
      // Inconel 600
      { code: 'B167_INCONEL600', name: 'ASTM B167 Inconel 600 (Ni-Cr-Fe)', stressData: [
      ...
      // Incoloy 800H
      { code: 'B407_INCOLOY800H', name: 'ASTM B407 Incoloy 800H (Ni-Fe-Cr)', stressData: [
      ...
      // Incoloy 825
      { code: 'B423_INCOLOY825', name: 'ASTM B423 Incoloy 825 (Ni-Fe-Cr-Mo-Cu)', stressData: [
        { tempC: -29, tempF: -20, ksi: 23.3, mpa: 160.6 },
        { tempC: 38, tempF: 100, ksi: 23.3, mpa: 160.6 },
      ...
      // Inconel 625
      { code: 'B444_INCONEL625', name: 'ASTM B444 Inconel 625 (Ni-Cr-Mo-Nb)', stressData: [
      ...
      // Hastelloy C-276
      { code: 'B619_HASTELLOYC276', name: 'ASTM B619 Hastelloy C-276 (Ni-Mo-Cr)', stressData: [

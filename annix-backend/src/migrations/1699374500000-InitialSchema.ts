...
export class InitialSchema1699374500000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "rfqs" ADD CONSTRAINT "FK_aba921c26dfeef3d7662eb97b21" FOREIGN KEY ("created_by_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "straight_pipe_rfqs" ADD CONSTRAINT "FK_b40657905110c1bde5a3767dad1" FOREIGN KEY ("steel_specification_id") REFERENCES "steel_specifications"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "straight_pipe_rfqs" DROP CONSTRAINT "FK_b40657905110c1bde5a3767dad1"`,
    );
    await queryRunner.query(

...
export class AddRemainingPhase2Items1777600000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const instValveTypes = [
      [
        ...
        'Standard needle valve for flow control',
        'ISOLATION',
      ],
      [
        'NV-ANGLE',
      ...
      [
        ...
        'Multiple port manifold valve',
        'MANIFOLD',
      ],
      [
        'BV-INST',
        'Instrument Ball Valve',
        'Mini ball valve for instruments',
        'ISOLATION',
      ],
      ...
      [
        ...
        '2-way instrument manifold',
        'MANIFOLD',
      ],
      [
        'MV-3WAY',
        'Manifold Valve 3-Way',
        '3-way instrument manifold',
        'MANIFOLD',
      ],
      [
        'MV-5WAY',
        'Manifold Valve 5-Way',
        '5-way instrument manifold',
        'MANIFOLD',
      ],
      ['GC-STD', 'Gauge Cock', 'Standard gauge isolation valve', 'GAUGE'],
      [
        'GC-BLEED',
        'Gauge Cock with Bleed',
        'Gauge cock with vent/bleed port',
        'GAUGE',
      ],
      [
        'TW-STD',
        'Thermowell',
        'Standard thermowell for temperature sensors',
        'THERMOWELL',
      ],
      [
        'TW-SOCK',
      ...
      [
        'TW-FLNG',
        'Flanged Thermowell',
        'Flanged thermowell for large connections',
        'THERMOWELL',
      ],
    ];
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_insulation_specs_type_nb`,
    );

    await queryRunner.query(
      `DROP TABLE IF EXISTS heat_treatment_specifications`,
    );

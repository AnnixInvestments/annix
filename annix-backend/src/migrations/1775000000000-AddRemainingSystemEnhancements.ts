...
export class AddRemainingSystemEnhancements1775000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const compatibilityRules = [
      {
        m1: 'Carbon Steel',
        m2: 'Type 304 SS (passive)',
        compat: 'Caution',
        diff: 550,
      },
      {
        m1: 'Carbon Steel',
        m2: 'Type 316 SS (passive)',
        compat: 'Caution',
        diff: 600,
      },
      ...
      { m1: 'Carbon Steel', m2: 'Titanium', compat: 'Avoid', diff: 800 },
      {
        ...
        compat: 'Compatible',
        diff: 350,
        notes: 'Zinc sacrificial anode',
      },
      {
        m1: 'Type 304 SS (passive)',
        m2: 'Type 316 SS (passive)',
        compat: 'Compatible',
        diff: 50,
      },
    ...
    const crackingData = [
      {
        ...
        mech: 'H2S (SSC)',
        susc: 'Susceptible',
        cond: 'pH < 4, H2S > 50 ppm, hardness > 22 HRC',
        mit: 'Limit hardness to 22 HRC max, use NACE MR0175 compliant',
      ...
      },
      {
        ...
        mech: 'Caustic SCC',
        susc: 'Susceptible',
        cond: 'NaOH > 5%, temp > 50C',
        mit: 'PWHT required, limit concentration/temperature',
        ref: 'API RP 571',
      },
      {
        mat: 'A106 Grade B',
        mech: 'Carbonate SCC',
        susc: 'Susceptible',
        cond: 'CO3/HCO3 solutions, temp > 70C',
        mit: 'PWHT required',
        ref: 'API RP 571',
      },
      {
        ...
        mech: 'HIC/SOHIC',
        susc: 'Susceptible',
        cond: 'Wet H2S service, high sulfur steel',
        mit: 'Use HIC-resistant steel per NACE TM0284',
        ref: 'NACE TM0284',
      },
      {
        mat: 'A312 TP304',
        mech: 'Chloride SCC',
        susc: 'Susceptible',
        cond: 'Cl > 10 ppm, temp > 60C, tensile stress',
        mit: 'Use 316L, duplex, or Ni alloys',
        ref: 'API RP 571',
      },
      {
        mat: 'A312 TP304L',
        mech: 'Chloride SCC',
        susc: 'Susceptible',
        cond: 'Cl > 10 ppm, temp > 60C',
        mit: 'Use duplex or Ni alloys above 80C',
        ref: 'API RP 571',
      },
      {
        mat: 'A312 TP316',
        mech: 'Chloride SCC',
        susc: 'Moderate',
        cond: 'Cl > 100 ppm, temp > 60C',
        mit: 'Use duplex above 80C',
        ref: 'API RP 571',
      },
      {
        mat: 'A312 TP316L',
        ...
        susc: 'Moderate',
        cond: 'Cl > 100 ppm, temp > 60C',
        mit: 'Use duplex above 100C',
        ref: 'API RP 571',
      },
      {
        mat: 'A312 TP304',
        mech: 'Polythionic Acid SCC',
        susc: 'Susceptible',
        cond: 'Sensitized material, sulfur compounds, moisture, air',
        mit: 'Use stabilized grades (321, 347) or L grades, soda ash wash',
        ref: 'NACE SP0170',
      },
      {
        mat: 'A312 TP321',
        mech: 'Polythionic Acid SCC',
        susc: 'Resistant',
        cond: 'Stabilized grade',
        mit: 'Solution anneal after welding',
        ref: 'NACE SP0170',
      },
      {
        mat: 'A312 TP347',
      ...
      },
      {
        ...
        mech: 'Chloride SCC',
        susc: 'Resistant',
        cond: 'Good resistance to 150C',
        mit: 'Verify ferrite/austenite balance',
        ref: 'API RP 571',
      },
      {
        mat: 'A790 S32205',
      ...
      },
      {
        mat: 'A790 S32750',
        mech: 'Chloride SCC',
        susc: 'Highly Resistant',
        cond: 'Good resistance to 200C',
        mit: 'Control intermetallic phases',
        ref: 'API RP 571',
      },
      {
        mat: 'A335 P5',
        mech: 'H2S (SSC)',
        susc: 'Moderate',
        cond: 'Tempered condition OK',
        mit: 'PWHT required, hardness < 22 HRC',
        ref: 'NACE MR0175',
      },
      {
        mat: 'A335 P11',
      ...
      },
      {
        ...
        mech: 'H2S (SSC)',
        susc: 'Moderate',
        cond: 'Tempered condition, hardness critical',
        mit: 'Strict PWHT, hardness < 250 HB',
        ref: 'NACE MR0175',
      },
      {
        mat: 'Monel 400',
        mech: 'H2S (SSC)',
        susc: 'Resistant',
        cond: 'Good H2S resistance',
        mit: 'Limit hardness for severe service',
        ref: 'NACE MR0175',
      },
      {
        mat: 'Inconel 625',
        mech: 'Chloride SCC',
        susc: 'Highly Resistant',
        cond: 'Excellent resistance',
        mit: 'Standard practice',
        ref: 'API RP 571',
      },
      {
        mat: 'Inconel 625',
        mech: 'H2S (SSC)',
        susc: 'Resistant',
        cond: 'Age-hardened condition may be susceptible',
        mit: 'Use solution annealed condition',
        ref: 'NACE MR0175',
      },
      {
        mat: 'Hastelloy C-276',
      ...
      },
      {
        ...
        mech: 'H2S (SSC)',
        susc: 'Resistant',
        cond: 'Good resistance',
        mit: 'Solution annealed condition',
        ref: 'NACE MR0175',
      },
    ];
    ...
    const coatingData = [
      {
        type: 'Fusion Bonded Epoxy (FBE)',
        cat: 'Thermosetting',
        maxT: 110,
        minT: -40,
        chem: 'Good acid/alkali resistance, moderate solvent resistance',
        suit: 'Water, crude oil, natural gas',
        notSuit: 'Strong solvents, aromatic hydrocarbons above 80C',
        dft: '300-500',
      },
      {
        type: 'Coal Tar Epoxy',
        ...
        maxT: 60,
        minT: -10,
        chem: 'Excellent water resistance, good chemical resistance',
        suit: 'Immersion service, marine, buried pipe',
        notSuit: 'High temperature, UV exposure',
        dft: '400-800',
      },
      {
        type: 'Polyurethane',
        ...
        maxT: 120,
        minT: -40,
        chem: 'Good chemical resistance, excellent abrasion resistance',
        suit: 'Abrasive slurries, chemical service',
        notSuit: 'Strong acids, ketones',
        dft: '250-500',
      },
      {
        type: 'Phenolic Epoxy',
        ...
        maxT: 150,
        minT: -20,
        chem: 'Excellent acid resistance, good solvent resistance',
        suit: 'Sour crude, H2S service, acids',
        notSuit: 'Strong alkalis above 50C',
        dft: '150-300',
      },
      {
        type: 'Novolac Epoxy',
        ...
        maxT: 180,
        minT: -20,
        chem: 'Excellent chemical/solvent resistance',
        suit: 'High-temp chemical service, solvents',
        notSuit: 'Very strong oxidizers',
        dft: '300-600',
      },
      {
        ...
        maxT: 100,
        minT: -20,
        chem: 'Excellent permeation resistance',
        suit: 'Immersion, chemical tanks',
        notSuit: 'Thermal cycling',
        dft: '800-1500',
      },
      {
        type: 'Glass Flake Vinyl Ester',
        cat: 'Thermosetting',
        maxT: 120,
        minT: -20,
        chem: 'Superior acid resistance',
        suit: 'Strong acids, bleach, chlorine',
        notSuit: 'Strong solvents',
        dft: '800-1500',
      },
      {
        type: 'Rubber Lining (Soft)',
        cat: 'Elastomer',
        maxT: 80,
        minT: -30,
        chem: 'Excellent acid/alkali resistance',
        suit: 'Acid service, slurries, abrasive media',
        notSuit: 'Oils, solvents, ozone',
        dft: '3000-6000',
      },
      {
        type: 'Rubber Lining (Hard)',
        cat: 'Elastomer',
        maxT: 90,
        minT: -20,
        chem: 'Good abrasion resistance',
        suit: 'Abrasive slurries, mineral acids',
        notSuit: 'Oils, solvents',
        dft: '4000-8000',
      },
      {
        type: 'PTFE Lining',
        ...
        maxT: 260,
        minT: -200,
        chem: 'Outstanding chemical resistance',
        suit: 'Strong acids/alkalis, solvents, cryogenic',
        notSuit: 'Molten alkali metals, fluorine',
        dft: '2000-4000',
      },
      {
        type: 'PFA Lining',
        ...
        maxT: 260,
        minT: -200,
        chem: 'Outstanding chemical resistance, better than PTFE',
        suit: 'Aggressive chemicals, pharmaceutical',
        notSuit: 'Molten alkali metals',
        dft: '1500-3000',
      },
      {
        type: 'PVDF Lining',
        ...
        maxT: 140,
        minT: -40,
        chem: 'Excellent chemical resistance',
        suit: 'Acids, chlorine, bromine, oxidizers',
        notSuit: 'Strong alkalis, ketones, amines',
        dft: '1500-3000',
      },
      {
        type: 'Polypropylene Lining',
        cat: 'Thermoplastic',
        maxT: 100,
        minT: 0,
        chem: 'Good acid/alkali resistance',
        suit: 'Dilute acids/alkalis, water treatment',
        notSuit: 'Organic solvents, oxidizing acids',
        dft: '3000-6000',
      },
      {
        type: 'HDPE Lining',
        ...
        maxT: 80,
        minT: -50,
        chem: 'Good chemical resistance',
        suit: 'Water, dilute chemicals',
        notSuit: 'Hydrocarbons, chlorinated solvents',
        dft: '2000-4000',
      },
      {
        type: 'Ceramic Epoxy',
        ...
        maxT: 200,
        minT: -20,
        chem: 'Good chemical/abrasion resistance',
        suit: 'Abrasive slurries, high-temp chemical',
        notSuit: 'Impact, thermal shock',
        dft: '500-1000',
      },
      {
        type: 'Cement Mortar Lining',
        cat: 'Cite',
        maxT: 70,
        minT: 0,
        chem: 'Good for potable water, soft water corrosion',
        suit: 'Potable water, aggressive water',
        notSuit: 'Acids, low pH water',
        dft: '6000-12000',
      },
      {
        type: 'Zinc Rich Primer',
        cat: 'Metallic',
        maxT: 400,
        minT: -50,
        chem: 'Cathodic protection for steel',
        suit: 'Atmospheric exposure, primer coat',
        notSuit: 'Immersion in acids/alkalis',
        dft: '50-100',
      },
      {
        type: 'Thermal Spray Aluminum',
        cat: 'Metallic',
        maxT: 540,
        minT: -200,
        chem: 'Cathodic protection, high temp',
        suit: 'Offshore, high temp, cryogenic',
        notSuit: 'Strong acids/alkalis',
        dft: '200-350',
      },
    ];
    ...
    const traceabilityReqs = [
      ...
      },
      {
        ...
        lot: true,
        wit: 'HIC/SSC testing',
        doc: 'MTR, HIC test report, hardness survey',
      },
      {
        mat: 'Carbon Steel',
        svc: 'Low Temperature',
      ...
      },
      {
        ...
        heat: true,
        lot: false,
        wit: 'PMI verification',
        doc: 'MTR, PMI report',
      },
      {
        mat: 'Alloy Steel',
        svc: 'High Temperature',
        mtr: true,
        pmi: true,
        heat: true,
        lot: true,
        wit: 'PMI, hardness check',
        doc: 'MTR, PMI, hardness report, PWHT chart',
      },
      {
        mat: 'Stainless Steel',
        svc: 'General',
      ...
      },
      {
        ...
        heat: true,
        lot: true,
        wit: 'IGC test, ferrite check',
        doc: 'MTR, PMI, IGC report, ferrite report',
      },
      {
        mat: 'Duplex SS',
        svc: 'General',
        ...
        heat: true,
        lot: true,
        wit: 'Ferrite check, CPT test',
        doc: 'MTR, PMI, ferrite, CPT, microstructure',
      },
      {
        mat: 'Nickel Alloy',
        svc: 'General',
        ...
        heat: true,
        lot: true,
        wit: 'PMI, solution anneal verify',
        doc: 'MTR, PMI, heat treatment certificate',
      },
      {
        mat: 'Titanium',
        svc: 'General',
        ...
        heat: true,
        lot: true,
        wit: 'PMI, surface condition',
        doc: 'MTR, PMI, processing records',
      },
    ];
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP TABLE IF EXISTS material_traceability_requirements`,
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS coating_lining_compatibility`,
    );
    await queryRunner.query(
      `DROP TABLE IF EXISTS environmental_cracking_susceptibility`,
    );

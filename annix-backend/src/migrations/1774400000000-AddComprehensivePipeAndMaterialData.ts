...
export class AddComprehensivePipeAndMaterialData1774400000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const smallBoreData = [
      ...
      { nps: '1/8', odInch: 0.405, odMm: 10.29, nbMm: 6, schedules: {
        '5S': 0.035, '10S': 0.049, '40': 0.068, '40S': 0.068, '80': 0.095, '80S': 0.095
      }},
      // NPS 1/4" (DN 8) - OD 0.540" / 13.72mm
      { nps: '1/4', odInch: 0.540, odMm: 13.72, nbMm: 8, schedules: {
        '5S': 0.049, '10S': 0.065, '40': 0.088, '40S': 0.088, '80': 0.119, '80S': 0.119
      }},
      // NPS 3/8" (DN 10) - OD 0.675" / 17.15mm
      { nps: '3/8', odInch: 0.675, odMm: 17.15, nbMm: 10, schedules: {
        '5S': 0.049, '10S': 0.065, '40': 0.091, '40S': 0.091, '80': 0.126, '80S': 0.126
      }},
    ];
    ...
    const additionalSchedules: { [nps: string]: { od: number; odMm: number; nbMm: number; schedules: { [sch: string]: number } } } = {
      '4': { od: 4.5, odMm: 114.3, nbMm: 100, schedules: { '10': 0.12, '20': 0.188, '30': 0.237, '60': 0.337, '100': 0.438, '120': 0.531, '140': 0.674 }},
      '5': { od: 5.563, odMm: 141.3, nbMm: 125, schedules: { '10': 0.134, '20': 0.188, '30': 0.258, '60': 0.375, '100': 0.5, '120': 0.625, '140': 0.75 }},
      '6': { od: 6.625, odMm: 168.28, nbMm: 150, schedules: { '10': 0.134, '20': 0.188, '30': 0.28, '60': 0.432, '100': 0.562, '120': 0.719, '140': 0.864 }},
      '8': { od: 8.625, odMm: 219.08, nbMm: 200, schedules: { '10': 0.148, '20': 0.25, '30': 0.277, '60': 0.406, '100': 0.594, '120': 0.719, '140': 0.812 }},
      '10': { od: 10.75, odMm: 273.05, nbMm: 250, schedules: { '10': 0.165, '20': 0.25, '30': 0.307, '60': 0.5, '100': 0.719, '120': 0.844, '140': 1.0 }},
      '12': { od: 12.75, odMm: 323.85, nbMm: 300, schedules: { '10': 0.18, '20': 0.25, '30': 0.33, '60': 0.562, '100': 0.844, '120': 1.0, '140': 1.125 }},
      '14': { od: 14.0, odMm: 355.6, nbMm: 350, schedules: { '10': 0.188, '20': 0.312, '30': 0.375, '60': 0.594, '100': 0.938, '120': 1.094, '140': 1.25 }},
      '16': { od: 16.0, odMm: 406.4, nbMm: 400, schedules: { '10': 0.188, '20': 0.312, '30': 0.375, '60': 0.656, '100': 1.031, '120': 1.219, '140': 1.438 }},
      '18': { od: 18.0, odMm: 457.2, nbMm: 450, schedules: { '10': 0.188, '20': 0.312, '30': 0.438, '60': 0.75, '100': 1.156, '120': 1.375, '140': 1.562 }},
      '20': { od: 20.0, odMm: 508.0, nbMm: 500, schedules: { '10': 0.218, '20': 0.375, '30': 0.5, '60': 0.812, '100': 1.281, '120': 1.5, '140': 1.75 }},
      '24': { od: 24.0, odMm: 609.6, nbMm: 600, schedules: { '10': 0.25, '20': 0.375, '30': 0.562, '60': 0.969, '100': 1.531, '120': 1.812, '140': 2.062 }},
      '26': { od: 26.0, odMm: 660.4, nbMm: 650, schedules: { '10': 0.312, '20': 0.5, 'STD': 0.375, 'XS': 0.5 }},
      '28': { od: 28.0, odMm: 711.2, nbMm: 700, schedules: { '10': 0.312, '20': 0.5, '30': 0.625, 'STD': 0.375, 'XS': 0.5 }},
      '30': { od: 30.0, odMm: 762.0, nbMm: 750, schedules: { '10': 0.312, '20': 0.5, '30': 0.625, 'STD': 0.375, 'XS': 0.5 }},
      '32': { od: 32.0, odMm: 812.8, nbMm: 800, schedules: { '10': 0.312, '20': 0.5, '30': 0.625, '40': 0.688, 'STD': 0.375, 'XS': 0.5 }},
      '34': { od: 34.0, odMm: 863.6, nbMm: 850, schedules: { '10': 0.312, '20': 0.5, '30': 0.625, '40': 0.688, 'STD': 0.375, 'XS': 0.5 }},
      '36': { od: 36.0, odMm: 914.4, nbMm: 900, schedules: { '10': 0.312, '20': 0.5, '30': 0.625, '40': 0.75, 'STD': 0.375, 'XS': 0.5 }},
      '42': { od: 42.0, odMm: 1066.8, nbMm: 1050, schedules: { '20': 0.5, '30': 0.625, '40': 0.75, 'STD': 0.375, 'XS': 0.5 }},
      '48': { od: 48.0, odMm: 1219.2, nbMm: 1200, schedules: { '20': 0.5, '30': 0.625, '40': 0.75, 'STD': 0.375, 'XS': 0.5 }},
    };
    ...
    const a333Grades = [
      ...
      { code: 'A333_GR1', name: 'ASTM A333 Grade 1 (Carbon-Manganese, -46°C)', stressData: [
      ...
      { code: 'A333_GR6', name: 'ASTM A333 Grade 6 (Carbon-Mn-Si, -46°C)', stressData: [
      ...
      { code: 'A333_GR3', name: 'ASTM A333 Grade 3 (3.5Ni, -101°C)', stressData: [
      ...
      { code: 'A333_GR8', name: 'ASTM A333 Grade 8 (9Ni Cryogenic, -196°C)', stressData: [
    ...
    const api5lGrades = [
      { code: 'API5L_X42', name: 'API 5L X42 (42 ksi SMYS)', stressData: [
      ...
      { code: 'API5L_X52', name: 'API 5L X52 (52 ksi SMYS)', stressData: [
      ...
      { code: 'API5L_X60', name: 'API 5L X60 (60 ksi SMYS)', stressData: [
      ...
      { code: 'API5L_X65', name: 'API 5L X65 (65 ksi SMYS)', stressData: [
      ...
      { code: 'API5L_X70', name: 'API 5L X70 (70 ksi SMYS)', stressData: [
    ...
    const chromeMolyGrades = [
      // A335 P1 - 0.5Mo
      { code: 'A335_P1', name: 'ASTM A335 P1 (0.5Mo)', stressData: [
      ...
      // A335 P5 - 5Cr-0.5Mo
      { code: 'A335_P5', name: 'ASTM A335 P5 (5Cr-0.5Mo)', stressData: [
        { tempC: -29, tempF: -20, ksi: 20.0, mpa: 137.9 },
        { tempC: 38, tempF: 100, ksi: 20.0, mpa: 137.9 },
        { tempC: 93, tempF: 200, ksi: 20.0, mpa: 137.9 },
      ...
      // A335 P9 - 9Cr-1Mo
      { code: 'A335_P9', name: 'ASTM A335 P9 (9Cr-1Mo)', stressData: [
        { tempC: -29, tempF: -20, ksi: 20.0, mpa: 137.9 },
        { tempC: 38, tempF: 100, ksi: 20.0, mpa: 137.9 },
        { tempC: 93, tempF: 200, ksi: 20.0, mpa: 137.9 },
        { tempC: 149, tempF: 300, ksi: 20.0, mpa: 137.9 },
      ...
      // A335 P12 - 1Cr-0.5Mo
      { code: 'A335_P12', name: 'ASTM A335 P12 (1Cr-0.5Mo)', stressData: [
        { tempC: -29, tempF: -20, ksi: 20.0, mpa: 137.9 },
        { tempC: 38, tempF: 100, ksi: 20.0, mpa: 137.9 },
        { tempC: 93, tempF: 200, ksi: 20.0, mpa: 137.9 },
        { tempC: 149, tempF: 300, ksi: 20.0, mpa: 137.9 },
      ...
      { code: 'A335_P91', name: 'ASTM A335 P91 (9Cr-1Mo-V Advanced)', stressData: [
      ...
      { code: 'A335_P92', name: 'ASTM A335 P92 (9Cr-2W Advanced)', stressData: [

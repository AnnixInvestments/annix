  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        uniques: [{ columnNames: ["nominal_diameter", "pressure_rating", "pvc_type"] }],
      }),
      true,
    );
    ...
    await queryRunner.createIndex(
      ...
      new TableIndex({
        name: "IDX_pvc_pipe_specs_dn",
        columnNames: ["nominal_diameter"],
      }),
    );
    await queryRunner.createIndex(
      "pvc_pipe_specifications",
      new TableIndex({
        name: "IDX_pvc_pipe_specs_pn",
        columnNames: ["pressure_rating"],
      }),
    );

...
export class AddAsmeB165AlloyPTRatings1772200000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const f11Data: Record<string, Record<number, number>> = {
      ...
      '1500': { '-29': 255.3, '38': 255.3, '93': 242.5, '149': 232.0, '204': 223.5, '260': 215.8, '316': 208.0, '343': 204.5, '371': 192.0, '399': 158.5, '427': 118.5, '454': 79.0, '482': 47.4 },
      '2500': { '-29': 425.5, '38': 425.5, '93': 404.2, '149': 386.7, '204': 372.5, '260': 359.6, '316': 346.7, '343': 340.8, '371': 320.0, '399': 264.2, '427': 197.5, '454': 131.7, '482': 79.0 },
    };
    ...
    const f22Data: Record<string, Record<number, number>> = {
      ...
      '1500': { '-29': 255.3, '38': 255.3, '93': 247.0, '149': 238.9, '204': 232.0, '260': 225.9, '316': 219.8, '343': 216.0, '371': 206.6, '399': 185.3, '427': 155.5, '454': 121.5, '482': 85.0, '510': 56.7, '538': 35.0 },
      '2500': { '-29': 425.5, '38': 425.5, '93': 411.7, '149': 398.2, '204': 386.7, '260': 376.5, '316': 366.4, '343': 360.1, '371': 344.3, '399': 308.9, '427': 259.2, '454': 202.5, '482': 141.7, '510': 94.4, '538': 58.3 },
    };
    ...
    const duplexF51Data: Record<string, Record<number, number>> = {
      ...
      '1500': { '-29': 255.3, '38': 255.3, '93': 249.0, '149': 241.5, '204': 232.0, '260': 215.8 },
      '2500': { '-29': 425.5, '38': 425.5, '93': 415.0, '149': 402.5, '204': 386.7, '260': 359.6 },
    };
    ...
    const superDuplexF55Data: Record<string, Record<number, number>> = {
      ...
      '1500': { '-29': 255.3, '38': 255.3, '93': 252.0, '149': 246.3, '204': 238.9, '260': 225.9 },
      '2500': { '-29': 425.5, '38': 425.5, '93': 420.0, '149': 410.6, '204': 398.2, '260': 376.5 },
    };
    ...
    const inconel625Data: Record<string, Record<number, number>> = {
      ...
      '1500': { '-29': 255.3, '38': 255.3, '93': 249.0, '149': 241.5, '204': 232.0, '260': 222.5, '316': 212.5, '371': 201.0, '427': 185.3, '482': 164.5, '538': 140.5, '593': 112.5, '649': 85.0 },
      '2500': { '-29': 425.5, '38': 425.5, '93': 415.0, '149': 402.5, '204': 386.7, '260': 370.8, '316': 354.2, '371': 335.0, '427': 308.9, '482': 274.2, '538': 234.2, '593': 187.5, '649': 141.7 },
    };
    ...
    const monel400Data: Record<string, Record<number, number>> = {
      ...
      '1500': { '-29': 255.3, '38': 255.3, '93': 238.9, '149': 222.5, '204': 211.5, '260': 200.0, '316': 183.7, '371': 159.4 },
      '2500': { '-29': 425.5, '38': 425.5, '93': 398.2, '149': 370.8, '204': 352.5, '260': 333.3, '316': 306.2, '371': 265.6 },
    };
    ...
    const hastelloyC276Data: Record<string, Record<number, number>> = {
      ...
      '1500': { '-29': 255.3, '38': 255.3, '93': 252.0, '149': 246.3, '204': 238.9, '260': 229.2, '316': 217.1, '371': 202.5, '427': 183.7, '482': 159.4, '538': 129.0, '593': 97.2, '649': 69.3, '704': 46.0 },
      '2500': { '-29': 425.5, '38': 425.5, '93': 420.0, '149': 410.6, '204': 398.2, '260': 381.9, '316': 361.9, '371': 337.5, '427': 306.2, '482': 265.6, '538': 215.0, '593': 162.0, '649': 115.5, '704': 76.7 },
    };
    ...
    await this.insertPTRatings(queryRunner, classMap, 'Duplex Stainless Steel F51 (Group 3.2)', duplexF51Data);
    await this.insertPTRatings(queryRunner, classMap, 'Super Duplex Stainless Steel F55 (Group 3.3)', superDuplexF55Data);
    ...
    await this.insertPTRatings(queryRunner, classMap, 'Hastelloy C276 (Group 4.3)', hastelloyC276Data);

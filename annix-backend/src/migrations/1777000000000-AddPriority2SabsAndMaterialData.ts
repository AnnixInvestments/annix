...
export class AddPriority2SabsAndMaterialData1777000000000 implements MigrationInterface {
  ...
  private async createSabs719ExpansionPieceTable(
  ...
  private async populateSabs719ExpansionPieces(
    queryRunner: QueryRunner,
  ): Promise<void> {
    console.warn(
      'Populating SABS 719 expansion pieces from MPS manual pages 35-36...',
    );
  ...
  private async createAstmMaterialCompositionTable(
    queryRunner: QueryRunner,
  ): Promise<void> {
  ...
  private async populateAstmMaterialCompositions(
    queryRunner: QueryRunner,
  ): Promise<void> {
    console.warn(
      'Populating ASTM material compositions from MPS manual pages 14-15...',
    );

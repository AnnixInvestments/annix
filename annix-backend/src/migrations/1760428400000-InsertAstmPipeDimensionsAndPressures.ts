...
export class InsertAstmPipeDimensionsAndPressures1760428400000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const astmSchedule80Dimensions = [
      ...
      [200, 219.1, 12.7, 64.63],
      [250, 273.0, 15.09, 95.9],
      [300, 323.8, 12.7, 97.44],
      [350, 355.6, 12.7, 107.38],
      [400, 406.4, 12.7, 123.29],
      [450, 457.2, 12.7, 139.19],
      [500, 508.0, 12.7, 155.1],
      [600, 609.6, 12.7, 186.92],
    ];

...
export class AddComprehensiveAsmeB165FlangeData1770300000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    > = [
      ...
      [25, "/8", 2500, 159, 41, 0, 2, 4, 26, '7/8"', 108, 5.0, 95],

      // ===== 32NB (1-1/4" NPS, 42.2 OD) =====
      // Class 150
      [32, "/2", 150, 117, 19, 43, 2, 4, 16, '1/2"', 89, 1.0, 55],
      ...
      // Class 300
      [40, "/2", 300, 156, 32, 49, 2, 4, 22, '3/4"', 114, 3.4, 80],
      ...
      // Class 900
      [40, "/2", 900, 178, 48, 49, 2, 4, 29, '1"', 124, 6.8, 110],
      [40, "/8", 900, 178, 38, 0, 2, 4, 29, '1"', 124, 5.67, 95],
      // Class 1500
      [40, "/2", 1500, 178, 48, 49, 2, 4, 29, '1"', 124, 6.8, 110],
      ...
      // Class 600
      [50, "/2", 600, 165, 41, 62, 2, 8, 19, '5/8"', 127, 5.0, 90],
      ...
      // Class 150
      [65, "/2", 150, 178, 27, 75, 2, 4, 19, '5/8"', 140, 3.4, 70],
      ...
      // Class 1500
      [65, "/2", 1500, 244, 70, 75, 2, 8, 32, '1-1/8"', 190, 18.6, 145],
      ...
      // Class 600
      [80, "/2", 600, 210, 54, 90, 2, 8, 22, '3/4"', 168, 9.3, 115],
      ...
      // Class 2500
      [80, "/2", 2500, 318, 130, 90, 2, 8, 35, '1-1/4"', 241, 56.7, 230],
      ...
      // Class 300
      [125, "/2", 300, 279, 60, 144, 2, 8, 22, '3/4"', 235, 16.1, 125],
      [125, "/3", 300, 279, 41, 144, 2, 8, 22, '3/4"', 235, 9.3, 95],
      ...
      [125, "/8", 1500, 375, 92, 0, 2, 8, 38, '1-3/8"', 298, 50.8, 190],
      ...
      // Class 300
      [200, "/2", 300, 381, 75, 222, 2, 12, 26, '7/8"', 330, 38.1, 155],
      ...
      [200, "/8", 900, 470, 102, 0, 2, 12, 38, '1-3/8"', 400, 82.1, 205],
      // Class 1500
      ...
      [250, "/8", 900, 546, 117, 0, 2, 16, 38, '1-3/8"', 470, 113.4, 235],
      // Class 1500
      ...
      [300, "/3", 300, 521, 62, 327, 2, 16, 32, '1-1/8"', 457, 38.1, 135],
      [300, "/8", 300, 521, 70, 0, 2, 16, 32, '1-1/8"', 457, 49.9, 150],
      // Class 600
      [300, "/2", 600, 559, 130, 327, 2, 20, 35, '1-1/4"', 489, 117.93, 245],
      [300, "/3", 600, 559, 86, 327, 2, 20, 35, '1-1/4"', 489, 63.5, 180],
      [300, "/8", 600, 559, 98, 0, 2, 20, 35, '1-1/4"', 489, 82.1, 200],
      // Class 900
      ...
      // Class 150
      [350, "/2", 150, 533, 54, 359, 2, 12, 29, '1"', 476, 50.8, 120],
      ...
      [450, "/8", 150, 635, 45, 0, 2, 16, 32, '1-1/8"', 578, 82.1, 110],
      // Class 300
      [450, "/2", 300, 711, 117, 462, 2, 24, 35, '1-1/4"', 635, 158.76, 220],
      [450, "/3", 300, 711, 79, 462, 2, 24, 35, '1-1/4"', 635, 82.1, 165],
      ...
      [500, "/8", 900, 857, 178, 0, 2, 20, 56, '2"', 762, 353.8, 340],
    ...
    for (const flange of flangeData) {
      const [nominalMm, typeCode, classNum, D, b, d4, f, holes, d1, bolt, pcd, mass, _boltLength] =
        flange;
    ...
    console.warn(
      `ASME B16.5 flange data migration complete: ${insertedCount} records added/updated, ${skippedCount} skipped`,
    );
  }

...
export class CreateFlangePtRatingsTable1766001300000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    console.warn("📊 Populating ASME B16.5 P/T ratings for Carbon Steel A105...");
    ...
    if (asmeStandard.length === 0) {
      console.warn("⚠️ ASME B16.5 standard not found, skipping P/T data population");
      return;
    }
    ...
    if (pressureClasses.length === 0) {
      console.warn("⚠️ No ASME B16.5 pressure classes found, skipping P/T data population");
      return;
    }

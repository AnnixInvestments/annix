...
export class AddFlangeSpecificationData1762269000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    for (const bolt of boltInserts) {
      const existing = await queryRunner.query(
        `SELECT id FROM bolts WHERE designation = '${bolt}'`,
      );
    ...
    for (const standard of standards) {
      const existing = await queryRunner.query(
        `SELECT id FROM flange_standards WHERE code = '${standard}'`,
      );
      if (existing.length === 0) {
    ...
    const flangeData = [
      ...
      [15, 21.3, "SABS 1123", "2500/3", 95.0, 14.0, 45.0, 2.0, 4, 14.0, "M12", 65.0, 0.6],
      [15, 21.3, "SABS 1123", "4000/3", 95.0, 14.0, 45.0, 2.0, 4, 14.0, "M12", 56.0, 0.6],
      ...
      [25, 33.7, "BS 4504", "10/3", 115.0, 16.0, 68.0, 2.0, 4, 14.0, "M12", 85.0, 1.0],
      [25, 33.7, "BS 4504", "16/3", 115.0, 16.0, 68.0, 2.0, 4, 14.0, "M12", 85.0, 1.0],
      [25, 33.7, "BS 4504", "25/3", 115.0, 18.0, 68.0, 2.0, 4, 14.0, "M12", 85.0, 1.2],
      [25, 33.7, "BS 4504", "40/3", 115.0, 18.0, 68.0, 2.0, 4, 14.0, "M12", 85.0, 1.2],
      ...
      [50, 60.3, "BS 4504", "6/3", 140.0, 16.0, 90.0, 3.0, 4, 14.0, "M12", 110.0, 1.3],
      [80, 88.9, "BS 4504", "100/3", 230.0, 34.0, 138.0, 3.0, 8, 26.0, "M24", 180.0, 6.87],
      [100, 114.3, "BS 4504", "160/3", 265.0, 44.0, 162.0, 3.0, 8, 30.0, "M27", 210.0, 15.3],
      [200, 219.1, "BS 4504", "25/3", 360.0, 28.0, 278.0, 3.0, 12, 26.0, "M24", 310.0, 12.0],
      [300, 323.9, "BS 4504", "40/3", 515.0, 50.0, 410.0, 4.0, 16, 33.0, "M30", 450.0, 42.0],
      [500, 508.0, "BS 4504", "64/3", 800.0, 94.0, 615.0, 4.0, 20, 48.0, "M45", 705.0, 196.19],

      // Large sizes
      [1000, 1016.0, "BS 4504", "6/3", 1175.0, 46.0, 1080.0, 5.0, 28, 30.0, "M27", 1120.0, 86.0],
      [
        1200,
        1220.0,
        "BS 4504",
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // Remove standards
    await queryRunner.query(
      `DELETE FROM flange_standards WHERE code IN ('BS 4504', 'SABS 1123', 'BS 10')`,
    );

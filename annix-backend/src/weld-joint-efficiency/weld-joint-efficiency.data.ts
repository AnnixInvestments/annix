...
export const B31_3_TABLE_A_1B: Record<string, B31_3_QualityFactorRow[]> = {
  "Carbon Steel": [
    ...
    },
    {
      specNo: "A 134",
      classOrType: "",
      description: "Electric fusion welded pipe, single butt, straight or spiral (helical) seam",
      notes: "",
      ej: 0.8,
    },
    {
    ...
    },
    {
      specNo: "A 139",
      classOrType: "",
      description: "Electric fusion welded pipe, straight or spiral (helical) seam",
      notes: "",
      ej: 0.8,
    },
    {

  ...
  async getCustomerDetail(customerId: number): Promise<CustomerDetailDto> {
    ...
    return {
      ...
      company: {
        ...
        generalEmail: profile.company.contact?.email ?? undefined,
  ...
  async getOnboardingForReview(onboardingId: number) {
    ...
    return {
      ...
      company: {
        ...
        streetAddress: onboarding.customer.company.address?.streetAddress ?? null,
        city: onboarding.customer.company.address?.city ?? null,
        provinceState: onboarding.customer.company.address?.province ?? null,
        postalCode: onboarding.customer.company.address?.postalCode ?? null,
        country: onboarding.customer.company.country,
        primaryPhone: onboarding.customer.company.contact?.phone ?? null,
      },

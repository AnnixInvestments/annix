...
@Module({
  ...
  providers: [
    ...
    repositoryProvider(AdminSessionRepository, MongoAdminSessionRepository),
    repositoryProvider(CompanyProfileRepository, MongoCompanyProfileRepository),
    repositoryProvider(ScheduledJobOverrideRepository, MongoScheduledJobOverrideRepository),
    repositoryProvider(
      ScheduledJobsGlobalSettingsRepository,
      MongoScheduledJobsGlobalSettingsRepository,
    ),
    repositoryProvider(PollingJobOverrideRepository, MongoPollingJobOverrideRepository),
    repositoryProvider(
    ...
    repositoryProvider(AuditLogRepository, MongoAuditLogRepository),
  ],
  controllers: [

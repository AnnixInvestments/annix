...
export class NominalOutsideDiameterMmController {
  constructor(
    private readonly nominalOutsideDiameterMmService: NominalOutsideDiameterMmService,
  ) {}
  ...
  create(
    @Body()
    createNominalOutsideDiameterMmDto: CreateNominalOutsideDiameterMmDto,
  ) {
    return this.nominalOutsideDiameterMmService.create(
  ...
  update(
    ...
    @Body()
    updateNominalOutsideDiameterMmDto: UpdateNominalOutsideDiameterMmDto,
  ) {
    return this.nominalOutsideDiameterMmService.update(
      +id,

...
export class SteelSpecificationController {
  constructor(
    private readonly steelSpecificationService: SteelSpecificationService,
  ) {}
  ...
  update(
    ...
    @Body() updateSteelSpecificationDto: UpdateSteelSpecificationDto,
  ) {
    return this.steelSpecificationService.update(
      +id,

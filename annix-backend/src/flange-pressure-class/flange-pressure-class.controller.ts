...
export class FlangePressureClassController {
  constructor(
    private readonly flangePressureClassService: FlangePressureClassService,
  ) {}
  ...
  update(
    @Param('id') id: string,
    @Body() updateFlangePressureClassDto: UpdateFlangePressureClassDto,
  ) {
    return this.flangePressureClassService.update(
      +id,

...
export class MaterialValidationController {
  constructor(private readonly materialValidationService: MaterialValidationService) {}
  ...
  checkSuitability(
    ...
    return this.materialValidationService.checkMaterialSuitability(specName, tempC, pressureBar);
  }
  ...
  getSuitableMaterials(
    ...
    return this.materialValidationService.getSuitableMaterials(tempC, pressureBar);
  }
}

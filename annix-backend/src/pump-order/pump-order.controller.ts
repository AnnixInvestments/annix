...
import { PumpOrderService, PumpOrderQueryParams } from './pump-order.service';
...
export class PumpOrderController {
  ...
  @ApiQuery({ name: 'search', required: false, type: String, description: 'Search in order number, customer' })
  @ApiQuery({ name: 'status', required: false, enum: PumpOrderStatus, description: 'Filter by status' })
  @ApiQuery({ name: 'orderType', required: false, enum: PumpOrderType, description: 'Filter by order type' })
  @ApiQuery({ name: 'supplierId', required: false, type: Number, description: 'Filter by supplier' })
  @ApiQuery({ name: 'fromDate', required: false, type: String, description: 'Filter from date (ISO)' })
  ...
  @ApiQuery({ name: 'updatedBy', required: false, type: String, description: 'User making the change' })

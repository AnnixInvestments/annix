...
export const FEATURE_FLAG_DESCRIPTIONS: Record<FeatureFlagKey, string> = {
  ...
  ANNIX_ORBIT_EE_COMPLIANCE_ENABLED:
...
export const PUBLIC_FEATURE_FLAGS: ReadonlySet<FeatureFlagKey> = new Set<FeatureFlagKey>([
  ...
  "SUPPLIER_DASHBOARD",
  "SUPPLIER_BOQS",
  "SUPPLIER_SUBMITTED_BOQS",
  "SUPPLIER_PRODUCTS_SERVICES",
  "SUPPLIER_PUMP_QUOTES",
  "SUPPLIER_MESSAGES",
  "SUPPLIER_DOCUMENTS",
  "RFQ_TYPE_STANDARD",
  "RFQ_TYPE_PHASE1",
  "RFQ_TYPE_RETENDER",
  "RFQ_TYPE_FEASIBILITY",
  "RFQ_PRODUCT_FABRICATED_STEEL",
  "RFQ_PRODUCT_FASTENERS_GASKETS",
  "RFQ_PRODUCT_SURFACE_PROTECTION",
  "RFQ_PRODUCT_HDPE",
  "RFQ_PRODUCT_PVC",
  "RFQ_PRODUCT_STRUCTURAL_STEEL",
  "RFQ_PRODUCT_PUMPS",
  "RFQ_PRODUCT_VALVES_METERS",
  "RFQ_PRODUCT_TRANSPORT_INSTALL",
  "RFQ_PRODUCT_PIPE_STEEL_WORK",
  "RFQ_RESTRICT_UNREGISTERED",
  "STOCK_MGMT_NIX_QUOTE_FROM_DOCUMENTS",
  "ANNIX_ORBIT_NIX_CV_BUILDER",
  "ANNIX_ORBIT_SEEKER_ASSISTANT",
]);

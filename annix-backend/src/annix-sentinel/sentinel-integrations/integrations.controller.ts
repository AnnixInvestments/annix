...
@ApiTags("annix-sentinel/integrations")
@ApiBearerAuth()
@UseGuards(AnnixSentinelJwtAuthGuard, AnnixSentinelCompanyScopeGuard)
@Controller("annix-sentinel/integrations")
export class AnnixSentinelIntegrationsController {
  constructor(
    private readonly integrationsService: AnnixSentinelIntegrationsService,

...
@Injectable()
export class AnnixSentinelSubscriptionsService {
  ...
  async subscriptionStatus(companyId: number): Promise<{
    subscription: AnnixSentinelSubscription;
  ...
  async upgradeTier(companyId: number, tier: string): Promise<AnnixSentinelSubscription> {

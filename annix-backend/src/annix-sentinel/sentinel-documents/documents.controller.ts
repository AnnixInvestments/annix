...
@ApiTags("annix-sentinel/documents")
@ApiBearerAuth()
@UseGuards(AnnixSentinelJwtAuthGuard, AnnixSentinelCompanyScopeGuard)
@Controller("annix-sentinel/documents")
export class AnnixSentinelDocumentsController {
  constructor(private readonly documentsService: AnnixSentinelDocumentsService) {}

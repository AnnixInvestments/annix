...
import { AnnixSentinelToggleChecklistDto } from "./dto/toggle-checklist.dto";
import { AnnixSentinelUpdateStatusDto } from "./dto/update-status.dto";

@ApiTags("annix-sentinel/compliance")
@Controller("annix-sentinel/compliance")
export class AnnixSentinelComplianceController {
  constructor(private readonly complianceService: AnnixSentinelComplianceService) {}
  ...
  async updateStatus(
    ...
    @Body() dto: AnnixSentinelUpdateStatusDto,
  ) {
  ...
  async toggleChecklistStep(
    ...
    @Body() dto: AnnixSentinelToggleChecklistDto,
  ) {

...
@ApiTags("annix-sentinel/advisor")
@ApiBearerAuth()
@UseGuards(AnnixSentinelJwtAuthGuard, AnnixSentinelCompanyScopeGuard)
@Controller("annix-sentinel/advisor")
export class AnnixSentinelAdvisorController {
  constructor(private readonly advisorService: AnnixSentinelAdvisorService) {}

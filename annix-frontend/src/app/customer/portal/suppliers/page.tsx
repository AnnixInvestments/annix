...
export default function CustomerSuppliersPage() {
  ...
  const [productsModalSupplier, setProductsModalSupplier] = useState<DirectorySupplier | null>(
    null,
  );
          ...
          <div className="flex items-center justify-center min-h-screen px-4">
            ...
            <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Add an unregistered supplier to your preferred list. They will be able to receive
                RFQs but won&apos;t have portal access until they register.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAddForm({ ...addForm, priority: parseInt(e.target.value, 10) || 1 })
                    }
                    className="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    min="1"
                  />
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4">
            ...
            <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">{productsModalSupplier.companyName}</p>

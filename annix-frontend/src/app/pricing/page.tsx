      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Customer Plans</h2>
        ...
        <div className="mb-16">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Supplier Plans</h2>
            <p className="text-gray-600 mt-2">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600">
                We'll notify you when you're approaching your limits and suggest an upgrade. You
                won't lose access to existing data.
              </p>
            </div>
          </div>
        </div>

...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const hardcodedEntries: MetadataRoute.Sitemap = [
    ...
    {
      url: `${AUIND_SITE_URL}/rubber-lining-benoni`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${AUIND_SITE_URL}/rubber-lining-germiston`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${AUIND_SITE_URL}/rubber-lined-mining-pipework`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    {
      url: `${AUIND_SITE_URL}/industrial-wear-lining`,
      lastModified: currentDate,
      changeFrequency: "monthly",
      priority: 0.85,
    },

...
import { useAnalyticsSummary, useMeetings } from "@/app/lib/query/hooks";
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Recent AI Activity</h2>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mb-4 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-700 dark:text-gray-300">
            {completedCount} meetings ready for AI analysis
          </span>
        </div>
      </div>
      ...
      {completedMeetings.length === 0 ? (
        <p className="text-sm text-gray-500 dark:text-gray-400">
          No completed meetings yet. Complete a meeting to use AI transcription and summaries.
        </p>
      ) : (
        <div className="space-y-2">
          <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
            Recent meetings available for AI features:
          </p>
            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  {formatDateZA(meeting.scheduledStart.toString())}
                </p>
              </div>
              <svg
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <FeatureCard
          ...
          href="/annix-pulse/schedule/route-planner"

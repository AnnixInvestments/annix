  ...
  if (product.comingSoon) {
    return (
      <div className="flex flex-col">
        <div className="flex aspect-[4/5] flex-col items-center justify-center rounded-xl border border-white/10 bg-white/5 p-4 text-center">
          <span
          ...
          <span className="mt-3 rounded-full bg-white/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white/70">
            Coming Soon
          </span>
        </div>

...
export function IndustrialValveIcon({ className = '', size = 24 }: ValveIconProps) {
  ...
  return (
    ...
    >
      ...
      {/* Handwheel at top */}
      <ellipse cx="15" cy="3" rx="8" ry="2" fill="url(#handwheelGradient)" stroke="#0D3A5C" strokeWidth="0.5" />
      {/* Handwheel spokes */}
      ...
      {/* Rising stem */}
      <rect x="14" y="4" width="2" height="8" fill="url(#stemGradient)" stroke="#707070" strokeWidth="0.3" />

      {/* Stem bonnet/yoke */}
      <path d="M 11 11 L 11 14 L 19 14 L 19 11 L 17 9 L 13 9 Z" fill="url(#valveBodyGradient)" stroke="#144780" strokeWidth="0.5" />

      {/* Main valve body */}
      <rect x="8" y="14" width="14" height="10" rx="1" fill="url(#valveBodyGradient)" stroke="#144780" strokeWidth="0.5" />

      {/* Body detail - gate slot indication */}
      <line x1="15" y1="15" x2="15" y2="23" stroke="#144780" strokeWidth="0.8" opacity="0.5" />

      {/* Left flange */}
      <ellipse cx="6" cy="19" rx="2" ry="6" fill="url(#flangeGradient)" stroke="#0D3A5C" strokeWidth="0.5" />
      ...
      {/* Right flange */}
      <ellipse cx="24" cy="19" rx="2" ry="6" fill="url(#flangeGradient)" stroke="#0D3A5C" strokeWidth="0.5" />
      ...
      {/* Bottom support/base */}
      <rect x="10" y="24" width="10" height="2" rx="0.5" fill="#1E5A9E" stroke="#0D3A5C" strokeWidth="0.3" />

      {/* Highlight on body */}
      <path d="M 9 15 L 9 22" stroke="#5AA0E8" strokeWidth="1" opacity="0.4" strokeLinecap="round" />

      {/* Highlight on handwheel */}
      <path d="M 9 2.5 Q 15 1 21 2.5" stroke="#7BBAF5" strokeWidth="0.8" fill="none" opacity="0.5" />
    </svg>
  );
}

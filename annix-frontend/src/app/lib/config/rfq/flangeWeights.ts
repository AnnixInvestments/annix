...
export const blankFlangeWeight = (nbMm: number, pressureClass: string): number => {
  ...
  const pcLookup =
    pcNormalized.includes("PN40") || pcNormalized.includes("CLASS300")
      ? "PN40"
      : pcNormalized.includes("PN25") || pcNormalized.includes("CLASS150")
        ? "PN25"
        : pcNormalized.includes("PN10")
          ? "PN10"
          : "PN16";
...
export const BNW_SET_WEIGHT_PER_HOLE: Record<
  string,
  Record<number, { boltSize: string; weight: number }>
> = {
  PN6: {
...
export const GASKET_WEIGHTS: Record<
  number,
  { spiralWound: number; rtj: number; ptfe: number; graphite: number; caf: number; rubber: number }
> = {
  15: { spiralWound: 0.025, rtj: 0.045, ptfe: 0.003, graphite: 0.002, caf: 0.004, rubber: 0.003 },
  20: { spiralWound: 0.03, rtj: 0.055, ptfe: 0.004, graphite: 0.003, caf: 0.005, rubber: 0.004 },
  25: { spiralWound: 0.035, rtj: 0.065, ptfe: 0.005, graphite: 0.004, caf: 0.007, rubber: 0.005 },
  32: { spiralWound: 0.045, rtj: 0.08, ptfe: 0.007, graphite: 0.005, caf: 0.009, rubber: 0.006 },
  40: { spiralWound: 0.055, rtj: 0.095, ptfe: 0.009, graphite: 0.007, caf: 0.012, rubber: 0.008 },
  50: { spiralWound: 0.07, rtj: 0.12, ptfe: 0.013, graphite: 0.01, caf: 0.017, rubber: 0.011 },
  65: { spiralWound: 0.09, rtj: 0.15, ptfe: 0.018, graphite: 0.014, caf: 0.023, rubber: 0.015 },
  80: { spiralWound: 0.11, rtj: 0.18, ptfe: 0.024, graphite: 0.018, caf: 0.031, rubber: 0.02 },
  100: { spiralWound: 0.15, rtj: 0.25, ptfe: 0.035, graphite: 0.027, caf: 0.045, rubber: 0.03 },
  125: { spiralWound: 0.2, rtj: 0.32, ptfe: 0.05, graphite: 0.038, caf: 0.064, rubber: 0.042 },
  150: { spiralWound: 0.26, rtj: 0.4, ptfe: 0.068, graphite: 0.052, caf: 0.087, rubber: 0.057 },
  200: { spiralWound: 0.4, rtj: 0.6, ptfe: 0.11, graphite: 0.085, caf: 0.14, rubber: 0.092 },
  250: { spiralWound: 0.55, rtj: 0.85, ptfe: 0.165, graphite: 0.127, caf: 0.21, rubber: 0.138 },
  300: { spiralWound: 0.72, rtj: 1.1, ptfe: 0.22, graphite: 0.17, caf: 0.285, rubber: 0.187 },
  350: { spiralWound: 0.9, rtj: 1.4, ptfe: 0.29, graphite: 0.225, caf: 0.375, rubber: 0.245 },
  400: { spiralWound: 1.1, rtj: 1.7, ptfe: 0.37, graphite: 0.285, caf: 0.475, rubber: 0.31 },
  450: { spiralWound: 1.35, rtj: 2.0, ptfe: 0.46, graphite: 0.355, caf: 0.59, rubber: 0.385 },
  500: { spiralWound: 1.6, rtj: 2.4, ptfe: 0.56, graphite: 0.43, caf: 0.72, rubber: 0.47 },
  600: { spiralWound: 2.2, rtj: 3.3, ptfe: 0.78, graphite: 0.6, caf: 1.0, rubber: 0.655 },
  700: { spiralWound: 2.9, rtj: 4.3, ptfe: 1.05, graphite: 0.81, caf: 1.35, rubber: 0.88 },
  800: { spiralWound: 3.7, rtj: 5.5, ptfe: 1.35, graphite: 1.04, caf: 1.73, rubber: 1.13 },
  900: { spiralWound: 4.6, rtj: 6.9, ptfe: 1.7, graphite: 1.31, caf: 2.18, rubber: 1.42 },
  1000: { spiralWound: 5.6, rtj: 8.4, ptfe: 2.1, graphite: 1.62, caf: 2.7, rubber: 1.76 },
  1200: { spiralWound: 7.9, rtj: 11.8, ptfe: 3.0, graphite: 2.31, caf: 3.85, rubber: 2.51 },
};
...
export const normalizePressureClass = (designation: string, flangeStandard?: string): string => {
  ...
  if (slashMatch) {
    const value = parseInt(slashMatch[1], 10);
    const isBs4504 =
  ...
  if (pnMatch) {
    const pnValue = parseInt(pnMatch[1], 10);
  ...
  if (classMatch) {
    const classValue = parseInt(classMatch[1], 10);
...
export const bnwSetInfo = (
  nbMm: number,
  pressureClass: string,
): { boltSize: string; weightPerHole: number; holesPerFlange: number } => {
  const normalized = normalizePressureClass(pressureClass);
...
export const gasketWeight = (gasketType: string, nbMm: number): number => {
  const sizes = Object.keys(GASKET_WEIGHTS)
    .map(Number)
    .sort((a, b) => a - b);
  ...
  if (gasketType.startsWith("SW-") || gasketType.includes("Spiral")) {
    ...
    gasketType.startsWith("Rubber-") ||
    gasketType.includes("EPDM") ||
    gasketType.includes("NBR")
  ) {
...
export const flangeWeight = (
  ...
  if (sansTableMatch || isSabsSans1123) {
    ...
    if (sansTableMatch) {
      kpa = parseInt(sansTableMatch[1], 10);
  ...
  const isAsmeB1647A =
    flangeStandard &&
    ((flangeStandard.toUpperCase().includes("B16.47") &&
      flangeStandard.toUpperCase().includes("A")) ||
      (flangeStandard.toUpperCase().includes("B16-47") &&
        flangeStandard.toUpperCase().includes("A")));
  ...
  const isAsmeB1647B =
    flangeStandard &&
    ((flangeStandard.toUpperCase().includes("B16.47") &&
      flangeStandard.toUpperCase().includes("B")) ||
      (flangeStandard.toUpperCase().includes("B16-47") &&
        flangeStandard.toUpperCase().includes("B")));
...
export const SABS_1123_FLANGE_TYPES: Sabs1123FlangeType[] = [
  {
    code: "/1",
    name: "Backing Ring",
    description: "BR - Backing Ring flange for rotating flange assemblies",
  },
  {
    code: "/2",
    name: "Weld Neck",
    description: "WN - Weld Neck flange for high pressure applications",
  },
  { code: "/3", name: "Slip-On", description: "SO - Slip-On Plate flange, most common type" },
  {
    code: "/4",
    name: "Threaded",
    description: "THD - Screwed/Threaded flange for low pressure services",
  },
  ...
  { code: "/7", name: "Spectacle Blank", description: "SB - Blank for Spectacle Blind assemblies" },
  {
    code: "/8",
    name: "Blind",
    description: "BL - Blind/Blank flange (raised face) to close pipe ends",
  },
];
...
export const ASME_B16_5_FLANGE_TYPES: FlangeTypeInfo[] = [
  {
    code: "WN",
    name: "Weld Neck",
    description: "WN - Weld Neck flange for high pressure and temperature applications",
  },
  { code: "SO", name: "Slip-On", description: "SO - Slip-On flange, welded inside and outside" },
  {
    code: "SW",
    name: "Socket Weld",
    description: "SW - Socket Weld flange for small bore high pressure",
  },
  {
    code: "THD",
    name: "Threaded",
    description: "THD - Threaded/Screwed flange for low pressure services",
  },
  { code: "BL", name: "Blind", description: "BL - Blind flange to close pipe ends" },
  {
    code: "LJ",
    name: "Lap Joint",
    description: "LJ - Lap Joint flange with stub end for easy alignment",
  },
  {
    code: "LWN",
    name: "Long Weld Neck",
    description: "LWN - Long Weld Neck flange for nozzle connections",
  },
];
...
export const retainingRingWeight = (nbMm: number, pipeOdMm?: number): number => {
  ...
  const ringThicknessMm = Math.max(
    minThicknessMm,
    Math.min(maxThicknessMm, nbMm * thicknessFactor),
  );

...
export const STEEL_MATERIALS: SteelMaterial[] = [
  {
    ...
    code: 'CS-A53B',
    description: 'General purpose carbon steel for mining piping, cost-effective with good strength',
    densityKgM3: 7850,
    defaultCostPerKg: 32,
    category: 'carbon',
...
export const STEEL_MATERIAL_CATEGORIES = [
  ...
  { id: 'stainless', name: 'Stainless Steel', description: 'Corrosion resistant for harsh environments' },
  { id: 'wear-resistant', name: 'Wear-Resistant Steel', description: 'Abrasion resistant for mining applications' },
];

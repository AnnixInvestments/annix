...
// ============================================================
// AR STEEL PLATE THICKNESS DATA (For Wear Liner Applications)
// ============================================================
// AR steels are NOT pipe schedules - they use plate thickness designations
// Common thicknesses per AS/NZS 3678 and manufacturer standards
...
// AR steel grade characteristics
...
// Helper to check if a steel spec is AR/wear-resistant
...
// Get AR steel schedules (plate thicknesses) for UI
...
// Get recommended plate thickness based on application

...
describe('Material Visual Comparison Tests', () => {
  ...
  describe('Lighting Configuration Validation', () => {
    ...
    it('key light should be brightest', () => {
      ...
      expect(LIGHTING_CONFIG.keyLight.intensity).toBeGreaterThan(LIGHTING_CONFIG.rimLight.intensity)
    })

    it('fill light should be secondary intensity', () => {
      expect(LIGHTING_CONFIG.fillLight.intensity).toBeGreaterThan(LIGHTING_CONFIG.rimLight.intensity)
    })
  ...
  describe('Environment Map Settings', () => {
    ...
    it('weld materials should have reduced environment reflection', () => {
      expect(WELD_MATERIALS.standard.envMapIntensity).toBeLessThan(PIPE_MATERIALS.outer.envMapIntensity)
    })

    it('flange materials should have higher environment reflection (polished)', () => {
      expect(FLANGE_MATERIALS.standard.envMapIntensity).toBeGreaterThan(PIPE_MATERIALS.outer.envMapIntensity)
    })
  })

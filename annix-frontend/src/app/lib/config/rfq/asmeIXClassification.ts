...
export const GROOVE_WELD_POSITIONS: WeldPosition[] = [
  ...
  },
  {
    ...
    description:
      "Pipe horizontal, axis fixed in horizontal plane. Welding progresses around pipe without rotation.",
    type: "groove",
  ...
  },
  {
    ...
    description:
      "Pipe axis at 45° to horizontal, fixed. Most comprehensive qualification - qualifies all positions.",
    type: "groove",
  ...
  },
  {
    ...
    description:
      "Same as 6G but with restriction ring simulating branch connection or structural constraint.",
    type: "groove",
...
export const PIPE_MATERIAL_TO_P_NUMBER: MaterialToPNumber[] = [
  {
    ...
    pNumber: 1,
    group: 1,
    tensileStrengthKsi: 48,
    nominalComposition: "C",
    productForm: "E.R.W./Seamless pipe",
  },
  {
    astmSpec: "A53",
    grade: "B",
  ...
  },
  {
    ...
    pNumber: 8,
    group: 1,
    tensileStrengthKsi: 75,
    nominalComposition: "18Cr-8Ni",
    productForm: "Seamless/welded pipe",
  },
  {
    astmSpec: "A312",
    grade: "TP304L",
  ...
  },
  {
    ...
    group: 1,
    tensileStrengthKsi: 75,
    nominalComposition: "16Cr-12Ni-2Mo",
    productForm: "Seamless/welded pipe",
  },
  {
    astmSpec: "A312",
  ...
  },
  {
    ...
    group: 1,
    tensileStrengthKsi: 75,
    nominalComposition: "18Cr-10Ni-Ti",
    productForm: "Seamless/welded pipe",
  },
  {
    astmSpec: "A312",
  ...
  },
  {
    ...
    group: 1,
    tensileStrengthKsi: 75,
    nominalComposition: "18Cr-10Ni-Nb",
    productForm: "Seamless/welded pipe",
  },
  {
    astmSpec: "A312",
  ...
  },
  {
    ...
    pNumber: 8,
    group: 4,
    tensileStrengthKsi: 95,
    nominalComposition: "20Cr-18Ni-6Mo",
    productForm: "Seamless/welded pipe",
  },
  {
    astmSpec: "A333",
    ...
    pNumber: 1,
    group: 1,
    tensileStrengthKsi: 55,
    nominalComposition: "C-Mn",
    productForm: "Seamless/welded pipe (low temp)",
  },
  {
    astmSpec: "A333",
    grade: "6",
  ...
  },
  {
    ...
    pNumber: 9,
    group: 1,
    tensileStrengthKsi: 65,
    nominalComposition: "3.5Ni",
    productForm: "Seamless/welded pipe (low temp)",
  },
  {
    astmSpec: "A333",
    ...
    pNumber: 11,
    group: 1,
    tensileStrengthKsi: 100,
    nominalComposition: "9Ni",
    productForm: "Seamless/welded pipe (cryogenic)",
  },
  {
    astmSpec: "A335",
    grade: "P1",
    ...
    group: 1,
    tensileStrengthKsi: 55,
    nominalComposition: "C-0.5Mo",
    productForm: "Seamless pipe (high temp)",
  },
  {
    astmSpec: "A335",
    grade: "P11",
    ...
    group: 1,
    tensileStrengthKsi: 60,
    nominalComposition: "1.25Cr-0.5Mo",
    productForm: "Seamless pipe (high temp)",
  },
  {
    astmSpec: "A335",
  ...
  },
  {
    ...
    pNumber: 15,
    group: 1,
    tensileStrengthKsi: 85,
    nominalComposition: "9Cr-1Mo-V",
    productForm: "Seamless pipe (high temp)",
  },
  {
    astmSpec: "A335",
    ...
    pNumber: 15,
    group: 1,
    tensileStrengthKsi: 90,
    nominalComposition: "9Cr-2W",
    productForm: "Seamless pipe (high temp)",
  },
  {
    astmSpec: "A358",
    ...
    tensileStrengthKsi: 75,
    nominalComposition: "18Cr-8Ni",
    productForm: "Electric-fusion welded pipe",
  },
  {
    astmSpec: "A358",
    grade: "316",
  ...
  },
  {
    ...
    tensileStrengthKsi: 60,
    nominalComposition: "C-Si",
    productForm: "Forging (flanges, fittings)",
  },
  {
    astmSpec: "A181",
    grade: "Cl. 70",
...
export const BEND_TEST_REQUIREMENTS = {
  ...
  acceptanceCriteria: {
    ...
    cornerCracks:
      "Cracks at corners not counted unless evidence of slag inclusion or fusion defect",
  },
};

export function pNumberForMaterial(
  astmSpec: string,
  grade?: string,
): { pNumber: number; group: number } | null {
  const normalizedSpec = astmSpec
    .toUpperCase()
    .replace(/\s+/g, "")
    .replace("ASTM", "")
    .replace("ASME", "")
  ...
  const entry = PIPE_MATERIAL_TO_P_NUMBER.find((m) => {
    const specMatch =
      m.astmSpec.toUpperCase().replace(/\s+/g, "") === normalizedSpec ||
      normalizedSpec.includes(m.astmSpec.toUpperCase());
...
export function qualifiedPositionsForTest(
  testPosition: string,

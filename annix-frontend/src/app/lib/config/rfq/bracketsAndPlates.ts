...
export const BRACKET_TYPES = [
  {
    id: "L_BRACKET",
    name: "L-Bracket (Angle)",
    description: "Standard L-shaped angle bracket for pipe support",
  },
...
export const standardPlateSizesByCategory = (
  category: StandardPlateSize["category"],
): StandardPlateSize[] => {

...
export const SEAT_LEAKAGE_CLASS_OPTIONS = [
  {
    value: "class_i",
    label: "Class I - No test required",
    description: "No leakage test required",
  },
  {
    value: "class_ii",
    label: "Class II - 0.5% of rated capacity",
    description: "Metal seated, general service",
  },
  {
    value: "class_iii",
    label: "Class III - 0.1% of rated capacity",
    description: "Metal seated, tighter shutoff",
  },
  {
    value: "class_iv",
    label: "Class IV - 0.01% of rated capacity",
    description: "Metal seated, stringent shutoff",
  },
  { value: "class_v", label: "Class V - Bubble-tight", description: "Soft seated, bubble-tight" },
  {
    value: "class_vi",
    label: "Class VI - Zero leakage",
    description: "Soft seated, zero visible leakage",
  },
  {
    value: "api_598_liquid",
    label: "API 598 Liquid - Zero leakage",
    description: "No visible leakage during test duration",
  },
  {
    value: "api_598_gas",
    label: "API 598 Gas - Bubble rate specified",
    description: "Maximum bubble rate per valve size",
  },
];
...
export const FIRE_SAFE_STANDARDS = [
  ...
  {
    value: "bs_6755_part_2",
    label: "BS 6755 Part 2",
    description: "British Standard fire type-testing",
  },
...
export const CRYOGENIC_SERVICE_OPTIONS = [
  {
    value: "standard",
    label: "Standard (-29°C to ambient)",
    description: "Normal low temperature service",
  },
  {
    value: "low_temp",
    label: "Low Temperature (-46°C to -29°C)",
    description: "Extended low temperature",
  },
  {
    value: "cryogenic_lng",
    label: "Cryogenic LNG (-162°C)",
    description: "Liquefied natural gas service",
  },
  {
    value: "cryogenic_nitrogen",
    label: "Cryogenic Nitrogen (-196°C)",
    description: "Liquid nitrogen service",
  },
  {
    value: "cryogenic_oxygen",
    label: "Cryogenic LOX (-183°C)",
    description: "Liquid oxygen service",
  },
  {
    value: "cryogenic_hydrogen",
    label: "Cryogenic LH2 (-253°C)",
    description: "Liquid hydrogen service",
  },
];
...
export const FUGITIVE_EMISSIONS_OPTIONS = [
  ...
  {
    value: "iso_15848_1_bhc",
    label: "ISO 15848-1 Class BH/C",
    description: "Hydrocarbon, 100 ppm endurance",
  },
  {
    value: "iso_15848_1_aha",
    label: "ISO 15848-1 Class AH/A",
    description: "Hydrocarbon, 50 ppm endurance",
  },
...
export const EXTENDED_BONNET_OPTIONS = [
  ...
  {
    value: "extended_low_temp",
    label: "Extended Bonnet - Low Temp",
    description: "Cryogenic service",
  },
  {
    value: "extended_high_temp",
    label: "Extended Bonnet - High Temp",
    description: "High temperature service",
  },
  { value: "bellows_sealed", label: "Bellows Sealed Bonnet", description: "Zero external leakage" },
  {
    value: "cryogenic_extended",
    label: "Cryogenic Extended Bonnet",
    description: "Per BS 6364 / MSS SP-134",
  },
];
...
export const findValveTorque = (
  valveType: string,
  sizeDN: number,
  pressureClass: string,
): ValveTorqueData | null => {
  return (
    VALVE_TORQUE_REFERENCE.find(

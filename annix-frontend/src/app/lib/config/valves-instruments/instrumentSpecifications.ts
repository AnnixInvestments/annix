...
export const COMMUNICATION_PROTOCOL_OPTIONS = [
  ...
  { value: '4_20ma_hart', label: '4-20mA with HART', description: 'Analog with digital HART protocol overlay' },
  { value: 'hart_7', label: 'HART 7', description: 'Highway Addressable Remote Transducer protocol' },
  { value: 'profibus_pa', label: 'PROFIBUS PA', description: 'Process Automation fieldbus, 31.25 kbit/s' },
  { value: 'profibus_dp', label: 'PROFIBUS DP', description: 'Decentralized Periphery, up to 12 Mbit/s' },
  { value: 'foundation_fieldbus', label: 'Foundation Fieldbus H1', description: 'ISA/IEC 61158 fieldbus, 31.25 kbit/s' },
  ...
  { value: 'ethernet_ip', label: 'EtherNet/IP', description: 'Industrial Ethernet protocol (Rockwell/ODVA)' },
  ...
  { value: 'wireless_hart', label: 'WirelessHART', description: 'IEC 62591 wireless mesh protocol' },
  ...
  { value: 'pulse_frequency', label: 'Pulse/Frequency Output', description: 'Digital pulse or frequency output' },
  { value: 'relay_contact', label: 'Relay Contact', description: 'Dry contact relay output' },
];

// Display Options
export const DISPLAY_OPTIONS = [
  { value: 'none', label: 'Blind (No Display)', description: 'No local display, remote indication only' },
  ...
  { value: 'remote_indicator', label: 'Remote Indicator', description: 'Separate remote display unit' },
  { value: 'touchscreen', label: 'Touchscreen', description: 'Local touchscreen interface' },
  { value: 'backlit', label: 'Backlit Display', description: 'Illuminated for low-light conditions' },
  { value: 'rotatable', label: 'Rotatable Display', description: 'Display can be rotated for viewing angle' },
];

// Power Supply Options
export const POWER_SUPPLY_OPTIONS = [
  { value: 'loop_powered', label: 'Loop Powered (2-wire)', description: '4-20mA loop powered, typically 12-42V DC' },
  ...
  { value: 'intrinsic_safe', label: 'Intrinsically Safe Supply', description: 'IS barrier powered for hazardous areas' },
];

// Wetted Parts Material Options
export const WETTED_PARTS_MATERIAL_OPTIONS = [
  { value: 'ss_316', label: 'Stainless Steel 316/316L', description: 'Standard for most applications' },
  { value: 'ss_304', label: 'Stainless Steel 304', description: 'Economical option for non-corrosive' },
  { value: 'hastelloy_c', label: 'Hastelloy C-276', description: 'Highly corrosion resistant alloy' },
  { value: 'monel', label: 'Monel 400', description: 'Nickel-copper alloy, seawater resistant' },
  { value: 'titanium', label: 'Titanium', description: 'Excellent corrosion resistance, lightweight' },
  ...
  { value: 'ruby', label: 'Synthetic Ruby/Sapphire', description: 'For precision bearing surfaces' },
...
export const PROCESS_CONNECTION_OPTIONS = [
  ...
  { value: 'flanged_din', label: 'Flanged DIN/EN', description: 'DIN/EN 1092-1 flanged connection' },
  { value: 'flanged_jis', label: 'Flanged JIS', description: 'Japanese Industrial Standard flange' },
  ...
  { value: 'insertion', label: 'Insertion/Hot Tap', description: 'Insertion style with ball valve' },
  ...
  { value: 'compression', label: 'Compression Fitting', description: 'Tube compression connection' },
...
export const CABLE_ENTRY_OPTIONS = [
  ...
  { value: 'connector_m12', label: 'M12 Connector', description: 'Industrial M12 circular connector' },
...
export const EXPLOSION_PROOF_OPTIONS = [
  ...
  { value: 'ex_ia', label: 'Ex ia (Intrinsically Safe)', description: 'IS for Zone 0, IEC 60079-11' },
  { value: 'ex_ib', label: 'Ex ib (Intrinsically Safe)', description: 'IS for Zone 1, IEC 60079-11' },
  { value: 'ex_ic', label: 'Ex ic (Intrinsically Safe)', description: 'IS for Zone 2, IEC 60079-11' },
  ...
  { value: 'ex_t', label: 'Ex t (Dust)', description: 'Protection by enclosure for dust, IEC 60079-31' },
  ...
  { value: 'atex_zone_2', label: 'ATEX Zone 2', description: 'Gas not likely, only abnormal conditions' },
  { value: 'atex_zone_20', label: 'ATEX Zone 20', description: 'Combustible dust continuously present' },
  { value: 'atex_zone_21', label: 'ATEX Zone 21', description: 'Combustible dust likely during normal operation' },
  { value: 'atex_zone_22', label: 'ATEX Zone 22', description: 'Combustible dust not likely, abnormal only' },
  { value: 'class_i_div_1', label: 'Class I Div 1 (NEC)', description: 'US/Canada hazardous gas normally present' },
  { value: 'class_i_div_2', label: 'Class I Div 2 (NEC)', description: 'US/Canada hazardous gas abnormal only' },
  { value: 'class_ii_div_1', label: 'Class II Div 1 (NEC)', description: 'US/Canada combustible dust normally present' },
  { value: 'class_ii_div_2', label: 'Class II Div 2 (NEC)', description: 'US/Canada combustible dust abnormal only' },
];
...
export const OUTPUT_SIGNAL_OPTIONS = [
  ...
  { value: 'frequency', label: 'Frequency Output', description: 'Frequency proportional to measurement' },
  ...
  { value: 'digital_bus', label: 'Digital Fieldbus', description: 'Protocol-specific digital output' },
];
...
export const CALIBRATION_OPTIONS = [
  { value: 'standard', label: 'Standard Factory Calibration', description: 'Manufacturer standard calibration' },
  { value: 'traceable', label: 'Traceable Calibration', description: 'Calibration traceable to national standards' },
  ...
  { value: 'sanas', label: 'SANAS Accredited', description: 'South African National Accreditation System' },
  { value: 'iso_17025', label: 'ISO/IEC 17025', description: 'Accredited calibration laboratory' },
  { value: '5_point', label: '5-Point Calibration', description: 'Calibration at 5 points across range' },
  { value: 'wet_calibration', label: 'Wet Calibration', description: 'Calibrated with actual fluid/gas' },
];

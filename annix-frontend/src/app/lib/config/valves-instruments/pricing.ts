...
export const VALVE_BASE_PRICES: ValveBasePricing[] = [
  ...
  { valveType: 'butterfly_valve_double_offset', basePrice: 4500, description: 'Double offset butterfly' },
  { valveType: 'butterfly_valve_triple_offset', basePrice: 12000, description: 'Triple offset butterfly' },
...
export const calculateValvePrice = (input: ValvePriceCalculationInput): ValvePriceCalculationResult | null => {
...
export const ACTUATOR_BASE_PRICES: ActuatorBasePricing[] = [
  { actuatorType: 'pneumatic_da', torqueRange: '0-50 Nm', basePrice: 3500, description: 'Pneumatic double acting' },
  { actuatorType: 'pneumatic_da', torqueRange: '50-150 Nm', basePrice: 5500, description: 'Pneumatic double acting' },
  { actuatorType: 'pneumatic_da', torqueRange: '150-500 Nm', basePrice: 9000, description: 'Pneumatic double acting' },
  { actuatorType: 'pneumatic_da', torqueRange: '500-1500 Nm', basePrice: 15000, description: 'Pneumatic double acting' },
  { actuatorType: 'pneumatic_da', torqueRange: '1500-5000 Nm', basePrice: 28000, description: 'Pneumatic double acting' },
  { actuatorType: 'pneumatic_sr', torqueRange: '0-50 Nm', basePrice: 5000, description: 'Pneumatic spring return' },
  { actuatorType: 'pneumatic_sr', torqueRange: '50-150 Nm', basePrice: 8000, description: 'Pneumatic spring return' },
  { actuatorType: 'pneumatic_sr', torqueRange: '150-500 Nm', basePrice: 14000, description: 'Pneumatic spring return' },
  { actuatorType: 'pneumatic_sr', torqueRange: '500-1500 Nm', basePrice: 25000, description: 'Pneumatic spring return' },
  { actuatorType: 'electric_on_off', torqueRange: '0-50 Nm', basePrice: 6000, description: 'Electric on/off' },
  { actuatorType: 'electric_on_off', torqueRange: '50-150 Nm', basePrice: 10000, description: 'Electric on/off' },
  { actuatorType: 'electric_on_off', torqueRange: '150-500 Nm', basePrice: 18000, description: 'Electric on/off' },
  { actuatorType: 'electric_on_off', torqueRange: '500-1500 Nm', basePrice: 35000, description: 'Electric on/off' },
  { actuatorType: 'electric_modulating', torqueRange: '0-50 Nm', basePrice: 12000, description: 'Electric modulating' },
  { actuatorType: 'electric_modulating', torqueRange: '50-150 Nm', basePrice: 18000, description: 'Electric modulating' },
  { actuatorType: 'electric_modulating', torqueRange: '150-500 Nm', basePrice: 30000, description: 'Electric modulating' },
  { actuatorType: 'electric_modulating', torqueRange: '500-1500 Nm', basePrice: 55000, description: 'Electric modulating' },
];

export const findActuatorPrice = (actuatorType: string, requiredTorque: number): ActuatorBasePricing | null => {
  const actuators = ACTUATOR_BASE_PRICES.filter(a => a.actuatorType === actuatorType);

  for (const actuator of actuators) {
    const [min, max] = actuator.torqueRange.split('-').map(s => parseInt(s));
...
export const VALVE_ACCESSORY_PRICES: AccessoryPricing[] = [
  ...
  { accessory: 'positioner_fieldbus', price: 22000, description: 'Fieldbus positioner (FF/Profibus)' },
  ...
  { accessory: 'mounting_kit', price: 1800, description: 'Actuator mounting kit (bracket + coupling)' },
...
export const INSTRUMENT_BASE_PRICES: InstrumentBasePricing[] = [
  // Flow Instruments
  { instrumentType: 'mag_flowmeter', basePrice: 25000, description: 'Electromagnetic flowmeter (DN50)' },
  { instrumentType: 'ultrasonic_flowmeter', basePrice: 35000, description: 'Ultrasonic flowmeter (DN50)' },
  { instrumentType: 'ultrasonic_clamp_on', basePrice: 45000, description: 'Clamp-on ultrasonic flowmeter' },
  { instrumentType: 'coriolis_flowmeter', basePrice: 85000, description: 'Coriolis mass flowmeter (DN25)' },
  { instrumentType: 'vortex_flowmeter', basePrice: 20000, description: 'Vortex flowmeter (DN50)' },
  { instrumentType: 'turbine_flowmeter', basePrice: 15000, description: 'Turbine flowmeter (DN50)' },
  ...
  { instrumentType: 'pressure_transmitter', basePrice: 8000, description: 'Pressure transmitter (4-20mA)' },
  { instrumentType: 'pressure_transmitter_smart', basePrice: 15000, description: 'Smart pressure transmitter (HART)' },
  { instrumentType: 'dp_transmitter', basePrice: 18000, description: 'Differential pressure transmitter' },
  { instrumentType: 'dp_transmitter_smart', basePrice: 28000, description: 'Smart DP transmitter (HART)' },
  ...
  { instrumentType: 'ultrasonic_level', basePrice: 12000, description: 'Ultrasonic level transmitter' },
  { instrumentType: 'hydrostatic_level', basePrice: 8000, description: 'Hydrostatic level transmitter' },
  { instrumentType: 'float_switch', basePrice: 1500, description: 'Float level switch' },
  { instrumentType: 'magnetic_level_gauge', basePrice: 15000, description: 'Magnetic level gauge (1m)' },
  ...
  { instrumentType: 'thermocouple_assembly', basePrice: 2500, description: 'Thermocouple with head' },
  { instrumentType: 'temp_transmitter', basePrice: 5000, description: 'Temperature transmitter (4-20mA)' },
  { instrumentType: 'temp_transmitter_smart', basePrice: 10000, description: 'Smart temp transmitter (HART)' },
  ...
  { instrumentType: 'conductivity_analyzer', basePrice: 20000, description: 'Conductivity analyzer' },
  { instrumentType: 'dissolved_oxygen', basePrice: 35000, description: 'Dissolved oxygen analyzer' },
...
export const calculateInstrumentPrice = (input: InstrumentPriceCalculationInput): InstrumentPriceCalculationResult | null => {
  const baseInstrument = INSTRUMENT_BASE_PRICES.find(i => i.instrumentType === input.instrumentType);
  if (!baseInstrument) return null;

  const sizeMultiplier = input.sizeDN ? (INSTRUMENT_SIZE_MULTIPLIERS[input.sizeDN] ?? 1.0) : 1.0;
  const linerMultiplier = input.linerMaterial ? (FLOWMETER_LINER_MULTIPLIERS[input.linerMaterial] ?? 1.0) : 1.0;
  const protocolMultiplier = input.protocol ? (INSTRUMENT_PROTOCOL_MULTIPLIERS[input.protocol] ?? 1.0) : 1.0;

...
import { useOrbitUpsertWorkforceNeed, useOrbitWorkforceNeed } from "@/app/lib/query/hooks";
...
export function WorkforceCapacityPanel(props: WorkforceCapacityPanelProps) {
  ...
  const query = useOrbitWorkforceNeed(rfqId);
  const mutation = useOrbitUpsertWorkforceNeed(rfqId);

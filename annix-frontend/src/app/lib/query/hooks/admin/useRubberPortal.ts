...
export function useUpdateRubberOrder() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      id: number;
      data: Parameters<typeof rubberPortalApi.updateOrder>[1];
...
export function useSaveRubberCompany() {
  ...
  return useMutation({
    mutationFn: (data: {
      id?: number;
      payload: Parameters<typeof rubberPortalApi.createCompany>[0];
    }) => {
      if (data.id) {
...
export function useSaveRubberCoding() {
  ...
  return useMutation({
    mutationFn: (data: {
      id?: number;
      payload: Omit<RubberProductCodingDto, "id" | "firebaseUid">;
    }) => {
      if (data.id) {
        return rubberPortalApi.updateProductCoding(data.id, {

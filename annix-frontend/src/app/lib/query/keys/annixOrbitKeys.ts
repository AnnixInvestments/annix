...
export const annixOrbitKeys = {
  ...
  dismissReasons: {
    all: ["annix-orbit", "dismiss-reasons"] as const,
    list: () => ["annix-orbit", "dismiss-reasons", "list"] as const,
  },
  seekerApplications: {
  ...
  seekerBilling: {
    all: ["annix-orbit", "seeker", "billing"] as const,
    status: () => ["annix-orbit", "seeker", "billing", "status"] as const,
  },
} as const;

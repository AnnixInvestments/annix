...
export const BlockEditor = forwardRef<BlockEditorHandle, BlockEditorProps>(
  function BlockEditor(props, ref) {
    ...
    useImperativeHandle(ref, () => ({ saveDraft: autoSaveDraft, hasChanges: () => dirty }), [
      dirty,
      blocks,
      props.pageId,
    ]);
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between gap-3">
          <p className="text-sm text-gray-500">
            Build the page from content blocks. Save Draft stores your changes; Publish pushes them
            to the live page (only when "Use blocks for the live page" is ticked above).
          </p>

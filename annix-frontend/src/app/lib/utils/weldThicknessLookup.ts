...
export const CARBON_STEEL_PIPES: CarbonSteelPipeData[] = [
  {
    ...
    schedule: "STD (40)",
    wall_mm: 2.77,
    pressures_bar: [344, 344, 325, 293, 289, 224, 186, 150],
  },
  {
    dn: 15,
    schedule: "XS (80)",
    wall_mm: 3.73,
    pressures_bar: [481, 481, 455, 409, 404, 313, 260, 209],
  },
  {
    dn: 15,
    schedule: "160",
    wall_mm: 4.78,
    pressures_bar: [628, 628, 594, 534, 528, 408, 339, 273],
  },
  {
    dn: 15,
    schedule: "XXS",
    wall_mm: 7.47,
    pressures_bar: [982, 982, 928, 835, 825, 639, 531, 427],
  },
  {
    dn: 20,
    schedule: "STD (40)",
    wall_mm: 2.87,
    pressures_bar: [281, 281, 265, 239, 236, 182, 152, 122],
  },
  {
    dn: 20,
    schedule: "XS (80)",
    wall_mm: 3.91,
    pressures_bar: [394, 394, 372, 335, 331, 256, 213, 171],
  },
  {
    dn: 20,
    schedule: "160",
    wall_mm: 5.56,
    pressures_bar: [582, 582, 550, 494, 488, 378, 314, 253],
  },
  {
    dn: 20,
    schedule: "XXS",
    wall_mm: 7.82,
    pressures_bar: [831, 831, 785, 706, 698, 540, 449, 362],
  },
  {
    dn: 25,
    schedule: "STD (40)",
    wall_mm: 3.38,
    pressures_bar: [263, 263, 248, 223, 220, 171, 142, 114],
  },
  {
    dn: 25,
    schedule: "XS (80)",
    wall_mm: 4.55,
    pressures_bar: [363, 363, 343, 309, 305, 236, 196, 158],
  },
  {
    dn: 25,
    schedule: "160",
    wall_mm: 6.35,
    pressures_bar: [525, 525, 496, 446, 441, 341, 283, 228],
  },
  {
    dn: 25,
    schedule: "XXS",
    wall_mm: 9.09,
    pressures_bar: [770, 770, 728, 655, 647, 501, 416, 335],
  },
  {
    dn: 32,
    schedule: "STD (40)",
    wall_mm: 3.56,
    pressures_bar: [216, 216, 204, 184, 182, 140, 117, 94],
  },
  {
    dn: 32,
    schedule: "XS (80)",
    wall_mm: 4.85,
    pressures_bar: [302, 302, 285, 257, 253, 196, 163, 131],
  },
  {
    dn: 32,
    schedule: "160",
    wall_mm: 6.35,
    pressures_bar: [406, 406, 384, 345, 341, 264, 219, 177],
  },
  {
    dn: 32,
    schedule: "XXS",
    wall_mm: 9.7,
    pressures_bar: [646, 646, 610, 549, 543, 420, 349, 281],
  },
  {
    dn: 40,
    schedule: "STD (40)",
    wall_mm: 3.68,
    pressures_bar: [194, 194, 184, 165, 163, 126, 105, 85],
  },
  {
    dn: 40,
    schedule: "XS (80)",
    wall_mm: 5.08,
    pressures_bar: [274, 274, 259, 233, 230, 178, 148, 119],
  },
  {
    dn: 40,
    schedule: "160",
    wall_mm: 7.14,
    pressures_bar: [397, 397, 376, 338, 334, 259, 215, 173],
  },
  {
    dn: 40,
    schedule: "XXS",
    wall_mm: 10.16,
    pressures_bar: [588, 588, 556, 500, 494, 382, 317, 256],
  },
  {
    dn: 50,
    schedule: "STD (40)",
    wall_mm: 3.91,
    pressures_bar: [164, 164, 155, 139, 138, 106, 88, 71],
  },
  {
    dn: 50,
    schedule: "XS (80)",
    wall_mm: 5.54,
    pressures_bar: [237, 237, 224, 201, 199, 154, 128, 103],
  },
  {
    dn: 50,
    schedule: "160",
    wall_mm: 8.74,
    pressures_bar: [389, 389, 367, 330, 327, 253, 210, 169],
  },
  {
    dn: 50,
    schedule: "XXS",
    wall_mm: 11.07,
    pressures_bar: [508, 508, 480, 432, 427, 330, 274, 221],
  },
  {
    dn: 65,
    schedule: "STD (40)",
    wall_mm: 5.16,
    pressures_bar: [179, 179, 169, 152, 150, 116, 97, 78],
  },
  {
    dn: 65,
    schedule: "XS (80)",
    wall_mm: 7.01,
    pressures_bar: [248, 248, 234, 211, 208, 161, 134, 108],
  },
  {
    dn: 65,
    schedule: "160",
    wall_mm: 9.53,
    pressures_bar: [346, 346, 327, 294, 291, 225, 187, 151],
  },
  {
    dn: 65,
    schedule: "XXS",
    wall_mm: 14.02,
    pressures_bar: [531, 531, 502, 451, 446, 345, 287, 231],
  },
  {
    dn: 80,
    schedule: "STD (40)",
    wall_mm: 5.49,
    pressures_bar: [156, 156, 150, 132, 131, 101, 84, 68],
  },
  {
    dn: 80,
    schedule: "XS (80)",
    wall_mm: 7.62,
    pressures_bar: [220, 220, 208, 187, 185, 143, 119, 96],
  },
  {
    dn: 80,
    schedule: "160",
    wall_mm: 11.13,
    pressures_bar: [331, 331, 313, 281, 278, 215, 179, 144],
  },
  {
    dn: 80,
    schedule: "XXS",
    wall_mm: 15.24,
    pressures_bar: [470, 470, 444, 399, 395, 305, 254, 204],
  },
  {
    dn: 100,
    schedule: "STD (40)",
    wall_mm: 6.02,
    pressures_bar: [132, 132, 125, 112, 111, 86, 71, 57],
  },
  {
    dn: 100,
    schedule: "XS (80)",
    wall_mm: 8.56,
    pressures_bar: [191, 191, 180, 162, 160, 124, 121, 83],
  },
  {
    dn: 100,
    schedule: "120",
    wall_mm: 11.13,
    pressures_bar: [252, 252, 238, 214, 212, 164, 136, 110],
  },
  {
    dn: 100,
    schedule: "160",
    wall_mm: 13.49,
    pressures_bar: [310, 310, 293, 264, 261, 202, 168, 132],
  },
  {
    dn: 100,
    schedule: "XXS",
    wall_mm: 17.12,
    pressures_bar: [403, 403, 381, 343, 339, 262, 218, 175],
  },
  {
    dn: 125,
    schedule: "STD (40)",
    wall_mm: 6.55,
    pressures_bar: [116, 116, 109, 98, 97, 75, 62, 50],
  },
  {
    dn: 125,
    schedule: "XS (80)",
    wall_mm: 9.53,
    pressures_bar: [171, 171, 161, 145, 143, 111, 92, 74],
  },
  {
    dn: 125,
    schedule: "120",
    wall_mm: 12.7,
    pressures_bar: [231, 231, 219, 197, 194, 150, 125, 101],
  },
  {
    dn: 125,
    schedule: "160",
    wall_mm: 15.88,
    pressures_bar: [294, 294, 278, 250, 247, 191, 159, 128],
  },
  {
    dn: 125,
    schedule: "XXS",
    wall_mm: 19.05,
    pressures_bar: [359, 359, 339, 305, 302, 233, 194, 156],
  },
  {
    dn: 150,
    schedule: "STD (40)",
    wall_mm: 7.11,
    pressures_bar: [106, 106, 99, 89, 88, 68, 54, 46],
  },
  {
    dn: 150,
    schedule: "XS (80)",
    wall_mm: 10.97,
    pressures_bar: [165, 165, 156, 140, 138, 107, 89, 72],
  },
  {
    dn: 150,
    schedule: "120",
    wall_mm: 14.27,
    pressures_bar: [217, 217, 206, 184, 183, 141, 117, 95],
  },
  {
    dn: 150,
    schedule: "XXS (160)",
    wall_mm: 18.26,
    pressures_bar: [283, 283, 268, 241, 238, 184, 153, 123],
  },
  ...
  { dn: 200, schedule: "60", wall_mm: 10.31, pressures_bar: [117, 117, 111, 100, 99, 76, 63, 51] },
  {
    ...
    schedule: "XS (80)",
    wall_mm: 12.7,
    pressures_bar: [146, 146, 138, 124, 122, 95, 79, 63],
  },
  {
    dn: 200,
    schedule: "100",
    wall_mm: 15.09,
    pressures_bar: [175, 175, 165, 148, 147, 113, 94, 76],
  },
  {
    dn: 200,
    schedule: "120",
    wall_mm: 18.26,
    pressures_bar: [213, 213, 202, 181, 179, 139, 115, 93],
  },
  {
    dn: 200,
    schedule: "140",
    wall_mm: 20.62,
    pressures_bar: [243, 243, 230, 207, 204, 158, 131, 106],
  },
  {
    dn: 200,
    schedule: "XXS",
    wall_mm: 22.23,
    pressures_bar: [263, 263, 249, 224, 221, 171, 142, 115],
  },
  {
    dn: 200,
    schedule: "160",
    wall_mm: 23.01,
    pressures_bar: [273, 273, 258, 232, 230, 178, 148, 119],
  },
];
...
export const CARBON_STEEL_FITTINGS: Record<string, FittingData[]> = {
  ...
  XH: [
    ...
    { dn: 200, od_mm: 219.1, wall_mm: 12.7, pressures_bar: [125, 120, 109, 90] },
    { dn: 250, od_mm: 273.0, wall_mm: 12.7, pressures_bar: [100, 96, 87, 72] },
    { dn: 300, od_mm: 323.9, wall_mm: 12.7, pressures_bar: [83, 80, 72, 60] },
    { dn: 350, od_mm: 355.6, wall_mm: 12.7, pressures_bar: [76, 73, 66, 55] },
    { dn: 400, od_mm: 406.4, wall_mm: 12.7, pressures_bar: [66, 64, 57, 48] },
    { dn: 450, od_mm: 457.2, wall_mm: 12.7, pressures_bar: [59, 57, 51, 42] },
    { dn: 500, od_mm: 508.0, wall_mm: 12.7, pressures_bar: [53, 51, 46, 38] },
    { dn: 600, od_mm: 609.6, wall_mm: 12.7, pressures_bar: [44, 42, 38, 32] },
    { dn: 750, od_mm: 762.0, wall_mm: 12.7, pressures_bar: [35, 34, 30, 25] },
    { dn: 900, od_mm: 914.4, wall_mm: 12.7, pressures_bar: [29, 28, 25, 21] },
    { dn: 1000, od_mm: 1016.0, wall_mm: 12.7, pressures_bar: [26, 25, 23, 19] },
    { dn: 1050, od_mm: 1066.8, wall_mm: 12.7, pressures_bar: [25, 24, 22, 18] },
    { dn: 1200, od_mm: 1219.2, wall_mm: 12.7, pressures_bar: [22, 21, 19, 16] },
  ],
  XXH: [
    ...
    { dn: 32, od_mm: 42.2, wall_mm: 9.7, pressures_bar: [583, 560, 505, 420] },
    ...
    { dn: 250, od_mm: 273.0, wall_mm: 25.4, pressures_bar: [208, 199, 180, 150] },
    { dn: 300, od_mm: 323.9, wall_mm: 25.4, pressures_bar: [173, 166, 150, 124] },
    { dn: 350, od_mm: 355.6, wall_mm: 25.4, pressures_bar: [157, 151, 136, 113] },
    { dn: 400, od_mm: 406.4, wall_mm: 25.4, pressures_bar: [137, 132, 119, 99] },
    { dn: 450, od_mm: 457.2, wall_mm: 25.4, pressures_bar: [122, 117, 106, 88] },
    { dn: 500, od_mm: 508.0, wall_mm: 25.4, pressures_bar: [110, 105, 95, 79] },
    { dn: 600, od_mm: 609.6, wall_mm: 25.4, pressures_bar: [91, 88, 79, 66] },
  ],
};
...
export function recommendWallThicknessCarbonPipe(
  ...
  if (candidates.length === 0) {
    ...
    const thickest = allForDn.reduce((max, p) => (p.wall_mm > max.wall_mm ? p : max));

    const normalizedCurrent = currentSchedule ? normalizeSchedule(currentSchedule) : null;
    const currentPipe = normalizedCurrent
      ? CARBON_STEEL_PIPES.find(
          (p) =>
            p.dn === dn &&
            p.schedule.includes(normalizedCurrent.replace(" (40)", "").replace(" (80)", "")),
        )
      : null;
  ...
  const recommended = candidates.reduce((min, p) => (p.wall_mm < min.wall_mm ? p : min));
...
export function recommendWallThicknessStainlessPipe(
  ...
  const minWall = candidates.reduce((min, p) => (p.wall_mm < min.wall_mm ? p : min));
...
export function getAvailableSchedules(dn: number): string[] {
  return CARBON_STEEL_PIPES.filter((p) => p.dn === dn).map((p) => p.schedule);
}

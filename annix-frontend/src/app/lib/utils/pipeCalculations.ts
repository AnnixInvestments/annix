 ...
 *
 * @param nominalBoreMm - Nominal bore in millimeters
 * @param pressureBar - Working pressure in bar
 * @param temperatureC - Design temperature in Celsius (default: 20)
 * @param materialCode - Material code (default: 'ASTM_A106_Grade_B')
...
// ============================================================================
// Re-exports for extracted modules (split in issue #191, Phase 7)
// ============================================================================

export {
  calculateDuckfootBendingMoment,
  calculateDuckfootGussetThickness,
  calculateDuckfootSteelworkWeight,
  calculateDuckfootThrustForce,
  type DuckfootGussetConfig,
  type DuckfootGussetResult,
  recommendDuckfootGussetCount,
  recommendDuckfootGussetThickness,
} from "./pipeDuckfootCalculations";
export {
  ANSI_B165_CLASS_150_FLANGES,
  ANSI_B165_CLASS_300_FLANGES,
  ANSI_B165_CLASS_600_FLANGES,
  calculateComprehensiveSurfaceArea,
  calculateSurfaceAreaPerPipe,
  calculateTotalSurfaceArea,
  type FlangeDimensions,
  getFlangeDimensionsByDn,
  type SurfaceAreaParams,
  type SurfaceAreaResult,
} from "./pipeSurfaceArea";
export {
  calculateBendWeldVolume,
  calculateButtWeldVolume,
  calculateFittingWeldVolume,
  calculateFlangeWeldVolume,
  calculateSaddleWeldVolume,
  calculateTotalWeldVolume,
  type WeldVolumeConfig,
  type WeldVolumeResult,
} from "./pipeWeldVolume";

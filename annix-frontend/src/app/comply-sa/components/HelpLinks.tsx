...
export default function HelpLinks() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {open && (
        <div className="absolute bottom-14 right-0 w-72 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="py-1">
            {HELP_LINKS.map((link) => (
              <a
                ...
                className="flex items-center justify-between px-4 py-2.5 text-sm text-slate-300 hover:bg-slate-700/50 hover:text-white transition-colors"
              >
                {link.label}

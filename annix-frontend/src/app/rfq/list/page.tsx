        ...
        <div className="mb-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-4 flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              <input
                type="text"
                placeholder="Search by RFQ number, project name, customer..."
                value={searchTerm}
                ...
                <div className="p-6">
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 font-medium">{rfq.projectName}</p>
                      {rfq.customerName && (
                    ...
                    <div className="flex items-center gap-6 text-sm text-gray-500">
                      <div className="text-center">
                        ...
                        <p className="font-medium text-blue-600">{rfq.itemCount}</p>
                      </div>
                      <div className="text-center">

  ...
  return (
    ...
    >
      ...
      <p>
        ...
        CONFIRMED] | Website: <span className="text-teal-400">sentinel.annix.co.za</span> | Email:
  ...
  async function handleSaveAndContinue() {
    ...
    if (keys(step1Errs).length > 0) {
      ...
      try {
        ...
        router.push("/annix-sentinel/onboarding");
      } catch (err) {
        setError(err instanceof Error ? err.message : "Signup failed");
      } finally {
        setLoading(false);
    ...
    <div className="min-h-screen bg-[#0A1B3D] flex items-center justify-center px-4 py-12">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 sm:p-8">
          ...
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-700">
            <p className="text-sm text-slate-400">
              ...
              <Link
                href="/annix-sentinel/auth/login"
      ...
      {showSuccessModal && (
        <SuccessModal
          ...
          onContinue={() => router.push("/annix-sentinel/onboarding")}
        />
      )}

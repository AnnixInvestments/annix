...
import SetupWizard from "@/app/annix-sentinel/components/SetupWizard";
import { formatDateZA } from "@/app/lib/datetime";
import { useAnnixSentinelDashboard, useUploadDocument } from "@/app/lib/query/hooks";

type DashboardData = NonNullable<ReturnType<typeof useAnnixSentinelDashboard>["data"]>;
...
export default function DashboardPage() {
  const { data, isLoading, error } = useAnnixSentinelDashboard();

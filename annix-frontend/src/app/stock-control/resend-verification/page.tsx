...
// eslint-disable-next-line no-restricted-imports -- Auth flow page (resend-verification); requires new auth hooks for unauthenticated operations. Tracked as tech debt per Phase 9 of annix/annix#191.
...
export default function ResendVerificationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await stockControlApiClient.resendVerification(email);
      setSubmitted(true);
    } catch (err) {

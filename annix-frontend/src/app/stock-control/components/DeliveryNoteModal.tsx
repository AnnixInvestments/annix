...
export function DeliveryNoteModal(props: DeliveryNoteModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" aria-labelledby="delivery-note-modal-title">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h2 id="delivery-note-modal-title" className="text-lg font-semibold text-gray-900">New Delivery Note</h2>

...
import type { StockControlSupplierDto, StockItem } from "@/app/lib/api/stockControlApi";
...
export function CertificatesPanel() {
  ...
  const handleDelete = async (id: number) => {
    try {
      ...
      setError(extractErrorMessage(err, "Failed to delete certificate"));
    }
  };
  ...
  const handleSaveCertificate = async (cert: IdentifiedCertificate, index: number) => {
    ...
    try {
      ...
      setError(extractErrorMessage(err, "Failed to save certificate"));
    } finally {
      setSavingCerts((prev) => {
              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    ...
                    setError(extractErrorMessage(err, "Product extraction failed"));
                  } finally {

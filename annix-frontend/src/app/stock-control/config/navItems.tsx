...
export const ALL_NAV_ITEMS: NavItemDef[] = [
  ...
  {
    key: "stock-reconcile",
    href: "/stock-control/portal/inventory/reconcile",
    label: "Reconcile",
    defaultRoles: ["manager", "admin"],
    group: "Stock",
    icon: (
  ...
  },
  {
    ...
    label: "Quotations",
    defaultRoles: ["viewer", "accounts", "manager", "admin"],
    group: "Customer",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
  ...
  },
  {
    ...
    href: "/stock-control/portal/customer-invoices",
  ...
  },
  {
    ...
    href: "/stock-control/portal/customer-scorecard",
    label: "Scorecard",
    defaultRoles: ["accounts", "manager", "admin"],
    group: "Customer",
    icon: (
  ...
  },
  {
    ...
    href: "/stock-control/portal/customer-documents",
    label: "Documents",
    defaultRoles: ["viewer", "quality", "storeman", "accounts", "manager", "admin"],
    group: "Customer",
    icon: (
  ...
  },
  {
    ...
    href: "/stock-control/portal/cpo-batch-approvals",
  ...
  {
    key: "stock-management-admin",
    href: "/stock-control/portal/preview/stock-management",
  ...
  {
    key: "rubber-issuing",
    href: "/stock-control/portal/rubber-issuing",
    label: "Rubber Issuing",
    defaultRoles: ["storeman", "manager", "admin"],
    group: "hidden",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    href: "/stock-control/portal/supplier-purchase-orders",
    label: "Supplier POs",
    defaultRoles: ["accounts", "manager", "admin"],
    group: "Supplier",
    icon: (
  ...
  {
    key: "grns",
    href: "/stock-control/portal/grns",
    label: "GRNs",
    defaultRoles: ["storeman", "accounts", "manager", "admin"],
    group: "Supplier",
    icon: (
  ...
  },
  {
    ...
    href: "/stock-control/portal/supplier-scorecard",
    label: "Scorecard",
    defaultRoles: ["accounts", "manager", "admin"],
    group: "Supplier",
    icon: (
  ...
  },
  {
    ...
    href: "/stock-control/portal/supplier-documents",
    label: "Documents",
    defaultRoles: ["viewer", "quality", "storeman", "accounts", "manager", "admin"],
    group: "Supplier",
    icon: (
  ...
  {
    key: "paint-dfts",
    href: "/stock-control/portal/quality/paint-dfts",
    label: "Paint DFTs",
    defaultRoles: ["quality", "manager", "admin"],
    group: "Quality",
    requiresQc: true,
  ...
  {
    key: "blast-profile",
    href: "/stock-control/portal/quality/blast-profile",
    label: "Blast Profile",
    defaultRoles: ["quality", "manager", "admin"],
    group: "Quality",
    requiresQc: true,
  ...
  {
    key: "shore-hardness",
    href: "/stock-control/portal/quality/shore-hardness",
  ...
  {
    key: "environmental",
    href: "/stock-control/portal/quality/environmental",
    label: "Environmental",
    defaultRoles: ["quality", "manager", "admin"],
    group: "Quality",
    requiresQc: true,
  ...
  {
    key: "qcp-log",
    href: "/stock-control/portal/quality/qcp-log",
    label: "QCP Log",
    defaultRoles: ["quality", "manager", "admin"],
    group: "Quality",
    requiresQc: true,
  ...
  {
    key: "boiler-control-docs",
    href: "/stock-control/portal/admin/boiler-control-docs",
    label: "Boiler Control Docs",
    defaultRoles: ["admin"],
    group: "Resources",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    key: "paint-pricing",
    href: "/stock-control/portal/admin/paint-pricing",
    label: "Paint Pricing",
    defaultRoles: ["manager", "admin"],
    group: "Resources",
    icon: (
...
export const isNavItemAllowedForRole = (
  ...
  const rbacOverride = rbacConfig[item.key];
  const configured = rbacOverride == null ? item.defaultRoles : rbacOverride;

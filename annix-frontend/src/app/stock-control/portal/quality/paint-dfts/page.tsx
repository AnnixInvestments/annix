...
export default function PaintDftsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Paint DFT Readings</h1>
        <p className="mt-1 text-sm text-gray-600">
          Dry film thickness readings across all job cards
        </p>
      </div>
      ...
      <UnlinkedUploadsSection entityType="dft" entityLabel="DFT" />
      ...
      <div className="bg-white shadow rounded-lg overflow-x-auto">
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No DFT readings</h3>
              ...
              {records.map((rec) => {
                ...
                return (
                  <tr key={rec.id} className="hover:bg-gray-50">
                    ...
                    <td className="whitespace-nowrap px-4 py-3 text-sm text-gray-600">{specStr}</td>

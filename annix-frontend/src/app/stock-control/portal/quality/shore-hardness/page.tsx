...
export default function ShoreHardnessPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Shore Hardness Readings</h1>
        <p className="mt-1 text-sm text-gray-600">
          Rubber shore hardness measurements across all job cards
        </p>
      </div>
      ...
      <UnlinkedUploadsSection entityType="shore_hardness" entityLabel="shore hardness" />
      ...
      <div className="bg-white shadow rounded-lg overflow-x-auto">
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No shore hardness readings</h3>

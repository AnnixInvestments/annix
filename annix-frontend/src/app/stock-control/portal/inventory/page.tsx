...
export default function InventoryPage() {
  ...
  const {
    ...
    invalidateInventory,
  } = useInventoryPageState(pdfPreview);
  ...
  const importFileName = state.importFile ? state.importFile.name : null;
  const printPreviewItems = state.printPreviewItems;
  const confirmDeleteId = state.confirmDeleteId;
  const canEdit = canEditPrices ?? false;
                ...
                <div className="print:block">
                  ...
                  <table className="min-w-full divide-y divide-gray-200 print:text-sm">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {printPreviewItems
                        .filter((item) => item != null && isObject(item))
                        .map((item) => {

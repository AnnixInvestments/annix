...
import type { CoatingAnalysis, QcBatchAssignment } from "@/app/lib/api/stockControlApi";
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
      <div className="flex items-center justify-between border-b border-gray-200 px-4 py-2">
        <h3 className="text-xs font-semibold text-gray-900">Item-Level Batch Assignments</h3>
      </div>
            ...
            <div key={field.fieldKey} className="rounded border border-gray-100 bg-gray-50 p-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  {unassignedCount > 0 && (
                    <span className="text-[10px] text-amber-600">{unassignedCount} unassigned</span>
                  )}

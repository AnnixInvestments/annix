...
export default function CompanyCalendarPage() {
  ...
  const slotsQuery = useOrbitInterviewSlotsForCompany(fromIso ? fromIso : null);
  const { data: jobs = [] } = useOrbitJobPostings();
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/5 rounded-xl border border-white/10 p-4">
        <p className="text-sm text-white/80">
          ...
          <Link href="/annix/orbit/portal/candidates" className="underline hover:text-white">
            candidate shortlist
          </Link>{" "}

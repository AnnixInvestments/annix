...
export default function SettingsPage() {
  ...
  const updateCompanyMutation = useOrbitUpdateCompanySettings();
  const updateImapMutation = useOrbitUpdateImapSettings();
  const updateNotifMutation = useOrbitUpdateNotificationPreferences();
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-white/70 mt-1">Configure your Annix Orbit settings</p>
      </div>

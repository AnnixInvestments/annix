...
const navItems: NavItem[] = [
  ...
  {
    href: "/annix/orbit/seeker/futurepath",
    label: "FuturePath",
  ...
  {
    href: "/annix/orbit/seeker/guardian",
    label: "For Parents",
...
function SeekerContent({ children }: { children: React.ReactNode }) {
  ...
  const isOnFuturePathPage = pathname.startsWith("/annix/orbit/seeker/futurepath");
  const isOnHowToPage = pathname.startsWith("/annix/orbit/seeker/how-to");
  const isOnGuardianPage = pathname.startsWith("/annix/orbit/seeker/guardian");
  const cvGateExempt =
    isOnProfilePage ||
    isOnSettingsPage ||
    isOnJobsPage ||

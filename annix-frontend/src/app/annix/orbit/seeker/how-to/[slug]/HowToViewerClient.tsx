...
interface SeekerHowToViewerClientProps {
  guide: ViewerGuide;
...
export default function HowToViewerClient(props: SeekerHowToViewerClientProps) {
  ...
  return (
    <SharedHowToViewerClient
      ...
      helpfulKeyPrefix="annix-orbit-seeker-how-to-helpful:"
    />
  );
}

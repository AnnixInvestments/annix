...
import { extractHeadings, loadAllGuides, loadGuideBySlug } from "@/app/annix/orbit/how-to/loader";
...
export default async function SeekerHowToGuidePage(props: PageProps) {

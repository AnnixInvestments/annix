  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorMessage.includes("Invalid credentials")) {
        ...
        setError("You do not have permission to access the AU Rubber App.");
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-yellow-500 mb-4">
            <span className="text-3xl font-bold text-slate-900">AU</span>
          </div>
          <h1 className="text-3xl font-bold text-white">AU Rubber App</h1>
          <p className="mt-2 text-xl text-blue-200">Sign in to manage rubber products</p>
        </div>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-2xl rounded-lg sm:px-10">
          ...
          >
            ...
            <button
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-slate-900 bg-yellow-500 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
            >
              {isSubmitting ? (
                <>

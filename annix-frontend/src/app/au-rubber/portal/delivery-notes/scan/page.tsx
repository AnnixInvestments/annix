          ...
          <div className="bg-white shadow rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className={`px-3 py-1 text-sm font-medium rounded-full ${
                ...
                {result.data.documentType === "SUPPLIER_DELIVERY" ? "Supplier Delivery" : "Customer Delivery"}
              </span>
            </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                {result.data.purchaseOrderNumber && (
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-gray-900">{result.data.purchaseOrderNumber}</dd>
                  </div>
                )}
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    {result.data.fromCompany.address && (
                      <p className="text-sm text-gray-600 mt-1">{result.data.fromCompany.address}</p>
                    )}
                    {result.data.fromCompany.vatNumber && (
                      <p className="text-xs text-gray-500 mt-1">VAT: {result.data.fromCompany.vatNumber}</p>
                    )}
                  </div>
                </div>
              )}
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    {result.data.toCompany.vatNumber && (
                      <p className="text-xs text-gray-500 mt-1">VAT: {result.data.toCompany.vatNumber}</p>
                    )}
                  </div>
                </div>
              )}
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-center">
                    {result.data.totals.totalQuantity && (
                      <div className="bg-gray-50 rounded-lg p-3">
                        <p className="text-lg font-semibold text-gray-900">{result.data.totals.totalQuantity}</p>
                        <p className="text-xs text-gray-500">Total Qty</p>
                      </div>
                    )}
                    {result.data.totals.numberOfRolls && (
                      <div className="bg-gray-50 rounded-lg p-3">
                        <p className="text-lg font-semibold text-gray-900">{result.data.totals.numberOfRolls}</p>
                        <p className="text-xs text-gray-500">Rolls</p>
                      </div>
                    )}
                    {result.data.totals.totalWeightKg && (
                      <div className="bg-gray-50 rounded-lg p-3">
                        <p className="text-lg font-semibold text-gray-900">{result.data.totals.totalWeightKg} kg</p>
              ...
              {result.data.notes && (
                <div className="border-t pt-4">
                  ...
                  <p className="text-sm text-gray-600 bg-yellow-50 p-3 rounded-lg">{result.data.notes}</p>
                </div>
              )}

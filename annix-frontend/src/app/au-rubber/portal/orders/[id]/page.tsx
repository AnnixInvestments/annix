                      ...
                      >
                        ...
                        <td className="px-3 py-3 text-center">
                          <select
                            ...
                            className="w-20 rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 text-sm border p-1.5"
                          >
                            <option value="">-</option>
                        ...
                        <td className="px-3 py-3 text-center">
                          <select
                            ...
                            className="w-24 rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 text-sm border p-1.5"
                          >
                            <option value="">-</option>
                            {WIDTH_OPTIONS.map((w) => (
                        ...
                        <td className="px-3 py-3 text-center">
                          <div className="flex items-center justify-center space-x-1">
                            ...
                            <input
                              ...
                              className="w-12 text-center rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500 text-sm border p-1"
                              min="0"
                            />
                            <button
                              onClick={() =>

...
import { compressPhoto, fileToDataUrl } from "@/app/lib/image/photoCompression";

const ACCENT = "var(--brand-navbar, #0f766e)";
const ACCENT_SOFT = "var(--brand-navbar-50, #f0fdfa)";
    ...
    return (
      <div className="space-y-2">
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-1.5 text-sm font-medium rounded-md transition-opacity hover:opacity-90 disabled:opacity-50"
  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={handleClick}
        disabled={isCompressing}
        className="inline-flex items-center px-4 py-2 border-2 border-dashed border-gray-300 rounded-lg text-sm font-medium text-gray-600 transition-colors hover:opacity-90 disabled:opacity-50"
      >
        {isCompressing ? (
          <>
            <div
              className="w-5 h-5 mr-2 border-2 border-t-transparent rounded-full animate-spin"

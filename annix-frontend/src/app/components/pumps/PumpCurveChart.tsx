...
export function PumpCurveChart({
  ...
  const bepZone = useMemo(() => {
    ...
    return {
      ...
      width: scales.xScale(Math.min(maxFlow, preferredMax)) - scales.xScale(Math.max(minFlow, preferredMin)),
    };
  }, [pumpCurve, scales]);
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      ...
      <svg width={width} height={height} className="overflow-visible">
        <g transform={`translate(${PADDING.left}, ${PADDING.top})`}>
          ...
          <line x1={0} y1={chartHeight} x2={chartWidth} y2={chartHeight} stroke={COLORS.axis} strokeWidth={2} />
          ...
          {hoveredPoint && (
            <g transform={`translate(${scales.xScale(hoveredPoint.flowM3h) + 10}, ${scales.yScaleHead(hoveredPoint.headM) - 10})`}>
              <rect
                x={0}
                y={-50}
                width={120}
      ...
      <div className="flex flex-wrap items-center gap-4 mt-4 text-xs">
        ...
        {showEfficiency && efficiencyPath && (
          <div className="flex items-center gap-2">
            <div className="w-4 h-0.5 border-dashed border-t-2" style={{ borderColor: COLORS.efficiency }} />
        ...
        {operatingPoint && (
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full" style={{ backgroundColor: COLORS.operatingPoint }} />
      ...
      <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
        ...
        <div className="bg-gray-50 rounded p-2">
          ...
          <div className="font-medium">
            {pumpCurve.bestEfficiencyPoint.flowM3h} m³/h @ {pumpCurve.bestEfficiencyPoint.efficiencyPercent}%
          </div>
        </div>
      </div>
    </div>

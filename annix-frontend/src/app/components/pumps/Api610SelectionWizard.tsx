...
export function Api610SelectionWizard(props: Api610SelectionWizardProps) {
  ...
  const rawFlowRateM3h = initialCriteria?.flowRateM3h;
  const rawHeadM = initialCriteria?.headM;
  const rawTemperatureC = initialCriteria?.temperatureC;
  const rawPressureBar = initialCriteria?.pressureBar;
  const rawPowerKw = initialCriteria?.powerKw;
  const rawInstallationType = initialCriteria?.installationType;
  const rawSpaceConstrained = initialCriteria?.spaceConstrained;
  const rawMaintenanceAccess = initialCriteria?.maintenanceAccess;
  const [criteria, setCriteria] = useState<Api610SelectionCriteria>({
    flowRateM3h: rawFlowRateM3h || 100,
    headM: rawHeadM || 50,
    temperatureC: rawTemperatureC || 20,
    pressureBar: rawPressureBar || 10,
    powerKw: rawPowerKw || 50,
    category: initialCriteria?.category,
    fluidType: initialCriteria?.fluidType,
    installationType: rawInstallationType || "horizontal",
    spaceConstrained: rawSpaceConstrained || false,
    maintenanceAccess: rawMaintenanceAccess || "moderate",
  });
  ...
  const renderOperatingConditions = () => {
    const rawCategory = criteria.category;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleCriteriaChange("temperatureC", parseFloat(e.target.value) || 0)
              }
              className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-blue-500 focus:border-blue-500"
              min={-50}
              max={500}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                return handleCriteriaChange(
                  "category",
                  (rawValue || undefined) as Api610PumpCategory | undefined,
                );
              }}
              className="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-blue-500 focus:border-blue-500"
            >
  ...
  const renderInstallation = () => {
    const rawSpaceConstrained2 = criteria.spaceConstrained;
      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="flex items-center gap-3">
            <input
              type="checkbox"
              checked={rawSpaceConstrained2 || false}
  ...
  const renderResults = () => {
    const rawInstallationType2 = criteria.installationType;
                  ...
                  <div className="border-t border-gray-200 p-4 bg-white space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                      ...
                      <div className="bg-gray-50 rounded p-2 text-center">
                        ...
                        <div className="font-medium">
                          {item.type.operatingLimits.maxSpeedRpm} RPM
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="ml-2 font-medium capitalize">
                {rawInstallationType2 || "Not specified"}
              </span>
            </div>
          </div>
        </div>

...
export function TableLoadingState(props: TableLoadingStateProps) {
  ...
  const message = rawMessage || "Loading...";
  const rawSpinnerClassName = props.spinnerClassName;
  const spinnerClassName = rawSpinnerClassName || "border-b-2 border-gray-600";
  return (
...
export function TableEmptyState(props: TableEmptyStateProps) {
  ...
  const rawClassName = action?.className;
  const buttonClassName = rawClassName || "text-white bg-gray-600 hover:bg-gray-700";
  return (
...
export function Pagination(props: PaginationProps) {
  ...
  const rawFocusClassName = props.focusClassName;
  const focusClassName = rawFocusClassName || "focus:ring-gray-500 focus:border-gray-500";
...
export const TableIcons = {
  document: (props: IconProps) => {
    const rawClassName2 = props.className;

    return (
      <svg
        className={rawClassName2 || "h-12 w-12"}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
  ...
  building: (props: IconProps) => {
    const rawClassName3 = props.className;

    return (
      <svg
        className={rawClassName3 || "h-12 w-12"}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
  ...
  cube: (props: IconProps) => {
    const rawClassName4 = props.className;

    return (
      <svg
        className={rawClassName4 || "h-12 w-12"}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
  ...
  tag: (props: IconProps) => {
    const rawClassName5 = props.className;

    return (
      <svg
        className={rawClassName5 || "h-12 w-12"}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
  ...
  currency: (props: IconProps) => {
    const rawClassName6 = props.className;

    return (
      <svg
        className={rawClassName6 || "h-12 w-12"}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >

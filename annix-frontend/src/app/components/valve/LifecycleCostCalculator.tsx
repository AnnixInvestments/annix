...
export default function LifecycleCostCalculator() {
  ...
  const results = useMemo<LifecycleCostResult>(() => {
    ...
    const totalCycles =
      cyclesPerDay && operatingHoursPerYear
        ...
        <div className="lg:col-span-1 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateValveSpec("nominalBoreMm", parseInt(e.target.value, 10) || 0)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
          ...
          <div className="bg-white rounded-lg shadow p-5">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCostInput("purchaseCost", parseFloat(e.target.value) || 0)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCostInput("installationCost", parseFloat(e.target.value) || 0)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Electricity Cost ({currencySymbol}/kWh)
                </label>
                <input
                  type="number"
                  step="0.1"
                  ...
                  onChange={(e) =>
                    updateCostInput("electricityCostPerKwh", parseFloat(e.target.value) || 0)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCostInput("annualMaintenanceCost", parseFloat(e.target.value) || 0)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCostInput("lifespanYears", parseInt(e.target.value, 10) || 1)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  />
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateCostInput("majorOverhaulCost", parseFloat(e.target.value) || 0)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateCostInput("downtimeCostPerHour", parseFloat(e.target.value) || 0)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateCostInput("inflationRate", parseFloat(e.target.value) || 0)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateCostInput("discountRate", parseFloat(e.target.value) || 0)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                    </div>
              ...
              {[
                {
                  ...
                  pct: costBreakdownPercentages.purchase,
                  color: "bg-indigo-500",
                },
                {
                  label: "Installation",
                  value: results.installationCost,
                  pct: costBreakdownPercentages.installation,
                  color: "bg-blue-500",
                },
                {
                  label: "Energy",
                  value: results.totalEnergyCost,
                  pct: costBreakdownPercentages.energy,
                  color: "bg-yellow-500",
                },
                {
                  label: "Maintenance",
                  value: results.totalMaintenanceCost,
                  pct: costBreakdownPercentages.maintenance,
                  color: "bg-green-500",
                },
                {
                  label: "Major Overhauls",
                  value: results.totalOverhaulCost,
                  pct: costBreakdownPercentages.overhaul,
                  color: "bg-orange-500",
                },
                {
                  label: "Downtime",
                  value: results.totalDowntimeCost,
                  pct: costBreakdownPercentages.downtime,
                  color: "bg-red-500",
                },
              ].map((item) => (
                <div key={item.label}>
                ...
                <tbody className="divide-y divide-gray-100">
                  <tr className="bg-indigo-50">
                    ...
                    <td className="py-2 px-3 text-right font-medium">
                      {currencySymbol}{" "}
                      {formatCurrency(results.purchaseCost + results.installationCost)}
                    </td>
                  ...
                  {results.breakdownByYear.map((year) => (
                    <tr key={year.year} className={year.overhaulCost > 0 ? "bg-orange-50" : ""}>
                      ...
                      <td className="py-2 px-3 text-right">
                        {currencySymbol} {formatCurrency(year.energyCost)}
                      </td>
                      <td className="py-2 px-3 text-right">
                        {currencySymbol} {formatCurrency(year.maintenanceCost)}
                      </td>
                      <td className="py-2 px-3 text-right">
                        {year.overhaulCost > 0
                          ? `${currencySymbol} ${formatCurrency(year.overhaulCost)}`
                          : "-"}
                      </td>
                      <td className="py-2 px-3 text-right">
                        {currencySymbol} {formatCurrency(year.downtimeCost)}
                      </td>
                      <td className="py-2 px-3 text-right font-medium">
                        {currencySymbol} {formatCurrency(year.totalCost)}
                      </td>
                      <td className="py-2 px-3 text-right text-gray-600">
                        {currencySymbol} {formatCurrency(year.presentValue)}
                      </td>
                      <td className="py-2 px-3 text-right font-medium">
                        {currencySymbol} {formatCurrency(year.cumulativeCost)}
                      </td>
                    </tr>
                  ))}
                </tbody>

      ...
      {datasheets.length < maxDatasheets && (
        ...
        >
          <input
            ...
            className="hidden"
          />
          <label htmlFor="valve-datasheet-upload" className="cursor-pointer flex items-center justify-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-400">Manufacturer specs, Cv curves, dimensions (PDF, images)</p>
            </div>
          </label>
        </div>
      )}

...
function BracketEntryCard({
  entry,
  index,
  onUpdate,
  onRemove,
  onDuplicate,
}: BracketEntryCardProps) {
  ...
  const validationErrors = useMemo(
    () => validateBracketDimensions(entry.dimensions),
    [entry.dimensions],
  );
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              ...
              {entry.dimensions.thicknessMm}mm | Qty: {entry.quantity}
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateDimension("angleDegrees", parseFloat(e.target.value) || 90)
                  }
                  className="w-full px-2 py-1.5 border border-gray-300 rounded text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                  min={30}
                  max={180}

...
import { OrbitControls, Center, Environment, ContactShadows, Text, Billboard } from '@react-three/drei'
...
import { use3DSceneSetup, type StubData } from '@/app/hooks/use3DSceneSetup'

                  ...
                  <div className="grid grid-cols-4 gap-3">
                    ...
                    <div ref={steelSpecDropdownRef} className="relative">
                      ...
                      >
                        <span
                          className={
                            globalSpecs?.steelSpecificationId ? "text-gray-900" : "text-gray-400"
                          }
                        >
                          ...
                          {(() => {
                            ...
                            const handleSpecSelect = async (specId: number) => {
                              ...
                              try {
                                ...
                                log.warn(
                                  "Material validation API unavailable, proceeding with selection:",
                                  error,
                                );
                              }
                            ...
                            const groups = [
                              {
                                label: "South African Standards (SABS)",
                                filter: (name: string) => name.startsWith("SABS"),
                              },
                              {
                                label:
                                  "Carbon Steel - ASTM A106 (High-Temp Seamless) - up to 427°C",
                                  ...
                                  {unsuitableSpecs.map((spec: any) => {
                                    ...
                                    return (
                                      <div
                                        ...
                                        onMouseEnter={
                                          isRestricted ? showRestrictionPopup : undefined
                                        }
                      ...
                      {globalSpecs?.steelSpecificationId &&
                        ...
                        (() => {
                          ...
                          if (!currentSpec || !allLimits) return null;
                          const suitability = checkSuitabilityFromCache(
                            allLimits,
                    ...
                    <div ref={flangeStandardDropdownRef} className="relative">
                      ...
                      >
                        <span
                          className={
                            globalSpecs?.flangeStandardId ? "text-gray-900" : "text-gray-400"
                          }
                        >
                      ...
                      {flangeStandardDropdownOpen && (
                        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
                          {(() => {
                            const handleFlangeStandardSelect = async (
                            ...
                            return (
                              <>
                                ...
                                {masterData.flangeStandards.map((standard: any) => {
                                  const isAllowed = isFlangeStandardAllowedForUnregistered(
                                    standard.code,
                                  );
                              ...
                              <div className="flex items-start gap-2">
                                ...
                                <div className="flex-1">
                                  <p className="text-red-800 font-medium">
                                    The selected pressure class is unsuitable for the operating
                                    conditions (P-T rating inadequate).
                                  </p>
                                  {autoPressureClassId && (
                                    <button
                                      type="button"
                              ...
                              <div className="flex items-start gap-2">
                                ...
                                <div className="flex-1">
                                  <p className="text-amber-800 font-medium">
                                    No P-T rating data available for this pressure class. Cannot
                                    verify suitability for operating conditions.
                                  </p>
                                  {autoPressureClassId && (
                                    <button
                                      type="button"
                            ...
                            onChange={(e) => {
                              ...
                              if (
                                ...
                                if (currentPressureClass?.designation) {
                                  const basePressure = currentPressureClass.designation.replace(
                                    /\/\d+$/,
                                    "",
                                  );
                          ...
                          return (
                            <div className="bg-gray-100 rounded-lg p-4 border border-gray-200">
                              <p className="text-sm text-gray-600 text-center">
                                Complete the required fields (marked *) to receive a coating
                                recommendation.
                              </p>
                            </div>
                          );
                          ...
                          <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-md p-2 border-2 border-emerald-300">
                                ...
                                <div className="bg-blue-50 rounded p-2 border border-blue-200 mb-2">
                                  ...
                                  {selectedIso12944System && (
                                    <>
                                      ...
                                      {iso12944Systems &&
                                        iso12944Systems.alternatives.length > 0 && (
                                          <div className="flex items-center gap-2">
                                            ...
                                            <select
                                              ...
                                              onChange={(e) =>
                                                setSelectedIso12944SystemCode(e.target.value)
                                              }
                                  ...
                                  {!selectedIso12944System && !iso12944Loading && (
                                    <p className="text-[10px] text-blue-700">
                                      No ISO 12944-5 systems available for this category/durability
                                      combination.
                                    </p>
                                  )}
                                </div>
                                  ...
                                  {!globalSpecs?.showRecCustomColourInput ? (
                                    ...
                                    >
                                      ...
                                      <optgroup label="Mining">
                                        <option value="Safety Yellow (RAL 1003)">
                                          Yellow RAL 1003
                                        </option>
                                        <option value="Safety Orange (RAL 2009)">
                                          Orange RAL 2009
                                        </option>
                                        <option value="Safety Red (RAL 3001)">Red RAL 3001</option>
                                        <option value="Safety Green (RAL 6024)">
                                          Green RAL 6024
                                        </option>
                                        <option value="Signal Blue (RAL 5005)">
                                          Blue RAL 5005
                                        </option>
                                      ...
                                      <optgroup label="Pipeline">
                                        ...
                                        <option value="Air - Light Blue (RAL 5012)">
                                          Air Blue
                                        </option>
                                    ...
                                    <div className="space-y-1">
                                      ...
                                      <div className="flex gap-1">
                                        <button
                                          ...
                                          onClick={() => {
                                            const newColour =
                                              globalSpecs?.recCustomColourInput?.trim();
                                            if (newColour) {
                                              try {
                            ...
                            <details className="mt-2 text-[10px] text-amber-700">
                              ...
                              <p className="mt-1 p-1.5 bg-amber-50 border border-amber-200 rounded">
                                Recommendations based on ISO 12944/21809. Does not replace
                                project-specific assessments or qualified inspector verification.
                              </p>
                            </details>
                          </div>
                        );
                    ...
                    {globalSpecs?.externalCoatingRecommendationRejected && (
                      <div className="bg-red-50 border-2 border-red-300 rounded-lg p-4 mb-4">
                        ...
                        <p className="text-sm text-red-700 mb-3">
                          You have chosen to specify your own coating requirements instead of using
                            ...
                            {!globalSpecs?.showCustomColourInput ? (
                              ...
                              >
                                ...
                                <optgroup label="SA Mining Standard Colours">
                                  ...
                                  <option value="Safety Red (RAL 3001)">
                                    Safety Red (RAL 3001)
                                  </option>
                                  <option value="Safety Green (RAL 6024)">
                                    Safety Green (RAL 6024)
                                  </option>
                                  <option value="Signal Blue (RAL 5005)">
                                ...
                                <optgroup label="Pipeline Identification (SABS 0140)">
                                  <option value="Water - Blue (RAL 5015)">
                                    Water - Blue (RAL 5015)
                                  </option>
                                  <option value="Steam - Silver Grey (RAL 7001)">
                                  ...
                                  <option value="Air - Light Blue (RAL 5012)">
                                    Air - Light Blue (RAL 5012)
                                  </option>
                                  <option value="Gas - Yellow Ochre (RAL 1024)">
                                    Gas - Yellow Ochre (RAL 1024)
                                  </option>
                                  <option value="Acids - Orange (RAL 2000)">
                                    Acids - Orange (RAL 2000)
                                  </option>
                                  <option value="Alkalis - Violet (RAL 4001)">
                                    Alkalis - Violet (RAL 4001)
                                  </option>
                                  <option value="Oil - Brown (RAL 8001)">
                                    Oil - Brown (RAL 8001)
                                  </option>
                                  <option value="Fire Services - Red (RAL 3000)">
                                    Fire Services - Red (RAL 3000)
                                  </option>
                                  <option value="Slurry - Black (RAL 9005)">
                                    Slurry - Black (RAL 9005)
                                  </option>
                                </optgroup>
                          ...
                          {!globalSpecs?.showCustomBand1Input ? (
                            ...
                            >
                              ...
                              <optgroup label="Safety & Warning Bands">
                                ...
                                <option value="Warning Black/Yellow Stripe">
                                  Warning Black/Yellow Stripe
                                </option>
                              </optgroup>
                              <optgroup label="Pipeline Identification Bands">
                                <option value="Water Identification Blue">
                                  Water Identification Blue
                                </option>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-md p-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-xs text-green-800">
                        ...
                        <span className="font-medium">PU Lining:</span>{" "}
                        {globalSpecs.internalPuThickness}mm • {globalSpecs.internalPuHardness} Shore
                        A
                      </div>
                      <button
                        type="button"
                ...
                <div className="bg-green-100 border border-green-400 rounded-md p-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 text-xs text-green-800">
                      ...
                      <span className="mx-2">•</span> <span className="font-medium">Gasket:</span>{" "}
                      {globalSpecs.gasketType}
                    </div>
                    <button
                      type="button"
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1">
                              <p className="text-amber-800">
                                ...
                                {boltRecommendation.grade}) for {globalSpecs.workingTemperatureC}°C
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-amber-700 text-xs">
                      Bolt quantities and dimensions will be automatically calculated based on your
                      flange selections per ASME B16.5/B16.47 standards.
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-green-700 text-sm">
                ...
                This will include delivery requirements, site logistics, installation services, and
                more.
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm mt-1">
                    Please go back to Stage 1 and select at least one product or service type to

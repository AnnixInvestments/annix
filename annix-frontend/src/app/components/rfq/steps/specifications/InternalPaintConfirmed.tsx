...
interface InternalPaintConfirmedProps {
  primerType: string;
...
const InternalPaintConfirmedInner = (props: InternalPaintConfirmedProps) => {
...
export const InternalPaintConfirmed = memo(InternalPaintConfirmedInner);

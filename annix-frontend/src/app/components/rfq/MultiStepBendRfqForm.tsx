...
import { bendRfqApi, masterDataApi } from "@/app/lib/api/client";
...
export default function MultiStepBendRfqForm({ onSuccess, onCancel }: Props) {
    ...
    try {
      ...
      if (classes.length > 0) {
        ...
        if (recommended) {
          ...
          log.debug(
            `Auto-selected pressure class ${recommended.designation} for ${workingPressureBar} bar`,
          );
        }
      }
    } catch (error) {
  ...
  const addBendEntry = () => {
    const newEntry: BendEntry = {
      ...
      clientItemNumber: generateClientItemNumber(
        formData.customerName,
        formData.bendEntries.length + 1,
      ),
      specs: {
        nominalBoreMm: 40,
        scheduleNumber: "40",
    ...
    try {
      ...
      const rfqData = {
        ...
        bend: {
          ...
          quantityType: "number_of_items" as const,
          workingPressureBar:
            firstBendEntry.specs.workingPressureBar ||
            formData.globalSpecs.workingPressureBar ||
            10,
          workingTemperatureC:
            firstBendEntry.specs.workingTemperatureC ||
            formData.globalSpecs.workingTemperatureC ||
            20,
          steelSpecificationId:
            firstBendEntry.specs.steelSpecificationId ||
            formData.globalSpecs.steelSpecificationId ||
            2,
          useGlobalFlangeSpecs: firstBendEntry.specs.useGlobalFlangeSpecs ?? true,
          ...(firstBendEntry.specs.flangeStandardId && {
            flangeStandardId: firstBendEntry.specs.flangeStandardId,
          }),
          ...(firstBendEntry.specs.flangePressureClassId && {
            flangePressureClassId: firstBendEntry.specs.flangePressureClassId,
          }),
        },
  ...
  const steps = [
    ...
    },
    {
      number: 3,
      title: "Bend Items",
      description: "Bend specifications",
        ...
        <div className="w-72 bg-white border-r border-gray-200 flex flex-col">
          ...
          <div className="px-5 py-4 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <h1 className="text-lg font-bold text-gray-900">Create Bend RFQ</h1>
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-gray-900 mb-6">
                        ...
                        <span className="ml-2 text-base font-normal text-gray-600">
                          (Optional - Can be specified per item)
                        </span>
                      </h2>
                      <p className="text-gray-600 mb-6">
                        Set default specifications that will apply to all bend items. Item-level
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            updateField("globalSpecs", {
                              ...formData.globalSpecs,
                              steelSpecificationId: parseInt(e.target.value, 10) || undefined,
                            })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            updateField("globalSpecs", {
                              ...formData.globalSpecs,
                              flangeStandardId: parseInt(e.target.value, 10) || undefined,
                            })
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                        >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <select
                                ...
                                onChange={(e) =>
                                  updateBendEntry(entry.id, {
                                    specs: {
                                      ...entry.specs,
                                      nominalBoreMm: parseInt(e.target.value, 10) || undefined,
                                    },
                                  })
                                }
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                              >
                                ...
                                bendOptionsCache[entry.specs.bendType]?.nominalBores?.length > 0
                                  ? // Use dynamic options from API
                                    bendOptionsCache[entry.specs.bendType].nominalBores.map(
                                      (nb: number) => (
                                  ...
                                  : // Fallback options
                                    [
                                      ...
                                      500, 550, 600, 650, 700, 750, 800, 900, 1000, 1050, 1100,
                                      1150, 1200,
                                    ].map((nb: number) => (
                                      <option key={nb} value={nb}>
                                        {nb}NB
                            ...
                            <div>
                              ...
                              >
                                ...
                                {entry.specs.bendType &&
                                bendOptionsCache[entry.specs.bendType]?.degrees?.length > 0
                                  ? // Use dynamic options from API
                                    bendOptionsCache[entry.specs.bendType].degrees.map(
                                      (deg: number) => (
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateBendEntry(entry.id, {
                                    specs: {
                                      ...entry.specs,
                                      quantityValue: parseInt(e.target.value, 10) || 1,
                                    },
                                  })
                                }
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
                                ...
                                <input
                                  ...
                                  onChange={async (e) => {
                                    ...
                                    const flangeStandardId =
                                      ...
                                      formData.globalSpecs.flangeStandardId;
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500">
                                  ...
                                  <div className="text-2xl font-bold text-gray-900 mt-1">
                                    {entry.calculation.totalWeight?.toFixed(1)} kg
                                  </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                  <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                    ...
                                    <span className="font-medium text-gray-900">
                                      {entry.calculation.bendWeight?.toFixed(1) || "0"} kg
                                    </span>
                                  </div>
                                  <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                    <span className="text-sm text-gray-600">Tangent:</span>
                                    <span className="font-medium text-gray-900">
                                      {entry.calculation.tangentWeight?.toFixed(1) || "0"} kg
                                    </span>
                                  </div>
                                  <div className="flex justify-between items-center p-2 bg-gray-50 rounded">
                                    <span className="text-sm text-gray-600">Flange:</span>
                                    <span className="font-medium text-gray-900">
                                      {entry.calculation.flangeWeight?.toFixed(1) || "0"} kg
                                    </span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="bg-white p-4 rounded-lg shadow-sm">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                  <div className="flex flex-col">
                                    ...
                                    <span className="font-medium text-gray-900">
                                      {entry.calculation.outsideDiameterMm?.toFixed(1) || "0"} mm
                                    </span>
                                  </div>
                                  <div className="flex flex-col">
                                    <span className="text-xs text-gray-500 uppercase tracking-wide">
                                    ...
                                    <span className="font-medium text-gray-900">
                                      {entry.calculation.wallThicknessMm?.toFixed(2) || "0"} mm
                                    </span>
                                  </div>
                                  <div className="flex flex-col">
                                    <span className="text-xs text-gray-500 uppercase tracking-wide">
                                    ...
                                    <span className="font-medium text-gray-900">
                                      {entry.calculation.numberOfFlanges || 0}
                                    </span>
                                  </div>
                                  <div className="flex flex-col">
                                    <span className="text-xs text-gray-500 uppercase tracking-wide">
                                    ...
                                    <span className="font-medium text-gray-900">
                                      {(
                                        (entry.calculation.totalFlangeWeldLength || 0) +
                                        (entry.calculation.totalButtWeldLength || 0)
                                      ).toFixed(2)}{" "}
                                      m
                                    </span>
                                  </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">
                            {formData.requiredDate || "Not specified"}
                          </p>
                        </div>
                      </div>
                    </div>
                          ...
                          <div key={entry.id} className="p-4 bg-white rounded-lg border shadow-sm">
                            <div className="flex justify-between items-start mb-3">
                              <div className="flex-1">
                                <h4 className="font-medium text-gray-900 text-lg">
                                  {entry.specs.nominalBoreMm}NB {entry.specs.bendDegrees}°{" "}
                                  {entry.specs.bendType} Bend
                                </h4>
                                <p className="text-sm text-gray-600 mt-1">{entry.description}</p>
                                <div className="mt-2">
                                  <span className="text-sm text-gray-600">Total Weight: </span>
                                  <span className="font-medium text-gray-900">
                                    {entry.calculation?.totalWeight?.toFixed(1) || "0"} kg
                                  </span>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3 p-3 bg-gray-50 rounded-lg">
                              ...
                              <div>
                                ...
                                <p className="font-medium text-gray-900">
                                  {entry.specs.workingPressureBar} bar
                                </p>
                              </div>
                            </div>
                            ...
                            {!entry.calculation && (
                              <div className="border-t pt-3">
                                <p className="text-sm text-yellow-600 bg-yellow-50 p-2 rounded">
                                  ⚠️ Calculation not performed yet. Go back to step 3 to calculate
                                  this bend.
                                </p>
                              </div>
                            )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="text-center">
                            <div className="text-2xl font-bold text-blue-600">
                              {formData.bendEntries
                                .reduce(
                                  (total, entry) => total + (entry.calculation?.totalWeight || 0),
                                  0,
                                )
                                .toFixed(1)}{" "}
                              kg
                          ...
                          <div className="text-center">
                            <div className="text-2xl font-bold text-orange-600">
                              {Math.max(
                                ...formData.bendEntries.map(
                                  (entry) => entry.calculation?.leadTimeDays || 0,
                                ),
                                0,
                              )}{" "}
                              days

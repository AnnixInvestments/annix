...
export default function SplitPaneLayout({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className={isEnabled ? "flex gap-0" : "space-y-5"}>
        ...
        >
          ...
          {!isEnabled && showSplitToggle && calcResultsContent && (
            <div className="mt-4">{calcResultsContent}</div>
          )}
        </div>
        ...
        {isEnabled && showSplitToggle && previewContent && (
          ...
          >
            <div className="flex-1 w-full min-h-0 flex flex-col">{previewContent}</div>
            <div
      ...
      {isEnabled && showSplitToggle && calcResultsContent && <div>{calcResultsContent}</div>}
    </div>
  );
}

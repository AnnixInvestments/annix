...
// Standard flange dimensions based on SABS 1123 Table 1000/4 (PN16)
const getFlangeSpecs = (nominalBore: number) => {
  const flangeData: { [key: number]: { flangeOD: number; pcd: number; boltHoles: number; holeID: number; thickness: number } } = {
    ...
    200: { flangeOD: 340, pcd: 295, boltHoles: 12, holeID: 22, thickness: 28 },
    250: { flangeOD: 405, pcd: 355, boltHoles: 12, holeID: 26, thickness: 30 },
    300: { flangeOD: 460, pcd: 410, boltHoles: 12, holeID: 26, thickness: 30 },
    350: { flangeOD: 520, pcd: 470, boltHoles: 16, holeID: 26, thickness: 32 },
    ...
    600: { flangeOD: 780, pcd: 725, boltHoles: 20, holeID: 30, thickness: 34 },
  };

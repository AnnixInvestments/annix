...
export const metadata: Metadata = {
  ...
  description:
    "Local rubber lining services for Boksburg mining and industrial customers. AU Industries is based in Anderbolt, Boksburg with same-day quoting and fast turnaround across the East Rand.",

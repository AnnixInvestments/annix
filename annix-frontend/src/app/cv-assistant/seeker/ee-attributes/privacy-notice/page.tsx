...
export default function EePrivacyNoticePage() {
  return (
    <div className="p-6 max-w-3xl mx-auto prose prose-sm">
      ...
      <p>
        ...
        <Link href="/cv-assistant/seeker/ee-attributes">Employment Equity disclosure form</Link>,
      ...
      <p>
        ...
        for the duration of the employer's EE plan (typically 5 years), and EEA2 / EEA4 returns
        require at least 3 years. POPIA s14 then requires deletion when no longer necessary. In
        practice we retain disclosures for 5 years from the consent date, then automatically purge.
      </p>
      ...
      <p className="text-xs text-gray-500">
        ...
        agreed to, see the version label shown on your disclosure page.
      </p>
    </div>
  );
}

...
export function StatusBadge(props: StatusBadgeProps) {
  ...
  const rawColorClass = colorMap[normalizedStatus];
  const colorClass = rawColorClass || "bg-gray-100 text-gray-800";
      ...
      <div className="p-5">
        <div className="flex items-center">
          <div className="flex-shrink-0">
            <div className={`w-12 h-12 rounded-md ${colorClass} flex items-center justify-center`}>
              {icon}
            </div>
          </div>
...
export const Icons = {
  Document: (props: { className?: string }) => {
    ...
    const className = rawClassName || "w-6 h-6 text-white";
    return (
  ...
  NoData: (props: { className?: string }) => {
    const rawClassName = props.className;
    const className = rawClassName || "h-12 w-12";
    return (
      <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"

        ...
        <div className="p-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-md flex items-center justify-center flex-shrink-0" style={{ background: "#323288" }}>
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">471K lines · 892 commits · 25× vendor productivity · cost &amp; value analysis</p>
              </div>
            </div>

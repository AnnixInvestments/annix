...
import { BlockEditor } from "@/app/lib/cms/components/BlockEditor";
...
export default function AuMarketingPageEditorPage() {
  ...
  const pageQuery = useAuCmsWebsitePage(isNew ? "" : id);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (isNew) {
        ...
        router.push(`/admin/portal/marketing/au/pages/${created.id}`);
      } else {
        await auCmsAdminApi.updateWebsitePage(id, fields as UpdateWebsitePageDto);
        queryClient.invalidateQueries({ queryKey: auCmsKeys.websitePages.all });
        queryClient.invalidateQueries({ queryKey: auCmsKeys.websitePages.detail(id) });
    ...
    <div className="px-6 py-4 max-w-5xl">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-3">
          <button
            onClick={() => router.push("/admin/portal/marketing/au")}

  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Rubber Lining Portal</h1>
          <p className="mt-1 text-sm text-gray-600">
            Manage rubber products, companies, and orders
          </p>
        </div>
        <Link
          href="/admin/portal/rubber/orders"
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <Link href="/admin/portal/rubber/orders" className="bg-white overflow-hidden shadow rounded-lg hover:ring-2 hover:ring-blue-500 transition-all">
          <div className="p-5">
        ...
        <Link href="/admin/portal/rubber/companies" className="bg-white overflow-hidden shadow rounded-lg hover:ring-2 hover:ring-green-500 transition-all">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
        ...
        <Link href="/admin/portal/rubber/products" className="bg-white overflow-hidden shadow rounded-lg hover:ring-2 hover:ring-purple-500 transition-all">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
        ...
        <Link href="/admin/portal/rubber/codings" className="bg-white overflow-hidden shadow rounded-lg hover:ring-2 hover:ring-orange-500 transition-all">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">
        ...
        <Link href="/admin/portal/rubber/pricing-tiers" className="bg-white overflow-hidden shadow rounded-lg hover:ring-2 hover:ring-yellow-500 transition-all">
          <div className="p-5">
            <div className="flex items-center">
              <div className="flex-shrink-0">

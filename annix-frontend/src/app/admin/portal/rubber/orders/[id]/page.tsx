            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                  ...
                  <th scope="col" className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase">Product
                  </th>
                  <th scope="col" className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Specific
                    Gravity
                  </th>
                  <th scope="col"
                      className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Thickness
                  </th>
                  <th scope="col" className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Width
                  </th>
                  <th scope="col" className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Length
                  </th>
                  <th scope="col"
                      className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Kg/Roll
                  </th>
                  <th scope="col"
                      className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Price/Kg
                  </th>
                  <th scope="col" className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Qty</th>
                  <th scope="col"
                      className="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase">Price/Roll
                  </th>
                  <th scope="col" className="px-3 py-3 text-right text-xs font-medium text-gray-500 uppercase">Total
                  </th>
                  <th scope="col"
                      className="px-3 py-3 text-center text-xs font-medium text-gray-500 uppercase">Actions
                  </th>
                </tr>
                </thead>

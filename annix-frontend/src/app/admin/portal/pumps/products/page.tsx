  ...
  return (
    <span className="inline-block ml-1">
      {active ? (
        ...
        <svg className="w-4 h-4 inline text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Browse and manage pump types and products
          </p>
        </div>
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {searchQuery || categoryFilter ? 'Try adjusting your filters' : 'Add your first pump product.'}
            </p>
          </div>
        ) : (
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc list-inside space-y-1">
                <li><strong>Centrifugal:</strong> End suction, multistage, vertical turbine, submersible</li>
                <li><strong>Positive Displacement:</strong> Gear, screw, vane, peristaltic, diaphragm, piston</li>
                <li><strong>Specialty:</strong> Vacuum, cryogenic, chemical duty, slurry, fire pumps</li>
              </ul>
            </div>
          </div>
        </div>

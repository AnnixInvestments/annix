...
import type { RbacApp } from "@/app/lib/api/adminApi";
...
const appIcons: Record<string, string> = {
  ...
  "stock-control": "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4",
  "cv-assistant":
    "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",
};

export function AppTabs({ apps, selectedAppCode, onSelectApp }: AppTabsProps) {
  return (

...
export default function AdminCustomersPage() {
  ...
  const rawTotalPagesValue = customersQuery.data?.totalPages;
  const totalPages = rawTotalPagesValue || 1;
  const rawTotalValue = customersQuery.data?.total;
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage customer accounts, view login history, and handle account actions
          </p>
        </div>
        <div className="text-sm text-gray-500">Total: {total} customers</div>
      </div>

    ...
    materials: [
      {
        ...
        rating: "excellent",
        maxTemp: 150,
        notes: "Electropolished preferred",
      },
      { material: "ptfe", rating: "excellent", maxTemp: 150 },
...
export const ISA_SUBSEQUENT_LETTERS: Record<
  string,
  { letter: string; description: string; type: string }
> = {
...
export const getFlowmeterRecommendation = (
  fluidType: string,
): FlowmeterSelectionGuide | undefined => {
...
export const VALVE_PID_SYMBOLS: PIDSymbol[] = [
  {
    type: "gate_valve",
    name: "Gate Valve",
    description: "Linear isolation valve",
    symbol: "><",
    isaTag: "HV/XV",
  },
  {
    type: "globe_valve",
    name: "Globe Valve",
    description: "Linear throttling valve",
    symbol: ">O<",
    isaTag: "FV/TV/PV",
  },
  {
  ...
  },
  {
    type: "control_valve",
    name: "Control Valve",
    description: "Modulating control",
    symbol: ">◊<",
    isaTag: "FCV/TCV/PCV/LCV",
  },
  {
    type: "three_way_valve",
    name: "Three-Way Valve",
    description: "Mixing/diverting",
    symbol: ">⋔<",
    isaTag: "FV/TV",
  },
  {
...
export const INSTRUMENT_PID_SYMBOLS: PIDSymbol[] = [
  {
    type: "transmitter",
    name: "Transmitter",
    description: "Field mounted transmitter",
    symbol: "○",
    isaTag: "FT/PT/LT/TT",
  },
  {
    type: "indicator_local",
    name: "Local Indicator",
    description: "Field mounted indicator",
    symbol: "○",
    isaTag: "FI/PI/LI/TI",
  },
  {
    ...
    description: "Control room indicator",
    symbol: "□",
    isaTag: "FI/PI/LI/TI",
  },
  {
  ...
  },
  {
    type: "switch",
    name: "Switch",
    description: "On/off switching",
    symbol: "○",
    isaTag: "FSL/PSH/LSH/TSH",
  },
  {
    type: "element",
